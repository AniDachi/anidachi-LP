...
- 2026-09-18 владелец согласовал удаление обещания индивидуальной цены для групп
  ...
  и priority support сохранены. Это отдельное согласованное решение; PR #353
  с предыдущими правками 5A пока не влит, дальнейшее внедрение ожидает согласования.
