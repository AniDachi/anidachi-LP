...
- Обещание индивидуальной цены для групп 8+ оставлено без изменений до ответа
  владельца. Файлы с этим и другими непроверенными marketing claims не закрываются
  целиком. Остальные пункты этапа 5 остаются открытыми.
