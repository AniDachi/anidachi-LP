...
- Friends has two switches: Friends and Groups. Incoming requests appear above
  friends only when present; outgoing requests are expandable. Add friend opens
  the existing invitation-link and recent-people actions. Groups preserve
  existing create/rename/archive/member actions and owner-private invitation-list
