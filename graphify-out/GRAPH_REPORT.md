# Graph Report - personal-history-mvp  (2026-09-10)

## Corpus Check
- 1239 files · ~1,260,425 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 11924 nodes · 26985 edges · 740 communities (421 shown, 283 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 430 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c8dbaf80`
...
- getSession
- node:assert/strict
- best-anime-to-watch-on-crunchyroll-with-friends/page.tsx
...
- e2e/package.json
- anidachi-auth/watch-history-access.ts
- api/package.json
...
- popup-styles.ts
- Inactive personal-history staging delivery packet
- voice-activity.ts
...
- telemetry.ts
- room-session-storage.test.ts
- kreatli-email-crm/page.tsx
- lucide-react
...
- best-psychological-anime-to-watch-with-friends/page.tsx
...
- best-romance-anime-to-watch-with-friends/page.tsx
...
- Durable Room Lifecycle and Idempotent Create
...
- Frozen host-plan room caps and independent media grants
- Historical Execution Plan Index
- Foundation Personal History Target Amendment
- Retained Private Recipient List Baseline
...
1. `.next/**` - 175 edges
2. `next/link` - 173 edges
3. `vitest` - 163 edges
4. `OverlayApp()` - 160 edges
5. `SeoPageLayout()` - 146 edges
6. `TocHeading` - 143 edges
7. `P2PMediaController` - 123 edges
8. `react` - 123 edges
9. `getGuideLinks()` - 122 edges
...
- **Durable invitation transaction, inbox authority, wakeup and display** — docs_superpowers_specs_2026_08_06_account_data_history_social_inbox_design_atomic_room_invites, docs_superpowers_specs_2026_08_06_account_data_history_social_inbox_design_durable_account_inbox, docs_superpowers_specs_2026_08_06_account_data_history_social_inbox_design_web_push_delivery_and_recovery, docs_superpowers_specs_2026_08_06_account_data_history_social_inbox_design_browser_notification_policy [EXTRACTED 1.00]
...
- **DB prerequisites, compatible runtime and separate activation** — docs_releases_personal_history_mvp_prerequisites_pr_additive_db_prerequisites, docs_releases_personal_history_mvp_runtime_pr_compatible_runtime_delivery, docs_releases_personal_history_mvp_readme_staging_delivery_packet, docs_releases_personal_history_mvp_readme_one_way_activation [EXTRACTED 1.00]
- **Durable Notification Delivery Flow** — docs_superpowers_specs_2026_08_06_account_data_history_social_inbox_design_semantic_room_invite_dedupe, docs_superpowers_specs_2026_08_06_account_data_history_social_inbox_design_transactional_push_outbox, docs_superpowers_specs_2026_08_06_account_data_history_social_inbox_design_web_push_invalidation, docs_superpowers_specs_2026_08_06_account_data_history_social_inbox_design_durable_inbox_aggregation, docs_superpowers_specs_2026_08_06_account_data_history_social_inbox_design_supabase_cron_recovery [EXTRACTED 1.00]
...
- **Capture, manual editing and catalog presentation share canonical progress** — docs_project_architecture_and_development_canonical_personal_progress, docs_superpowers_plans_2026_09_08_personal_history_and_plans_mvp_personal_history_contract, docs_superpowers_plans_2026_09_10_account_library_editor_atomic_manual_progress_batch, docs_superpowers_specs_2026_09_05_watch_drawer_browse_design_accepted_catalog_episode_grid [INFERRED 0.95]
...
## Communities (740 total, 283 thin omitted)

### Community 0 - "getResolvedSiteOrigin"
Cohesion: 0.02
Nodes (90): faq, headings, metadata, SITE_URL, faq, headings, metadata, SITE_URL (+82 more)

### Community 1 - "pricing-copy.ts"
Cohesion: 0.03
Nodes (132): faq, headings, metadata, SITE_URL, faq, headings, metadata, SITE_URL (+124 more)

### Community 2 - ".next/**"
Cohesion: 0.02
Nodes (93): faq, itemList, metadata, tocHeadings, faq, metadata, tocHeadings, faq (+85 more)

### Community 3 - "overlay-app.tsx"
Cohesion: 0.03
Nodes (114): HOLD_FIRE_SUPER_REACTION_EXPERIMENT, normalizeExperimentFlag(), attachAndPlayVideoElement(), activeRoomConflictMessage(), appendVisibleReaction(), buildCurrentSourceUrlForInvite(), CameraBubble(), CatchUpState (+106 more)

### Community 4 - "responsive-compare-table.tsx"
Cohesion: 0.02
Nodes (103): faq, itemList, metadata, tocHeadings, faq, headings, metadata, SITE_URL (+95 more)

### Community 5 - "P2PMediaController"
Cohesion: 0.11
Nodes (7): MediaCaptureIntents, classifyMicrophoneTerminalFailure(), formatCameraErrorMessage(), formatMicrophoneErrorMessage(), microphoneErrorName(), P2PMediaController, stopStream()

### Community 6 - "getGuideLinks"
Cohesion: 0.02
Nodes (81): AniDachiVsRavePage(), AniDachiVsTelepartyPage(), CrunchyrollPartyVsTelepartyForAnimePage(), faq, headings, metadata, SITE_URL, AsyncWatchingGlossaryPage() (+73 more)

### Community 7 - "room-session-storage.ts"
Cohesion: 0.10
Nodes (65): clearRoomSessionForDepartureIfMatchNow(), clearRoomSessionIfMatch(), clearRoomSessionIfMatchForTabNow(), confirmRoomSessionForTabNow(), createBoundedSessionValue(), createDepartureRetryRecord(), createParticipantSessionId(), discardPreparedRoomSessionIfMatchNow() (+57 more)

### Community 8 - "auth-client.ts"
Cohesion: 0.05
Nodes (86): assertExtensionLogoutRedirect(), attemptWebsiteLogoutFlow(), AuthCommand, AuthMessage, AuthMessageResponse, buildExtensionConnectUrl(), buildExtensionLogoutUrl(), buildWebUrl() (+78 more)

### Community 9 - "social.ts"
Cohesion: 0.06
Nodes (85): AccountOverviewPage(), dynamic, metadata, db(), acceptFriendInviteLink(), acceptFriendRequest(), acceptFriendshipFromInvite(), acceptRoomInvite() (+77 more)

### Community 10 - "how-to-host-a-crunchyroll-watch-party/page.tsx"
Cohesion: 0.09
Nodes (21): faq, HowToHostACrunchyrollWatchPartyPage(), howToSteps, metadata, SITE_URL, tocHeadings, faq, HowToHostAYoutubeWatchPartyPage() (+13 more)

### Community 11 - "room-invite-notifications.ts"
Cohesion: 0.04
Nodes (107): accountInboxFromBridge(), accountInboxHttpError(), AccountInboxHttpMessage, AccountInboxHttpMessageResponse, AccountInboxUnauthorizedError, decodeAccountInboxResponse(), handleAccountInboxHttpMessage(), isAccountInboxHttpMessage() (+99 more)

### Community 12 - "watch-history.ts"
Cohesion: 0.03
Nodes (78): aggregate(), fail(), fingerprint(), progressFingerprint(), readWatchHistoryGrid(), RecordValue, createWatchHistoryGridGet(), supabaseWatchHistoryGridStore (+70 more)

### Community 13 - "next/link"
Cohesion: 0.04
Nodes (65): metadata, faq, metadata, tocHeadings, WatchActionAnimeWithFriendsPage(), faq, metadata, tocHeadings (+57 more)

### Community 14 - "core/types.ts"
Cohesion: 0.07
Nodes (31): isMediaTimeBuffered(), MediaReadyReason, READY_EVENTS, RemoteSeekAttempt, shouldDeferHostStateSeek(), shouldSeekForHostState(), shouldSeekForRemoteCommand(), shouldThrottleRemoteSeekAttempt() (+23 more)

### Community 15 - "getSession"
Cohesion: 0.10
Nodes (31): AccountFeatureRequestsPage(), metadata, AccountFriendsPage(), dynamic, metadata, AccountLayout(), dynamic, metadata (+23 more)

### Community 16 - "node:assert/strict"
Cohesion: 0.06
Nodes (46): cleanup(), measurementsOutput, pageOutput, requireAcceptedCatalog(), sql(), target, sql(), assertAcceptedCatalogMeasurement() (+38 more)

### Community 17 - "best-anime-to-watch-on-crunchyroll-with-friends/page.tsx"
Cohesion: 0.09
Nodes (15): faq, headings, itemList, metadata, SITE_URL, faq, headings, itemList (+7 more)

### Community 18 - "popup-watch-drawer.tsx"
Cohesion: 0.05
Nodes (73): WEB_HTTP_BASE, PopupEpisodeProgress(), HistoryConsent(), PopupHistorySettings(), BrowseMessage, Parser, PopupWatchBrowseRecovery, PopupWatchBrowseViews (+65 more)

### Community 19 - "PlaybackSyncController"
Cohesion: 0.10
Nodes (8): isMediaSettling(), PendingSourceNavigation, PlaybackSyncController, createHarness(), createHarness(), getSyncCorrection(), PlaybackState, WatchSourceDescriptor

### Community 20 - "p2p-media.ts"
Cohesion: 0.05
Nodes (57): createLocalAudioLevelMeter(), LocalAudioLevelMeter, addOptionalNumbers(), applyP2PCodecPreferences(), copyDefinedStat(), createP2PMediaSignalDedupeKey(), decideP2PSignalConnection(), DEFAULT_STUN_SERVERS (+49 more)

### Community 21 - "next/server"
Cohesion: 0.08
Nodes (54): dynamic, POST(), dynamic, POST(), dynamic, POST(), dynamic, POST() (+46 more)

### Community 22 - "SeoPageLayout"
Cohesion: 0.03
Nodes (49): faq, howToSteps, metadata, tocHeadings, faq, howToSteps, metadata, tocHeadings (+41 more)

### Community 23 - "room-client.ts"
Cohesion: 0.05
Nodes (69): BackgroundPushEvent, dispatchPrivilegedRoomRuntimeMessage(), dispatchRoomDepartureRuntimeMessage(), PrivilegedRoomRuntimeDependencies, RemovedRoomTabDependencies, ROOM_ADMISSION_DEPARTURE_SETTLE_TIMEOUT_MS, waitForAdmissionCompletion(), PrivilegedOverlayContext (+61 more)

### Community 24 - "account.ts"
Cohesion: 0.03
Nodes (65): AcceptedRoomInviteResponse, AcceptedRoomInviteResponseSchema, ACCOUNT_RESPONSE_SCHEMA_VERSION, AccountInboxActiveRoomInviteItemSchema, AccountInboxCountsSchema, AccountInboxFriendRequestItemSchema, AccountInboxItemSchema, AccountInboxMissedRoomInviteItemSchema (+57 more)

### Community 25 - "watch-library.ts"
Cohesion: 0.05
Nodes (73): createRoom(), getActiveRoomByClientRequestId(), listRoomMembers(), RoomMemberRow, RoomRow, UserRow, getLegacyWatchLibraryEntitlements(), ProfileRow (+65 more)

### Community 26 - "popup-app.tsx"
Cohesion: 0.06
Nodes (58): rootElement, accountErrorState(), accountIdentityChanged(), accountLoadingState(), AccountOwnedState, accountReadyState(), AccountRequestGate, AccountRequestToken (+50 more)

### Community 27 - "stripe-env.ts"
Cohesion: 0.12
Nodes (26): POST(), sanitizeDiscordHandle(), POST(), beginStripeEventProcessing(), markStripeEventFailed(), markStripeEventProcessed(), createStripeClient(), getStripeSecretKey() (+18 more)
...
### Community 29 - "RoomDurableObject"
Cohesion: 0.10
Nodes (14): handleRoomWebSocketMessageBoundary(), mediaSeatError(), RoomDurableObject, roomEndedEvent(), sendAndCloseEndedRoomSockets(), endedRoomTombstone, EndRoomCommand, RoomMeterState (+6 more)

### Community 30 - "watch-history-client.ts"
Cohesion: 0.04
Nodes (67): BrowseCommand, BrowseInput, emptyPartition(), handleWatchHistoryHttpMessage(), hasExactKeys(), historyPageTabs, historyReadSequences, inferredObservationDisplayMode() (+59 more)

### Community 31 - "crm-client.tsx"
Cohesion: 0.09
Nodes (30): exportCsvDataAction(), exportSurveyLeadsCsvAction(), contactStatusBadgeClass(), CrmClient(), copyFilteredSurveyLeadsTsv(), runExport(), runExportSurveyLeads(), runPreview() (+22 more)

### Community 32 - "diagnostic-log.ts"
Cohesion: 0.07
Nodes (45): ANIDACHI_BUILD_ID, API_HTTP_BASE, API_WS_BASE, VOICE_KEYWORD_EMOJI, WXT_VAPID_PUBLIC_KEY, appendDiagnosticEntry(), clearDiagnosticEntries(), clearDiagnosticsFromPage() (+37 more)

### Community 33 - "social-client.ts"
Cohesion: 0.10
...
### Community 34 - "device-push.ts"
Cohesion: 0.05
Nodes (60): DELETE(), dynamic, dynamic, POST(), dynamic, GET(), maxDuration, POST() (+52 more)

### Community 35 - "plan-survey-modal.tsx"
Cohesion: 0.14
Nodes (25): FooterPricingCta(), Hero(), JoinDiscordButton(), JoinDiscordButtonProps, trackDiscordClick(), NavPricingButton(), NavPricingLink(), PlanSurveyModal() (+17 more)

### Community 36 - "room-session.ts"
Cohesion: 0.04
Nodes (80): endedRoomLifecycle, lifecycleApi, dynamic, POST(), dynamic, POST(), dynamic, POST() (+72 more)

### Community 37 - "RoomState"
Cohesion: 0.05
Nodes (24): emptyMediaState(), HostStateUpdateErrorCode, HostStateUpdateResult, LEGACY_ROOM_CAPABILITIES, matchesCanonicalFingerprint(), MediaSeatChangeCode, MediaSeatChangeResult, NormalizedRoomSourceUpdate (+16 more)

### Community 38 - "room-departure-retry.ts"
Cohesion: 0.06
...
### Community 39 - "crunchyroll/progress.ts"
Cohesion: 0.06
Nodes (71): isValidHistoryMedia(), normalizeHistoryUrl(), ProviderPlaybackMetadata, SourceAdapterHistoryPolicy, cleanCrunchyrollTitle(), cleanImageUrl(), collectJsonLdSeasonCandidates(), collectJsonLdSeriesCandidates() (+63 more)

### Community 40 - "video/prepare/route.ts"
Cohesion: 0.06
Nodes (89): AccountResult, blobUrlToProxyUrl(), POST(), prepareTikTokImages(), publishToIgAccount(), publishToTtAccount(), AccountResult, blobUrlToProxyUrl() (+81 more)

### Community 41 - "content.tsx"
Cohesion: 0.07
Nodes (29): ContentLifecycleDependencies, ContentLifecycleRuntime, createReactOverlayRenderer(), detectLifecycleResult(), ensurePageStyles(), installMessageComposerKeyboardGuard(), LOCAL_CONTENT_SCRIPT_MATCHES, main() (+21 more)

### Community 42 - "crunchyroll.content.ts"
Cohesion: 0.06
Nodes (65): BitmovinLikePlayer, BitmovinNamespace, BitmovinPlayerConstructor, BitmovinPlayerMethod, clampMediaTime(), clickElement(), CrunchyrollKatamariPlayer, delay() (+57 more)

### Community 43 - "privileged-overlay-intent.ts"
Cohesion: 0.09
...
### Community 44 - "plan-entitlements.ts"
Cohesion: 0.05
Nodes (76): CheckoutTier, getOrCreateStripeCustomer(), loginUrlForRequest(), POST(), dynamic, POST(), generateRefreshToken(), getBillingCustomerByUserId() (+68 more)

### Community 45 - "private-integration-blob.ts"
Cohesion: 0.08
Nodes (38): compat, __dirname, eslintConfig, __filename, clearGoogleAdsTokens(), GoogleAdsStoredTokens, tokenPath(), writeGoogleAdsTokens() (+30 more)

### Community 46 - "room-persistence.ts"
Cohesion: 0.07
Nodes (39): activeRoomLifecycle, EMPTY_ROOM_RETRY_BASE_MS, EMPTY_ROOM_RETRY_MAX_MS, EndingRoomLifecycle, isRecord(), isTimestamp(), parseEndRoomCommand(), parseRoomLifecycleState() (+31 more)

### Community 47 - "[roomId]/connect/route.ts"
Cohesion: 0.16
Nodes (33): dynamic, maxDuration, POST(), dynamic, POST(), activeRoomConflictResponse(), claimActiveRoomSession(), createRoomWithActiveSession() (+25 more)

### Community 48 - "debug-log.ts"
Cohesion: 0.09
Nodes (37): clearDebugLog(), compactDebugData(), compactInputData(), compactVideoData(), copyDebugFields(), DebugEntry, entries, getCompactDebugLogText() (+29 more)

### Community 49 - "html5-video-adapter.ts"
Cohesion: 0.04
...
### Community 50 - "room-media-defaults.ts"
Cohesion: 0.06
...
### Community 51 - "popup-people-panel.test.tsx"
Cohesion: 0.03
Nodes (57): popupInboxBadgeCount(), PopupNavigation(), AccountInboxItem, buildPopupInboxModel(), buildPopupPeopleModel(), cloneFriend(), cloneGroup(), cloneInboxItem() (+49 more)

### Community 52 - "seo-page-layout.tsx"
Cohesion: 0.07
Nodes (32): BestWayToWatchCrunchyrollWithFriendsPage(), faq, metadata, SITE_URL, tocHeadings, DoesEveryoneNeedCrunchyrollPremiumPage(), faq, metadata (+24 more)

### Community 53 - "chrome-extension-demo-async-overlay.tsx"
Cohesion: 0.05
Nodes (37): ActiveWatcher, ASYNC_STEP_LABELS, AsyncDemoOverlayKeyframes(), AsyncDemoOverlayLayer(), BEAT_CAPTIONS, BEAT_TITLES, DemoMode, FRIEND (+29 more)

### Community 54 - "billing.ts"
Cohesion: 0.06
Nodes (39): BillingClient(), formatDate(), PLAN_NAMES, BillingPage(), dynamic, metadata, dynamic, POST (+31 more)

### Community 55 - "watch-library-client.tsx"
Cohesion: 0.06
Nodes (49): AccountWatchLibraryPage(), dynamic, metadata, WatchLibraryCapacity(), bindWatchHistoryPageRefresh(), clampProgress(), deleteConfirmation(), deleteScopeKey() (+41 more)

### Community 56 - "Account Data Watch History Social And Inbox Foundation Design"
Cohesion: 0.06
Nodes (56): Account Data Watch History Social And Inbox Foundation Design, Account Response Runtime Validation, Bounded Notification Recovery, Chrome FCM Endpoint Allowlist, Chrome Web Push Documentation, Compatibility Blocked Friendship, Conditional Invite Response, Cross Surface Acceptance (+48 more)

### Community 57 - "source-navigation.ts"
Cohesion: 0.09
Nodes (20): PlaybackSyncControllerOptions, CanonicalSourceNavigationResult, DefinitionLookup, ensureGenericSource(), ensureSourceForProvider(), navigationRejection(), resolveCanonicalSourceNavigation(), withRoomHash() (+12 more)

### Community 58 - "watch-history-v3.ts"
Cohesion: 0.06
Nodes (87): checkPersonalHistoryOperation(), personalHistoryError(), PersonalHistoryReadFence, paid, withPersonalHistoryRead(), applyPersonalWatchProgress(), PersonalWatchHistoryStore, productionStore (+79 more)

### Community 59 - "p2p-media-harness.mjs"
Cohesion: 0.05
Nodes (84): node:http, node:process, node:readline/promises, playwright, batchLabel(), BLOCKER_PATTERNS, BLOCKER_SCOPED_SELECTORS, clickActionsButton() (+76 more)

### Community 60 - "reaction-shortcuts.ts"
Cohesion: 0.07
...
Cohesion: 0.16
Nodes (26): GET(), appendTouch(), assertLocalCrmRuntime(), blobReadText(), blobUpdateText(), ContactMutation, ContactMutationResult, contactsFilePath() (+18 more)

### Community 63 - "watch-history-v3-routes.ts"
Cohesion: 0.04
Nodes (49): dynamic, POST, dynamic, POST, dynamic, POST, dynamic, GET (+41 more)

### Community 64 - "home-survey.ts"
Cohesion: 0.08
Nodes (28): PlanSurveyOpenContext, isStaleDefaultSurvey(), isValidSegment(), OpenSurveyArgs, PlanSurveyContext, PlanSurveyContextValue, PlanSurveyProvider(), safeParseSurvey() (+20 more)

### Community 65 - "overlay-interface-settings.tsx"
Cohesion: 0.12
Nodes (22): AnidachiLogoMark(), AnidachiLogoMarkProps, MainControlPresentation, ParticipantPillPresentation, ParticipantRailPresentation, resolveMainControlPresentation(), resolveParticipantPillPresentation(), resolveParticipantRailPresentation() (+14 more)

### Community 66 - "interface-preferences.ts"
Cohesion: 0.23
Nodes (13): getDefaultInterfacePreferences(), INTERFACE_PREFERENCES_STORAGE_KEY, INTERFACE_PREFERENCES_VERSION, InterfacePreferencesPatch, InterfacePreferencesV1, isRecord(), parseInterfacePreferences(), updateInterfacePreferences() (+5 more)

### Community 67 - "node:test"
Cohesion: 0.09
Nodes (20): catalogContext, envelope(), progressEvent(), files, browseWatchHistoryOptionsV3(), browseWatchHistorySessionsV3(), browseWatchHistoryTitleEpisodesV3(), browseWatchHistoryV3() (+12 more)

### Community 68 - "account-inbox.ts"
Cohesion: 0.09
...
### Community 69 - "api/src/index.ts"
Cohesion: 0.06
Nodes (39): app, closeInvalidRoomFrame(), closeRoomRateLimitedSocket(), consumeParsedRoomEventBoundary(), consumeRoomFrameBoundary(), departureResponse(), detachResponse(), encode() (+31 more)

### Community 70 - "youtube/adapter.ts"
Cohesion: 0.07
...
### Community 71 - "watch-history-storage.ts"
Cohesion: 0.11
Nodes (28): activeGenerationsFromPartitions(), createWatchHistoryStorage(), clearRebuildableAccountData(), discardAllOtherOwnerOutboxes(), discardOtherOwnerOutbox(), ensureMigration(), otherOwnerPendingSummary(), readRoot() (+20 more)

### Community 72 - "history-browser.tsx"
Cohesion: 0.06
Nodes (39): clock(), episodeLabel(), HistoryBrowser(), InspectorHandle, isTitleWatched(), itemId(), Props, TitleInspector() (+31 more)

### Community 73 - "room-hibernation-runtime.ts"
Cohesion: 0.06
Nodes (17): ConnectParams, connectRoomClient(), fixture(), join(), makeEmptyAlarmDue(), openRoomSocket(), participant(), readRoomRuntime() (+9 more)

### Community 74 - "google-ads/oauth.ts"
Cohesion: 0.11
Nodes (33): dynamic, failRedirect(), GET(), dynamic, GET(), buildSeed(), generateKeywordIdeas(), GenerateKeywordIdeasInput (+25 more)

### Community 75 - "verifyKreatliCrmSession"
Cohesion: 0.07
Nodes (46): dynamic, errorToShortString(), failRedirect(), GET(), dynamic, GET(), dynamic, POST() (+38 more)

### Community 76 - "survey-lead.ts"
Cohesion: 0.14
Nodes (33): GET(), AccountWaitlistStatus, buildResult(), buildSurveyNote(), buildSurveySegments(), creditReferrer(), getAccountWaitlistStatus(), mergeSegments() (+25 more)

### Community 77 - "portfolio-audit.ts"
Cohesion: 0.10
Nodes (39): fetchGa4LandingByChannel(), fetchGa4LandingConversions(), fetchGa4TopPages(), Ga4LandingChannelRow, Ga4LandingConversionRow, Ga4PageRow, resolveGa4PropertyName(), dateRange() (+31 more)

### Community 78 - "react"
Cohesion: 0.09
Nodes (21): AccountNav(), isActive(), ITEMS, BlouLoginForm(), safeNextParam(), BlouLoginPage(), dynamic, metadata (+13 more)

### Community 79 - "createWatchHistoryClient"
Cohesion: 0.12
Nodes (58): canCaptureWatchHistory(), personalEnvelopeEligible(), bestEffortFlushWatchHistoryBeforeSignOut(), browseHardRevision(), browsePath(), browseReadRevision(), browseResponseMatchesQuery(), browseResponseMeta() (+50 more)

### Community 80 - "logDebug"
Cohesion: 0.15
Nodes (8): logDebug(), shouldPrintDebugToConsole(), RoomSendDisposition, configureSender(), countMatches(), planP2PVideoSenderSync(), summarizeP2PSdp(), summarizeTransceivers()

### Community 81 - "blob-reconciliation.ts"
Cohesion: 0.09
Nodes (38): assertContact(), BlobHeadResult, BlobReadResult, CONTACT_STATUSES, contentTypeFor(), CrmMeta, digest(), isObject() (+30 more)

### Community 82 - "src/types.ts"
Cohesion: 0.07
Nodes (31): MAX_ICE_CANDIDATE_BYTES, MAX_REACTION_EMOJI_CHARS, MAX_ROOM_FRAME_BYTES, MAX_SDP_BYTES, CanonicalPlanCodeSchema, ClientP2PSignalEnvelopeSchema, LegacyPlanCodeSchema, MAX_ROOM_HISTORY_ATTESTATION_CHARS (+23 more)

### Community 83 - "invites-client.tsx"
Cohesion: 0.04
Nodes (57): AcceptInviteResponse, AccountInboxItem, acknowledgeInboxPageSeen(), ActiveRoomInvite, Avatar(), formatDate(), FriendRequestRow(), InboxFriendRequest (+49 more)

### Community 84 - "middleware.ts"
Cohesion: 0.12
...
### Community 85 - "Room Flow And P2P Flawless Execution Plan"
Cohesion: 0.09
Nodes (36): Authenticated ICE Endpoint, BFCache Session Resume, Bounded Camera Recovery State, Decoded Frame Stall Recovery, Deferred HMAC IP Abuse Signals, Deferred Relay Privacy Mode, Forced Relay Harness, Four Acceptance Layers (+28 more)
...
### Community 87 - "p2p-media.test.ts"
Cohesion: 0.07
Nodes (14): classifyRemoteVideoActivity(), getP2PAudioTransceiverDirection(), isPoliteP2PPeer(), p2pAudioTrackSwapNeedsNegotiation(), shouldInitiateP2POffers(), dispatchRemoteAudioTrack(), fakeAudioStream(), FakeAudioTrack (+6 more)

### Community 88 - "room-departure.ts"
Cohesion: 0.10
Nodes (31): ConfirmedRoomDepartureOutcome, confirmedRuntimeDeparture(), confirmExplicitRoomDeparture(), ConfirmExplicitRoomDepartureDependencies, departActiveWebsiteRoomFromApi(), departWebsiteRoomFromApi(), explicitDepartureError(), handleActiveRoomRecovery() (+23 more)

### Community 89 - "youtube/player-chrome.ts"
Cohesion: 0.11
...
### Community 90 - "youtube/storage.ts"
Cohesion: 0.08
Nodes (44): clearStateCookie(), dynamic, GET(), getOrigin(), dynamic, GET(), POST(), GET() (+36 more)

### Community 91 - "app/login/page.tsx"
Cohesion: 0.07
Nodes (27): ExtensionConnectMobileConfirm(), FriendInviteClient(), initials(), Props, PublicProfile, readJson(), dynamic, FriendInvitePage() (+19 more)

### Community 92 - "Watch History Crunchyroll Catalog Progress Implementation Plan"
Cohesion: 0.09
...
### Community 93 - "watch-library-routes.test.ts"
Cohesion: 0.10
Nodes (28): dynamic, POST, dynamic, GET, PATCH, dynamic, POST, dynamic (+20 more)

### Community 94 - "cn"
Cohesion: 0.09
Nodes (30): ConnectClient(), ERROR_MESSAGES, IgAccount, IgStatus, TtAccount, TtStatus, YtAccount, YtStatus (+22 more)

### Community 95 - "Production Room Realtime And P2P Hardening Roadmap"
Cohesion: 0.10
Nodes (30): Cloudflare Hibernation Documentation, Durable Idempotent Room Creation, Durable Shared Watch Progress, Durable Source Persistence Pending, Exact Departure Lifecycle, Generation Scoped Signal Replay, Hibernation Alarm Acceptance Pending, Historical Shared Progress Task (+22 more)

### Community 96 - "account-inbox-cache.ts"
Cohesion: 0.08
...
### Community 97 - "overlay-layout-editor.tsx"
Cohesion: 0.10
...
### Community 98 - "session.ts"
Cohesion: 0.09
Nodes (33): dynamic, POST(), dynamic, GET(), loginRedirectUrl(), POST(), refreshSessionFromCookie(), checkoutSessionUserId() (+25 more)

### Community 99 - "pseo-new-guides.tsx"
Cohesion: 0.08
Nodes (21): metadata, metadata, metadata, metadata, metadata, metadata, metadata, metadata (+13 more)

### Community 100 - "participant-disconnect.ts"
Cohesion: 0.07
Nodes (65): acknowledgeParticipantDisconnect(), acknowledgeStoredParticipantDisconnect(), cancelParticipantDisconnectForJoin(), cancelStoredParticipantDisconnectForJoin(), claimDueParticipantDisconnects(), claimDueStoredParticipantDisconnects(), claimParticipantDisconnect(), claimStoredParticipantDisconnect() (+57 more)

### Community 101 - "registry.ts"
Cohesion: 0.12
Nodes (13): SourceAdapterDefinition, findBestVideo(), findPlayerContainer(), findVideosDeep(), isUsableVideo(), scoreVideo(), crunchyrollDefinition, findCrunchyrollPlayerContainer() (+5 more)
...
Cohesion: 0.07
Nodes (27): devDependencies, eslint, eslint-config-next, @eslint/eslintrc, happy-dom, tailwindcss, @tailwindcss/postcss, tsx (+19 more)

### Community 104 - "cli.ts"
Cohesion: 0.16
Nodes (25): contactsToCsv(), isContactDue(), renderTemplate(), Contact, ContactStatus, Touch, assertValidContact(), parseStatus() (+17 more)

### Community 105 - "ghost-cam.ts"
Cohesion: 0.08
Nodes (30): GhostCamOptions, GhostCamSession, IncomingP2PSignalSender, p2pSignalMatchesActiveGeneration(), p2pSignalMetadata(), replayPendingP2PSignals(), syncRemoteVoiceParticipant(), useGhostCam() (+22 more)

### Community 106 - "Invitation Delivery Reliability Implementation Plan"
Cohesion: 0.14
Nodes (22): Invitation Outbox Recovery, Outer Cron Statement Timeout, pg_net Platform Permission Boundary, Supabase Configuration, Automatic Staging Recovery Evidence, Independent Worker Recovery Drain, Invitation Delivery Reliability Implementation Plan, Ordered Staging Cutover (+14 more)

### Community 108 - "watch_history_v2_migration_order_contract.mjs"
Cohesion: 0.15
...
### Community 109 - "Task 1 Shared Session and Departure Contracts"
Cohesion: 0.06
...
### Community 110 - "how-to-sync-youtube-with-friends/page.tsx"
Cohesion: 0.07
...
### Community 111 - ".ensurePeer"
Cohesion: 0.10
Nodes (10): createP2PRtcConfiguration(), createVideoElement(), decideP2PIceRestart(), getNetworkInformation(), mediaElementUsesTrack(), reconcilePeerAction(), shouldProactivelyRestartIceForNetworkSignal(), summarizeIceServers() (+2 more)

### Community 112 - "voice-audio-preferences.ts"
Cohesion: 0.10
Nodes (29): isWithinOverlayHotkeyBoundary(), OVERLAY_HOTKEY_BOUNDARY_ATTRIBUTE, overlayHotkeyBoundaryProps, OverlayInteractionBoundaryProps, ParticipantAudioContourControl(), ParticipantAudioInlineControl(), ParticipantMuteButton(), applyParticipantAudioSliderValue() (+21 more)

### Community 113 - "protocol/src/index.ts"
Cohesion: 0.12
Nodes (24): HistoryObservation, HistoryPolicyInput, historyServerTime(), WatchHistoryCaptureResult, createWatchHistoryController(), apply(), capture(), persist() (+16 more)

### Community 114 - "watch-history-catalog.ts"
Cohesion: 0.08
Nodes (31): createWatchHistoryLease(), parseWatchHistoryLease(), WatchHistoryLease, contextKey(), createWatchHistoryCatalogCoordinator(), begin(), commit(), createWatchHistoryPageResolver() (+23 more)

### Community 115 - "Project Planes"
Cohesion: 0.12
...
### Community 116 - "internal-web-client.ts"
Cohesion: 0.07
Nodes (39): boundedInternalWebCallbackTimeout(), fetchAndReadJsonWithBoundedTimeout(), INTERNAL_WEB_CALLBACK_TIMEOUT_MS, internalWebCallbackConfig(), InternalWebLifecycleEnv, isLoopbackHostname(), notifyWebParticipantDeparted(), notifyWebRoomEnded() (+31 more)

### Community 117 - "overlay-room-rail.tsx"
Cohesion: 0.11
Nodes (18): ParticipantPillVisibility, EMPTY_REACTION_CUE_PARTICIPANT_IDS, participantInitials(), ROOM_RAIL_CLOSE_DELAY_MS, RoomRail(), RoomRailAvatar(), RoomRailProps, isRoomRailEdgeIntent() (+10 more)

### Community 118 - "overlay-layout-model.ts"
Cohesion: 0.13
Nodes (25): clampInteger(), cloneDefinition(), DEFAULT_LAYOUT, getDefaultOverlayLayoutDefinition(), getDefaultOverlayLayoutPreferencesV2(), isRecord(), normalizeCameraSizeStep(), normalizeGridCoordinate() (+17 more)

### Community 119 - "node:fs"
Cohesion: 0.09
Nodes (15): providerDirectories, sharedOverlayRuntimeFiles, sourceAdaptersDirectory, sourceDirectory, source, SOURCE_URL, node:fs, args (+7 more)

### Community 120 - "contact-messages.ts"
Cohesion: 0.13
Nodes (20): POST(), metadata, CATEGORY_LABELS, ContactForm(), CONTACT_CATEGORIES, CONTACT_MESSAGE_SEGMENT, ContactCategory, ContactMessageRecord (+12 more)

### Community 121 - "public-media-blob.test.ts"
Cohesion: 0.09
...
Cohesion: 0.07
Nodes (27): @amplitude/unified, dependencies, @amplitude/unified, @anidachi/protocol, clsx, google-auth-library, jose, lucide-react (+19 more)

### Community 123 - "room-source.ts"
Cohesion: 0.12
Nodes (25): dynamic, POST(), persistRoomSource(), assignCleanString(), handleRoomCreateRequestBody(), invalidRequest(), parseRoomCreateRequestBody(), RoomCreateFailure (+17 more)

### Community 124 - "popup-view-state.ts"
Cohesion: 0.19
Nodes (19): PopupTab, boolean(), forgetPopupView(), HistoryView, PopupView, position(), readPopupHistoryView(), readPopupView() (+11 more)

### Community 126 - "Deferred Together: Together MVP Revision 2"
Cohesion: 0.09
Nodes (32): Account Contracts And Isolation, Account Data History Social And Inbox Foundation, Additive Compatibility Rollout, Atomic Room Invites, Browser Notification Policy, Foundation Progress Reconcile, Friendships And Recent People, Popup And Web Responsibilities (+24 more)

### Community 127 - "background-invite-notification-wiring.test.ts"
Cohesion: 0.40
Nodes (4): boundary, flush(), handlers, start()

### Community 128 - "bridge-client.ts"
Cohesion: 0.13
Nodes (24): isControlRequest(), checkHistoryAbort(), cmsPath(), collectCrunchyrollHistoryCatalog(), HistoryJsonLoader, historyRows(), isCrunchyrollControlResult(), resolveCrunchyrollHistoryMetadata() (+16 more)

### Community 129 - "crunchyroll/player-chrome.ts"
Cohesion: 0.11
...
### Community 131 - "node:path"
Cohesion: 0.11
Nodes (18): alt, contentType, runtime, size, ModuleLoader, __dirname, loadEnvLocal(), main() (+10 more)

### Community 132 - "popup-watch-filters.tsx"
Cohesion: 0.23
Nodes (13): emptyHistoryConditions, periods, PopupHistoryConditions, PopupWatchFilters(), createWatchHistoryDateRange(), isoRange(), localDateStart(), moveLocalCalendarDate() (+5 more)

### Community 133 - "popup-watch-history.test.tsx"
Cohesion: 0.11
Nodes (28): PopupWatchHistoryPanel(), subscribeToPopupWatchHistorySnapshot(), createListWatchHistoryMessage(), click(), clientFixture(), findButton(), findInput(), fixtureBrowseDetail() (+20 more)

### Community 134 - "migrate-private-integration-blobs.ts"
Cohesion: 0.10
...
### Community 135 - "Current operational source of truth"
Cohesion: 0.16
Nodes (17): Native popup dimensions and dark initial surface, Account editor local implementation and pending staging acceptance, Account history capacity without automatic eviction, Current operational source of truth, Owner-bound access lease and original capture authority, D01 amendment: Free retains reading, Resume and deletion, Unified own-player personal history MVP, Recent People from actual co-presence (+9 more)

### Community 136 - "instagram/storage.ts"
Cohesion: 0.17
Nodes (19): clearStateCookie(), dynamic, GET(), getOrigin(), ShortLivedTokenResponse, POST(), clearAllCredentials(), clearBlob() (+11 more)

### Community 137 - "video-adapter.test.ts"
Cohesion: 0.16
Nodes (11): buildWatchSourceDescriptor(), normalizeWatchTitle(), canonicalWatchSourceUrl(), normalizeVideoFingerprint(), sourceProviderFromUrl(), stableFingerprintHash(), createAdapter(), createPlaybackState() (+3 more)
...
### Community 141 - "catalog.ts"
Cohesion: 0.14
Nodes (28): array(), Availability, boundedString(), classifyAvailability(), compareOrder(), compatibleSeason(), CrunchyrollCatalogInput, CrunchyrollCatalogPartialReason (+20 more)

### Community 142 - "privileged-overlay-wiring.test.tsx"
Cohesion: 0.11
...
### Community 143 - "seo-landing-path.ts"
Cohesion: 0.13
Nodes (25): AnalyticsEvents(), onScroll(), ensureReady(), initAmplitudeClient(), startInit(), trackAmplitudeEvent(), UNIFIED_OPTIONS, captureFirstLandingPath() (+17 more)

### Community 144 - "Watch History v3 Local Verification"
Cohesion: 0.12
...
### Community 145 - "Watch History Catalog And Progress Design"
Cohesion: 0.12
...
### Community 148 - "reaction-pop.tsx"
Cohesion: 0.14
Nodes (17): LiveChatMessage, VisibleReaction, clamp(), findReactionAnchor(), REACTION_IDENTITY_CUE_DURATION_MS, REACTION_MOTION_PROFILES, REACTION_VISIBLE_DURATION_MS, ReactionAnchor (+9 more)

### Community 149 - "p2p-ice.ts"
Cohesion: 0.14
Nodes (27): useP2PGhostCam(), connectP2P(), buildIceServersRequest(), CachedIceServers, cachedIceServersByScope, clearP2PIceServersCacheForTest(), cloneIceServers(), dedupeIceServers() (+19 more)

### Community 150 - "background-privileged-room-route.test.ts"
Cohesion: 0.10
Nodes (25): handleRemovedRoomTab(), cleanupRoomAdmissionHandoffForTab(), connectRoomHttpMessage(), RoomAdmissionHandoff, handleRoomTabDeparture(), assertTabId(), clearRoomSessionForClosedTab(), clearRoomSessionForDepartureIfMatch() (+17 more)

### Community 151 - "feature-requests.ts"
Cohesion: 0.13
...
### Community 152 - "app/layout.tsx"
Cohesion: 0.08
Nodes (23): metadata, metadata, geistMono, geistSans, metadata, shouldNoindex, viewport, AnidachiLogoLink() (+15 more)

### Community 153 - "oauth-transaction.ts"
Cohesion: 0.08
Nodes (40): dynamic, GET(), dynamic, GET(), dynamic, GET(), handleOAuthCallback(), HandleOAuthCallbackDependencies (+32 more)

### Community 154 - "Main Repository Monorepo Migration Implementation Plan"
Cohesion: 0.07
...
### Community 155 - "AniDachi Pre-release Security and Reliability Readiness Plan"
Cohesion: 0.13
...
### Community 156 - "Harness"
Cohesion: 0.10
Nodes (9): P2PMediaSessionInput, selectP2PMediaParticipants(), RoomConnectionStatus, P2PSignal, Harness, HarnessState, nativeGetUserMedia, StartOptions (+1 more)

### Community 157 - "AdapterPlaybackSnapshot"
Cohesion: 0.15
...
### Community 158 - "nav-bar-client.tsx"
Cohesion: 0.12
Nodes (16): ContactNavMenu(), fetchNavUser(), isWatchClusterPath(), MeResponse, MobileSignOut(), NavBarClient(), NavUser, PLAN_LABELS (+8 more)

### Community 159 - "sitemap-discovery.ts"
Cohesion: 0.13
...
### Community 160 - "Watch History Room Authority Threat Model"
Cohesion: 0.08
...
### Community 161 - "src/watch-history-grid.ts"
Cohesion: 0.11
Nodes (18): WATCH_HISTORY_PROVIDER_LIMITS, WatchHistoryCapacity, WatchHistoryCapacitySchema, isWatchSpecialSeasonLabel(), Key, WATCH_HISTORY_GRID_PAGE_SIZE, WatchHistoryGridEpisodeSchema, WatchHistoryGridQuery (+10 more)

### Community 162 - "room-media.ts"
Cohesion: 0.11
Nodes (21): Generation, HostMediaRevokeSchema, isRoomMediaPairAllowed(), MediaIntentAckSchema, MediaIntentErrorSchema, MediaIntentSchema, ParticipantMediaStateSchema, participantScope (+13 more)

### Community 163 - "include"
Cohesion: 0.15
Nodes (12): compilerOptions, types, extends, include, src, test, ../../tsconfig.base.json, vitest/globals (+4 more)

### Community 164 - "user-identity.ts"
Cohesion: 0.15
...
### Community 165 - "overlay-room-media-controls.tsx"
Cohesion: 0.15
Nodes (12): getMediaAction(), orderRoomParticipants(), PanelCameraControl(), PanelCameraControlProps, participantInitials(), participantMediaStatus(), participantOrderRank(), RoomPeopleSection() (+4 more)

### Community 166 - "vitest"
Cohesion: 0.06
Nodes (45): canReadWatchHistory(), usesStoredWatchHistorySession(), applyPersonalHistoryResume(), takePersonalHistoryResume(), WATCH_HISTORY_STORAGE_KEY, WatchHistoryStorageRoot, input(), launch() (+37 more)

### Community 167 - "jsonUnauthorizedUnlessKreatliSession"
Cohesion: 0.11
Nodes (21): dynamic, GET(), OPTIONAL, dynamic, GET(), INSTAGRAM_SCOPES, GET(), dynamic (+13 more)

### Community 168 - "top-bubble-reveal.test.tsx"
Cohesion: 0.14
Nodes (12): MainControlVisibility, MainControlRevealPhase, clearTimer(), pointInsideRect(), pointInsideViewport(), TOP_BUBBLE_HIDE_DELAY_MS, TOP_BUBBLE_REVEAL_DELAY_MS, TopBubbleRevealState (+4 more)

### Community 169 - "Commercial Room, P2P, and Watch Progress Architecture Implementation Plan"
Cohesion: 0.08
...
### Community 170 - "Source Adapter Architecture Implementation Plan"
Cohesion: 0.08
...
### Community 171 - "Canonical Runtime Flow"
Cohesion: 0.10
...
### Community 172 - "use-camera-interaction-lock.ts"
Cohesion: 0.13
...
### Community 173 - "artwork-select.ts"
Cohesion: 0.18
...
### Community 175 - "anidachi-seo-aeo-pages.md"
Cohesion: 0.06
Nodes (33): Addy Osmani / technical SEO gate, AEO (answer engines), Conversion and CTAs, Crunchyroll anti-cannibalization map (owned queries), Crunchyroll conversion checklist (required), Crunchyroll conversion stack (required), Crunchyroll Keyword Planner gate (before locking URLs), Crunchyroll measurement note (+25 more)

### Community 176 - "scripts"
Cohesion: 0.10
Nodes (20): scripts, blob:migrate:private, build, cache:jikan, check, crm, crm:reconcile-blobs, dev (+12 more)

### Community 177 - "compilerOptions"
Cohesion: 0.07
Nodes (27): compilerOptions, allowJs, esModuleInterop, incremental, isolatedModules, jsx, lib, module (+19 more)

### Community 178 - "Anidachi Architecture and Stack Notes"
Cohesion: 0.08
...
### Community 179 - "Deferred Together Group History Specification"
Cohesion: 0.12
...
### Community 180 - "canonicalizeRoomSourceUrl"
Cohesion: 0.17
Nodes (19): invalidCreateRoomSourceError(), normalizeCreateRoomInput(), MAX_VIDEO_FINGERPRINT_CHARS, boundedCanonicalRoomSource(), canonicalizeProviderUrl(), canonicalizeRoomSourceUrl(), CanonicalRoomSource, CanonicalRoomSourceUrlResult (+11 more)

### Community 181 - "overlay-layout-runtime.ts"
Cohesion: 0.23
...
### Community 182 - "extension/test/watch-history-browse.test.ts"
Cohesion: 0.13
...
### Community 183 - "Account subscription cancellation"
Cohesion: 0.08
...
### Community 185 - "room-signaling-harness.mjs"
Cohesion: 0.17
Nodes (15): API_DIR, b64url(), Client, __dirname, main(), playbackStateFor(), PORT, rawConnect() (+7 more)

### Community 186 - "api/src/auth.ts"
Cohesion: 0.16
Nodes (23): getSecret(), isBoundedId(), isBoundedUrl(), isPositiveInteger(), RoomHistoryAttestationClaims, signRoomHistoryAttestation(), signRoomTokenForTest(), verifyRoomToken() (+15 more)

### Community 187 - "room-socket-attachment.ts"
Cohesion: 0.09
Nodes (21): VerifiedRoomToken, ROOM_ADMISSION_JOIN_DEADLINE_MS, ROOM_ADMISSION_PENDING_PER_SUBJECT_LIMIT, RoomAdmission, RoomAdmissionJoinResult, RoomAdmissionResult, RoomAdmissionSocket, attachmentToVerifiedRoomToken() (+13 more)

### Community 188 - "RoomMediaSession"
Cohesion: 0.20
Nodes (6): RoomPeopleSectionProps, RoomMediaSession, MediaIntent, ParticipantMediaState, RoomMediaKind, RoomMediaSnapshot

### Community 189 - "Kreatli CRM Data Schema"
Cohesion: 0.13
...
### Community 190 - "db.ts"
Cohesion: 0.06
Nodes (58): ACTIVE_ROOM_CONFLICT_MESSAGE, ActiveRoomAssignment, ActiveRoomClaimDatabaseResult, activeRoomConflictResponseInput(), ActiveRoomCreateDatabaseResult, ActiveRoomReleaseDatabaseResult, ActiveRoomSessionDatabaseError, ActiveRoomSummary (+50 more)

### Community 191 - "Watch History v3 Staging Verification"
Cohesion: 0.14
...
### Community 192 - "Watch History v2 Clean MVP Implementation Plan"
Cohesion: 0.09
...
### Community 193 - "Personal History And Plans MVP Specification"
Cohesion: 0.12
...
### Community 194 - "RecentP2PSignalBuffer"
Cohesion: 0.16
...
### Community 195 - "RoomRateLimiter"
Cohesion: 0.19
Nodes (4): CLASS_LIMITS, RoomEventClass, RoomRateLimiter, RoomSubjectRateLimiters

### Community 196 - "overlay-layout-editor.test.tsx"
Cohesion: 0.10
Nodes (5): OverlayLayoutEditorProps, OverlayLayoutContext, OverlayLayoutDefinition, measuredLayoutContext, RenderedEditor

### Community 197 - "room-invite-target-status.ts"
Cohesion: 0.17
Nodes (15): finalizeStatuses(), GROUP_STATUS_ORDER, isNewerRecipientEntry(), mergeInviteRecipients(), mergeRecipientEntry(), mergeRoomInviteTargetStatus(), mergeTargetRecipients(), RecipientStatusEntry (+7 more)

### Community 198 - "watch_history_v3_catalog_read_states_contract.mjs"
Cohesion: 0.11
Nodes (13): begin(), cases, commit(), failed, first, foreign, omitted, outputPath (+5 more)

### Community 199 - "connect/page.tsx"
Cohesion: 0.17
Nodes (16): dynamic, ExtensionConnectPage(), metadata, Props, createExtensionAuthLoginRedirect(), EXTENSION_AUTH_HANDOFF_TTL_SECONDS, extensionAuthHandoffKey(), extensionAuthLoginRedirectForEnvelope() (+8 more)

### Community 200 - "public.browse_watch_history_v3"
Cohesion: 0.10
...
### Community 201 - "Development Flow Quality System Plan"
Cohesion: 0.10
...
### Community 202 - "LinkedIn Sales Navigator Connection Requests"
Cohesion: 0.10
...
### Community 205 - "extension-codes.ts"
Cohesion: 0.19
Nodes (17): dynamic, POST(), dynamic, GET(), consumeExtensionAuthCode(), ConsumeExtensionAuthCodeInput, createExtensionAuthCode(), CreateExtensionAuthCodeInput (+9 more)

### Community 206 - "protocol/package.json"
Cohesion: 0.11
Nodes (18): dependencies, zod, devDependencies, typescript, vitest, exports, typescript, vitest (+10 more)

### Community 207 - "AniDachi Repository Overview"
Cohesion: 0.08
Nodes (25): Feature to Staging to Production Git Flow, Graphify Development Workflow, Git And Release Flow, Graphify Usage, Runtime Environments, Staging / Release Notes, Workspace Package Globs, AniDachi Repository Overview (+17 more)

### Community 208 - "Anidachi Project Operating Manual"
Cohesion: 0.10
...
### Community 209 - "Shared Watch Progress Tracker"
Cohesion: 0.15
...
### Community 210 - "Development Workflow Hardening Implementation Plan"
Cohesion: 0.10
...
### Community 211 - "Plan Code Canonicalization And Billing Cleanup Implementation Plan"
Cohesion: 0.10
...
### Community 212 - "e2e/package.json"
Cohesion: 0.18
Nodes (10): esbuild, devDependencies, esbuild, playwright, playwright, name, private, scripts (+2 more)

### Community 213 - "anidachi-auth/watch-history-access.ts"
Cohesion: 0.05
Nodes (50): dynamic, GET, dynamic, GET, dynamic, GET, runtime, dynamic (+42 more)

### Community 214 - "api/package.json"
Cohesion: 0.07
Nodes (28): dependencies, @anidachi/protocol, hono, jose, devDependencies, @cloudflare/vitest-pool-workers, @cloudflare/workers-types, typescript (+20 more)

### Community 216 - "hotkeys.ts"
Cohesion: 0.10
Nodes (24): getEmojiHotkey(), getHotkeyAction(), hasBlockedModifier(), HotkeyAction, HotkeyEventLike, HotkeyState, isEditableElement(), isEditableEventTarget() (+16 more)

### Community 217 - "getExtensionSessionFromAuthorization"
Cohesion: 0.37
Nodes (12): dynamic, POST(), dynamic, POST(), reportRoomDepartureOutcome(), endHostLobbyForActiveSession(), getActiveRoomSessionAssignment(), releaseActiveRoomSession() (+4 more)

### Community 218 - "YouTube Playback Synchronization Hardening Implementation Plan"
Cohesion: 0.11
...
### Community 219 - "Watch Drawer Browse Local Verification"
Cohesion: 0.12
...
### Community 220 - "protocol/src/auth.ts"
Cohesion: 0.12
Nodes (19): Base64UrlSchema, EXTENSION_AUTH_CODE_MAX_CHARS, EXTENSION_AUTH_REDIRECT_URI_MAX_CHARS, EXTENSION_AUTH_STATE_MAX_CHARS, ExtensionAuthClientIdSchema, ExtensionAuthCodeSchema, ExtensionAuthError, ExtensionAuthErrorCodeSchema (+11 more)

### Community 221 - "dev-check.mjs"
Cohesion: 0.15
Nodes (17): args, changedFiles(), classify(), commands, dedupe(), fail(), files, isDocs() (+9 more)

### Community 222 - "release-channel-build.test.ts"
Cohesion: 0.12
...
### Community 223 - "components.json"
Cohesion: 0.11
Nodes (17): aliases, components, hooks, lib, ui, utils, iconLibrary, rsc (+9 more)

### Community 224 - "public.apply_personal_watch_progress_v1"
Cohesion: 0.13
...
### Community 225 - "Survey → Subscription Conversion (Planner Notes)"
Cohesion: 0.11
...
### Community 226 - "Crunchyroll Adapter Notes"
Cohesion: 0.14
...
### Community 227 - "Anidachi Development Environments"
Cohesion: 0.11
...
### Community 228 - "OpenClaw: YouTube Shorts posting"
Cohesion: 0.11
...
### Community 229 - "Account Data Watch History Social Inbox Foundation Design"
Cohesion: 0.13
Nodes (15): Durable Client Recovery, Open Popup Inbox Convergence, Account Data Watch History Social Inbox Foundation Design, Account Isolation, Account Request Generation Fence, Client Recovery Intents, Independent Corrupt Cache Recovery, Migration And Rollout (+7 more)
...
### Community 231 - "best-anime-movies-to-watch-with-friends/page.tsx"
Cohesion: 0.13
Nodes (10): faq, headings, itemList, metadata, SITE_URL, faq, headings, itemList (+2 more)

### Community 232 - "RoomClient"
Cohesion: 0.22
Nodes (5): buildRoomWebSocketUrl(), createRoomConnectionId(), isOlderHistoryBoundary(), RoomClient, sameHistoryBoundary()

### Community 233 - "VideoAdapter"
Cohesion: 0.09
Nodes (9): ActiveAdapterPlaybackOptions, useActiveAdapterPlayback(), readCurrentResourceDisplay(), OverlayAppProps, ActiveAdapterHooks, AdapterManager, VideoAdapter, Harness() (+1 more)

### Community 234 - "Environment And Secrets Matrix"
Cohesion: 0.14
Nodes (13): ANIDACHI_NOTIFICATION_DRAIN_SECRET, Change Checklist, Cloudflare, Cloudflare Configuration, Environment And Secrets Matrix, Environment Separation, GitHub Actions, GitHub Actions Configuration (+5 more)

### Community 235 - "Chrome Web Store Listing — AniDachi Extension"
Cohesion: 0.12
...
### Community 238 - "Watch History Local Read Implementation Plan"
Cohesion: 0.17
...
### Community 239 - "Real-WebRTC Two-browser P2P Harness"
Cohesion: 0.12
...
### Community 240 - "generate-extension-icons.mjs"
Cohesion: 0.15
Nodes (16): node:zlib, CHECK_ONLY, chunk(), crc32(), encodePng(), OUTPUT_DIR, paethPredictor(), PNG_SIGNATURE (+8 more)

### Community 241 - "demo/package.json"
Cohesion: 0.12
Nodes (16): devDependencies, typescript, vite, vitest, typescript, vitest, name, private (+8 more)

### Community 242 - "ghost-cam-size.ts"
Cohesion: 0.22
...
### Community 243 - "room-client-auth.test.ts"
Cohesion: 0.08
Nodes (12): PreparedRoomSession, confirmedRoomSession(), confirmRoomSession, ControlledWebSocket, FakeWebSocket, preparedRoomSession, roomConnectionResponse(), roomHistoryAuthority() (+4 more)

### Community 244 - "tiktok/storage.ts"
Cohesion: 0.26
...
Cohesion: 0.15
Nodes (26): addContactAction(), applyImportAction(), CrmActionState, deleteContactAction(), guard(), ImportPreviewResult, logTouchAction(), nowIso() (+18 more)

### Community 246 - "discord-contact.tsx"
Cohesion: 0.18
...
### Community 247 - "watch-history-authority.ts"
Cohesion: 0.17
...
Cohesion: 0.22
Nodes (9): @biomejs/biome, devDependencies, @biomejs/biome, turbo, typescript, vitest, turbo, typescript (+1 more)

### Community 249 - "Social Rooms Subscriptions Execution Plan"
Cohesion: 0.17
...
### Community 250 - "watch_history_capacity_concurrency_contract.mjs"
Cohesion: 0.20
Nodes (14): args, contend(), event(), labels, literal(), live, marker, ports (+6 more)

### Community 251 - "20260814010000_watch_history_v2_foundation.sql"
Cohesion: 0.25
...
### Community 253 - "Voice Controls and Participant Audio Implementation Plan"
Cohesion: 0.13
...
### Community 254 - "Interface Visibility Settings Design"
Cohesion: 0.13
...
### Community 257 - "best-anime-to-watch-with-friends/page.tsx"
Cohesion: 0.16
Nodes (9): faq, headings, itemList, metadata, faq, metadata, tocHeadings, DataTableColumn (+1 more)

### Community 258 - "AniDachi SEO Content Guidelines"
Cohesion: 0.14
...
### Community 262 - "Handoff For AI Working On AniDachi Site Pages"
Cohesion: 0.14
...
### Community 265 - "Two-phase Production Promotion"
Cohesion: 0.16
...
### Community 266 - "Waitlist And CRM Durable Storage Recovery Implementation Plan"
Cohesion: 0.23
...
### Community 267 - "demo/tsconfig.json"
Cohesion: 0.18
Nodes (10): compilerOptions, lib, extends, include, DOM, DOM.Iterable, src, ../../tsconfig.base.json (+2 more)

### Community 268 - "anidachi-vs-twoseven/page.tsx"
Cohesion: 0.15
Nodes (10): AniDachiVsTwosevenPage(), faq, headings, metadata, SITE_URL, faq, howToSteps, metadata (+2 more)

### Community 269 - "extension/package.json"
Cohesion: 0.05
Nodes (40): dependencies, @anidachi/protocol, lucide-react, motion, react, react-dom, zustand, devDependencies (+32 more)

### Community 270 - "popup-styles.ts"
Cohesion: 0.28
Nodes (6): extensionThemeTokens, popupStyles, popupWatchHistoryStyles, overlayStyles, getNumericProperty(), getRule()

### Community 271 - "Inactive personal-history staging delivery packet"
Cohesion: 0.22
Nodes (12): External acceptance remains separate from local and delivery evidence, Personal-history MVP implementation evidence, Populated staging-chain preservation rehearsal, Canonical personal progress authority, Control, live and client plane ownership, Contract-first cross-plane changes, Feature PR, staging acceptance and separate production release, Delivered additive DB prerequisite PR #273 (+4 more)

### Community 272 - "voice-activity.ts"
Cohesion: 0.13
...
### Community 273 - "20260904114914_account_inbox_push_outbox.sql"
Cohesion: 0.20
...
### Community 275 - "Codex-Hosted Semantic Extraction"
Cohesion: 0.17
...
### Community 276 - "One canonical personal episode progress row in Supabase"
Cohesion: 0.24
...
### Community 277 - "Global Constraints"
Cohesion: 0.15
...
### Community 278 - "V1 Product Decisions (Historical)"
Cohesion: 0.17
...
### Community 279 - "Shared Pure Visibility Policy"
Cohesion: 0.12
Nodes (21): Manual Acceptance and Draft PR Gate, Accessible Interface Settings View, Finite Policy-Driven Preview, Main-Control Preference Integration, September 4 Microphone-Independent Main Control Correction, Persistent Compact Participant Rail Integration, Versioned Interface Preference Model, Shared Pure Visibility Policy (+13 more)

### Community 280 - "pull_request_template.md"
Cohesion: 0.20
Nodes (9): Affected Planes, AI Contribution Notes, Changed Areas, Docs / Graphify, Goal, Quality Gate, Risk Class, Rollback (+1 more)

### Community 281 - "telemetry.ts"
Cohesion: 0.16
Nodes (12): Env, drainUrl(), scheduled(), SchedulerEnv, AnalyticsEngineDataset, buildRoomDataPoint(), emitRoomTelemetry(), RoomDataPoint (+4 more)

### Community 282 - "room-session-storage.test.ts"
Cohesion: 0.09
Nodes (11): ROOM_SESSION_INSTALL_ID_STORAGE_KEY, ROOM_SESSION_RECOVERY_HINT_STORAGE_KEY, ROOM_SESSION_STORAGE_MESSAGE_TYPE, RoomSessionStorageMessage, RoomSessionStorageResponse, BackgroundDependencies, DelayedRemoveStorageArea, MemoryStorageArea (+3 more)

### Community 283 - "kreatli-email-crm/page.tsx"
Cohesion: 0.31
Nodes (8): dynamic, KreatliCrmPage(), listContactMessages(), parseContactMessages(), listFeatureRequests(), parseFeatureRequests(), crmDataDir(), listTemplateSlugs()

### Community 284 - "lucide-react"
Cohesion: 0.20
Nodes (11): ExtensionCheck(), COPY, RoomMobileHandoff(), RoomMobileHandoffProps, AccountOverview(), AccountWaitlistCard(), Props, isMobileUserAgent() (+3 more)

### Community 285 - "public.get_account_inbox_page_v2"
Cohesion: 0.23
...
### Community 286 - "public.commit_room_usage_day_v1"
Cohesion: 0.26
...
### Community 287 - "watch_history_v3.test.sql"
Cohesion: 0.17
...
### Community 288 - "Project Knowledge Map"
Cohesion: 0.17
...
### Community 289 - "Popup People And Social Directory Implementation Plan"
Cohesion: 0.17
...
### Community 291 - "smoke-staging-web.mjs"
Cohesion: 0.29
...
### Community 292 - "Incremental Re-extraction"
Cohesion: 0.18
...
### Community 293 - "Download on the App Store Badge"
Cohesion: 0.31
...
### Community 294 - "20260816090000_watch_history_v2_bounded_read.sql"
Cohesion: 0.18
...
### Community 295 - "public.active_room_sessions"
Cohesion: 0.29
...
### Community 296 - "Personal History And Plans MVP — Implementation Evidence"
Cohesion: 0.20
Nodes (10): Initial Local Checks, Personal History And Plans MVP — Implementation Evidence, Preserved Baseline, Remaining Acceptance, Task 1 — Contracts And Early Media Experiment, Task 3 — Personal Writer, Read Fences And Unified Browse, Task 4 — Recent People From Confirmed Presence, Task 5 Reviewed Personal Capture and Resume (+2 more)

### Community 297 - "Resources Progress Menu Implementation Plan"
Cohesion: 0.18
...
### Community 299 - "Watch History Capacity"
Cohesion: 0.12
Nodes (18): Free plan, History retention and capacity, Host and viewer entitlements, Plus plan, Pro plan, Public media acceptance, Social pricing model, Provider capacity amendment (+10 more)

### Community 300 - "p2p-scorecard.mjs"
Cohesion: 0.29
Nodes (10): analyzeFile(), fail(), get(), median(), ms(), pairKind(), parseExport(), paths (+2 more)

### Community 301 - "overlay-media-session.ts"
Cohesion: 0.33
...
### Community 302 - "room-quota-display.ts"
Cohesion: 0.31
...
### Community 303 - "MAX_PARTICIPANT_ID_CHARS"
Cohesion: 0.29
Nodes (7): loadVoiceModePreference(), parseVoiceModePreference(), persistVoiceModePreference(), StorageAreaLike, VOICE_MODE_PREFERENCE_VERSION, voiceModePreferenceStorageKeyForUser(), MAX_PARTICIPANT_ID_CHARS

### Community 304 - "watch-history-v3-sql.test.ts"
Cohesion: 0.20
...
### Community 305 - "discord.ts"
Cohesion: 0.33
Nodes (8): dynamic, GET(), buildDiscordAuthUrl(), DISCORD_SCOPES, exchangeDiscordCode(), getCredentials(), getRedirectUri(), OAuthProfile

### Community 306 - "SEO Trust & Authority plan (2026-07-28)"
Cohesion: 0.20
...
### Community 307 - "AniDachi Logo Asset"
Cohesion: 0.33
...
### Community 308 - "personal_mvp_activation_contract.mjs"
Cohesion: 0.28
Nodes (8): activation, args, delay(), policy(), readme, sql(), target, until()

### Community 309 - "20260819133849_auth_channel_rotation.sql"
Cohesion: 0.38
...
### Community 313 - "Completed Public-Product Recovery Record"
Cohesion: 0.20
...
### Community 314 - "Watch Drawer Browse Implementation Plan"
Cohesion: 0.20
...
### Community 315 - "Personal History MVP Design"
Cohesion: 0.15
Nodes (10): Architectural boundaries, D01 Retention and Free access, D02 Frozen room capabilities, D03 Explicit media admission, D04 Editor deferred, D05 Short access lease, Personal History MVP Design, Plan matrix and hosting time (+2 more)

### Community 316 - "AniDachi Contributor Startup Contract"
Cohesion: 0.19
...
### Community 317 - "react-dom/client"
Cohesion: 0.27
Nodes (6): mockGeometry(), ReactionHarness(), rect(), remoteParticipant(), remoteReaction(), react-dom/client

### Community 318 - "panel-account-title.tsx"
Cohesion: 0.39
...
### Community 319 - "overlay-layout-ghost-preview.tsx"
Cohesion: 0.33
...
### Community 320 - "Conversion metrics (GA4)"
Cohesion: 0.22
...
### Community 321 - "Host Avatar Asset"
Cohesion: 0.28
...
### Community 322 - "public.apply_watch_progress_v2"
Cohesion: 0.22
...
### Community 323 - "20260907194413_personal_history_access.sql"
Cohesion: 0.25
...
### Community 324 - "graphify reference: extra exports and benchmark"
Cohesion: 0.22
Nodes (8): graphify reference: extra exports and benchmark, Step 6b - Wiki (only if --wiki flag), Step 7 - Neo4j export (only if --neo4j or --neo4j-push flag), Step 7a - FalkorDB export (only if --falkordb or --falkordb-push flag), Step 7b - SVG export (only if --svg flag), Step 7c - GraphML export (only if --graphml flag), Step 7d - MCP server (only if --mcp flag), Step 8 - Token reduction benchmark (only if total_words > 5000)

### Community 325 - "Executor's Feedback or Assistance Requests"
Cohesion: 0.22
...
### Community 326 - "Social Rooms, Friends, Groups, And Subscriptions Execution Plan"
Cohesion: 0.22
...
### Community 327 - "Global Constraints"
Cohesion: 0.15
Nodes (14): AniDachi Project Knowledge Map, Graph-First, Source-Verified Navigation, P2P Block 6 Graph Navigation, Pull Request Graph and Source Evidence, Scoped Local Graphs, Shared Graph Artifact Allowlist, Global Constraints, Interface Visibility Settings Implementation Plan (+6 more)

### Community 329 - "room-invite-notification-runtime.test.ts"
Cohesion: 0.22
Nodes (5): alarms, diagnostic, json(), registered(), state

### Community 330 - "room-tab-lock.ts"
Cohesion: 0.46
Nodes (5): acquireRoomTabLock(), getLockManager(), isRoomTabLockSupported(), LockManagerLike, releaseRoomTabLock()

### Community 331 - "overlay-layout-engine.test.ts"
Cohesion: 0.31
...
### Community 332 - "include"
Cohesion: 0.15
Nodes (12): compilerOptions, jsx, types, extends, include, src, test, vitest/globals (+4 more)

### Community 333 - "Haruto Avatar Image"
Cohesion: 0.39
...
### Community 334 - "Natsuki Avatar Asset"
Cohesion: 0.43
...
### Community 341 - "Global Constraints"
Cohesion: 0.25
...
### Community 342 - "Global Constraints"
Cohesion: 0.25
...
### Community 343 - "Approved Voice UX Simplification V2"
Cohesion: 0.25
...
### Community 344 - "Production Acceptance Snapshot: 685 Survey Leads"
Cohesion: 0.29
...
### Community 345 - "YouTube Adapter Notes"
Cohesion: 0.25
...
### Community 346 - "linkedin/package.json"
Cohesion: 0.20
Nodes (9): dependencies, playwright, playwright, name, private, scripts, chrome, send (+1 more)

### Community 347 - "AniDachi Apple Touch Icon"
Cohesion: 0.43
...
### Community 348 - "AniDachi Web Logo Asset"
Cohesion: 0.52
...
### Community 349 - "public.watch_sessions"
Cohesion: 0.62
...
### Community 350 - "Participant Session Identity"
Cohesion: 0.28
...
### Community 351 - "Project Status Board"
Cohesion: 0.29
...
### Community 352 - "Site, Extension, Auth, and Database Integration Notes"
Cohesion: 0.29
...
### Community 353 - "protocol/tsconfig.json"
Cohesion: 0.22
Nodes (8): compilerOptions, types, extends, include, src, test, ../../tsconfig.base.json, vitest/globals

### Community 354 - "Voice UX Simplification V2"
Cohesion: 0.29
...
### Community 355 - "Participant Audio Controls"
Cohesion: 0.29
...
### Community 357 - "Watch History Catalog And Progress Implementation Plan"
Cohesion: 0.29
...
### Community 360 - "AniDachi App Icon"
Cohesion: 0.40
...
### Community 365 - "public.claim_active_room_session_v1"
Cohesion: 0.47
...
### Community 366 - "anidachi_private.tick_inbox_push_scheduler"
Cohesion: 0.40
...
### Community 367 - "20260908071729_room_media_negotiation_fence.sql"
Cohesion: 0.40
...
### Community 368 - "personal_history_access.test.sql"
Cohesion: 0.33
Nodes (3): access_results, saved_order, saved_progress

### Community 373 - "watch_history_v3_episode_previews.test.sql"
Cohesion: 0.40
Nodes (3): bounded_preview, pg_temp.preview_tail(), preview_pages

### Community 375 - "graphify reference: query, path, explain"
Cohesion: 0.33
Nodes (5): For /graphify explain, For /graphify path, graphify reference: query, path, explain, Step 0 — Constrained query expansion (REQUIRED before traversal), Step 1 — Traversal

### Community 376 - "YouTube keyword bank + templates (Keyword Planner US)"
Cohesion: 0.33
...
### Community 377 - "High-level Task Breakdown (historical)"
Cohesion: 0.33
...
### Community 378 - "Sitewide CTA → Plan-Picker Survey (Planner Notes)"
Cohesion: 0.33
...
### Community 379 - "findKatamariPlayerFromReactNode"
Cohesion: 0.48
...
### Community 380 - "best-psychological-anime-to-watch-with-friends/page.tsx"
Cohesion: 0.29
Nodes (5): faq, headings, itemList, metadata, SITE_URL

### Community 381 - "Billing And Entitlements"
Cohesion: 0.33
...
### Community 384 - "Always-Visible Compact Participant Pills"
Cohesion: 0.40
Nodes (5): Audio-Adjustment Expansion Latch, Listener-Local Audio Controls and Compact Mute Marker, Always-Visible Compact Participant Pills, Participant Rail Eligibility and Displayable-Video Deduplication, Smart Participant Pills

### Community 385 - "Final Staging Runtime Acceptance"
Cohesion: 0.33
...
### Community 386 - "Exact Assignment Release"
Cohesion: 0.33
...
### Community 387 - "Accepted Catalog Read"
Cohesion: 0.33
...
### Community 388 - "smoke-worker.mjs"
Cohesion: 0.40
Nodes (3): baseUrl, fetchJson(), url()

### Community 389 - "apps/api Agent Instructions"
Cohesion: 0.40
Nodes (4): apps/api Agent Instructions, Rules, Source Of Truth, Verification

### Community 390 - "apps/extension Agent Instructions"
Cohesion: 0.40
Nodes (4): apps/extension Agent Instructions, Rules, Source Of Truth, Verification

### Community 391 - "apps/web Agent Instructions"
Cohesion: 0.40
Nodes (4): apps/web Agent Instructions, Rules, Source Of Truth, Verification

### Community 392 - "CTA and conversion map (internal)"
Cohesion: 0.40
Nodes (4): CTA and conversion map (internal), Placements, Surfaces, Template IDs (`page_template` in events)

### Community 393 - "best-romance-anime-to-watch-with-friends/page.tsx"
Cohesion: 0.29
Nodes (5): faq, headings, itemList, metadata, SITE_URL

### Community 394 - "createWebsiteRoomFromApi"
Cohesion: 0.47
Nodes (6): connectWebsiteRoomFromApi(), createWebsiteRoomFromApi(), endWebsiteRoomFromApi(), parseQuotaSummary(), parseRoomCapabilities(), websiteRoomHttpError()

### Community 395 - "20260525_anidachi_auth.sql"
Cohesion: 0.80
Nodes (4): public.refresh_tokens, public.room_members, public.rooms, public.users

### Community 396 - "20260620_billing_entitlements.sql"
Cohesion: 0.50
Nodes (4): public.billing_customers, public.stripe_events, public.subscriptions, public.users

### Community 397 - "20260621_social_profiles_friends_recent.sql"
Cohesion: 0.60
Nodes (4): public.friendships, public.profiles, public.recent_people_hidden, public.users

### Community 398 - "public.friend_groups"
Cohesion: 0.60
Nodes (4): public.friend_group_members, public.friend_groups, public, public.users

### Community 399 - "public.list_recent_people_evidence_v2"
Cohesion: 0.40
...
### Community 416 - "vercel.json"
Cohesion: 0.50
Nodes (3): regions, $schema, sfo1

### Community 417 - "graphify reference: add a URL and watch a folder"
Cohesion: 0.50
Nodes (3): For /graphify add, For --watch, graphify reference: add a URL and watch a folder

### Community 418 - "graphify reference: commit hook and native CLAUDE.md integration"
Cohesion: 0.50
Nodes (3): For git commit hook, For native CLAUDE.md integration, graphify reference: commit hook and native CLAUDE.md integration

### Community 419 - "graphify reference: incremental update and cluster-only"
Cohesion: 0.50
Nodes (3): For --cluster-only, For --update (incremental re-extraction), graphify reference: incremental update and cluster-only

### Community 420 - "Experimental Features"
Cohesion: 0.50
Nodes (3): Experimental Features, Hold Fire Super Reaction, P2P Media Transport

### Community 421 - "Manual Staging Release Gate"
Cohesion: 0.50
Nodes (4): Manual Staging Release Gate, Ultra-Light P2P Reliability, P2P Media Engine Block, Release Gates and Rollback

### Community 422 - "Privacy Security And Abuse Controls"
Cohesion: 0.50
Nodes (4): Abuse Controls, Chrome Web Store, Privacy Security And Abuse Controls, Supabase

### Community 423 - "Audio Speech Activity Classification"
Cohesion: 0.50
...
### Community 427 - "Five-Object CRM Reconciliation"
Cohesion: 0.50
...
## Knowledge Gaps
- **3491 isolated node(s):** `name`, `private`, `version`, `type`, `build` (+3486 more)
...
- **Why does `react` connect `react` to `use-interface-preferences.test.tsx`, `pricing-copy.ts`, `overlay-app.tsx`, `popup-watch-filters.tsx`, `popup-watch-history.test.tsx`, `privileged-overlay-wiring.test.tsx`, `getSession`, `seo-landing-path.ts`, `overlay-unmount-cleanup.test.tsx`, `popup-watch-drawer.tsx`, `reaction-pop.tsx`, `feature-requests.ts`, `app/layout.tsx`, `popup-app.tsx`, `lucide-react`, `[slug]/page.tsx`, `nav-bar-client.tsx`, `crm-client.tsx`, `Harness`, `plan-survey-modal.tsx`, `overlay-room-media-controls.tsx`, `vitest`, `top-bubble-reveal.test.tsx`, `use-camera-interaction-lock.ts`, `html5-video-adapter.ts`, `room-media-defaults.ts`, `popup-people-panel.test.tsx`, `seo-page-layout.tsx`, `chrome-extension-demo-async-overlay.tsx`, `billing.ts`, `watch-library-client.tsx`, `reaction-shortcuts.ts`, `react-dom/client`, `panel-account-title.tsx`, `overlay-layout-ghost-preview.tsx`, `home-survey.ts`, `overlay-interface-settings.tsx`, `interface-preferences.ts`, `overlay-layout-editor.test.tsx`, `history-browser.tsx`, `invites-client.tsx`, `overlay-interface-settings.test.tsx`, `hotkeys.ts`, `app/login/page.tsx`, `cn`, `account-inbox-cache.ts`, `overlay-layout-editor.tsx`, `VideoAdapter`, `ghost-cam.ts`, `voice-audio-preferences.ts`, `overlay-room-rail.tsx`, `discord-contact.tsx`, `contact-messages.ts`, `popup-view-state.ts`?**
  _High betweenness centrality (0.078) - this node is a cross-community bridge._
- **Why does `vitest` connect `vitest` to `overlay-app.tsx`, `auth-client.ts`, `room-invite-notifications.ts`, `watch-history.ts`, `core/types.ts`, `popup-watch-drawer.tsx`, `room-client.ts`, `account.ts`, `popup-app.tsx`, `watch-history-client.ts`, `diagnostic-log.ts`, `social-client.ts`, `room-session.ts`, `RoomState`, `room-departure-retry.ts`, `crunchyroll/progress.ts`, `privileged-overlay-intent.ts`, `room-persistence.ts`, `debug-log.ts`, `html5-video-adapter.ts`, `room-media-defaults.ts`, `popup-people-panel.test.tsx`, `source-navigation.ts`, `reaction-shortcuts.ts`, `overlay-interface-settings.tsx`, `interface-preferences.ts`, `api/src/index.ts`, `youtube/adapter.ts`, `room-hibernation-runtime.ts`, `src/types.ts`, `p2p-media.test.ts`, `room-departure.ts`, `youtube/player-chrome.ts`, `account-inbox-cache.ts`, `overlay-layout-editor.tsx`, `participant-disconnect.ts`, `registry.ts`, `ghost-cam.ts`, `voice-audio-preferences.ts`, `protocol/src/index.ts`, `watch-history-catalog.ts`, `internal-web-client.ts`, `overlay-room-rail.tsx`, `overlay-layout-model.ts`, `node:fs`, `popup-view-state.ts`, `background-invite-notification-wiring.test.ts`, `bridge-client.ts`, `crunchyroll/player-chrome.ts`, `ice-servers.ts`, `popup-watch-filters.tsx`, `popup-watch-history.test.tsx`, `video-adapter.test.ts`, `catalog.ts`, `privileged-overlay-wiring.test.tsx`, `p2p-ice.ts`, `background-privileged-room-route.test.ts`, `AdapterPlaybackSnapshot`, `src/watch-history-grid.ts`, `room-media.ts`, `user-identity.ts`, `overlay-room-media-controls.tsx`, `top-bubble-reveal.test.tsx`, `use-camera-interaction-lock.ts`, `artwork-select.ts`, `canonicalizeRoomSourceUrl`, `overlay-layout-runtime.ts`, `extension/test/watch-history-browse.test.ts`, `api/src/auth.ts`, `room-socket-attachment.ts`, `RoomMediaSession`, `RecentP2PSignalBuffer`, `RoomRateLimiter`, `overlay-layout-editor.test.tsx`, `room-invite-target-status.ts`, `anidachi-auth/watch-history-access.ts`, `overlay-interface-settings.test.tsx`, `hotkeys.ts`, `protocol/src/auth.ts`, `release-channel-build.test.ts`, `VideoAdapter`, `ghost-cam-size.ts`, `room-client-auth.test.ts`, `use-interface-preferences.test.tsx`, `popup-styles.ts`, `voice-activity.ts`, `telemetry.ts`, `room-session-storage.test.ts`, `overlay-media-session.ts`, `room-quota-display.ts`, `react-dom/client`, `panel-account-title.tsx`, `overlay-layout-ghost-preview.tsx`, `room-invite-notification-runtime.test.ts`, `room-tab-lock.ts`, `overlay-layout-engine.test.ts`, `overlay-unmount-cleanup.test.tsx`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `next/server` connect `next/server` to `instagram/storage.ts`, `watch-history.ts`, `getSession`, `feature-requests.ts`, `oauth-transaction.ts`, `stripe-env.ts`, `device-push.ts`, `room-session.ts`, `jsonUnauthorizedUnlessKreatliSession`, `video/prepare/route.ts`, `plan-entitlements.ts`, `[roomId]/connect/route.ts`, `discord.ts`, `billing.ts`, `watch-history-v3.ts`, `store.ts`, `watch-history-v3-routes.ts`, `node:test`, `account-inbox.ts`, `history-browser.tsx`, `google-ads/oauth.ts`, `verifyKreatliCrmSession`, `survey-lead.ts`, `extension-codes.ts`, `middleware.ts`, `anidachi-auth/watch-history-access.ts`, `getExtensionSessionFromAuthorization`, `youtube/storage.ts`, `watch-library-routes.test.ts`, `session.ts`, `tiktok/storage.ts`, `contact-messages.ts`, `public-media-blob.test.ts`, `room-source.ts`?**
...
- **Should `getResolvedSiteOrigin` be split into smaller, more focused modules?**
  _Cohesion score 0.021075581395348836 - nodes in this community are weakly interconnected._