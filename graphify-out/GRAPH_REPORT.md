...
## Corpus Check
- Full corpus: 1,330 files · ~1,310,866 words
- Incremental slice processed: 15 changed files (10 code, 5 documents)
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 12380 nodes · 27494 edges · 770 communities (446 shown, 282 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 438 edges (avg confidence: 0.85)
...
- Production Recovery And Release
...
- Server Module
- Page Module
- Watch History V2 Migration Order
- Room Invite Notifications
- Scratchpad Module
...
## Communities (770 total, 282 thin omitted)

### Community 0 - "External References"
Cohesion: 0.02
Nodes (113): faq, headings, metadata, SITE_URL, faq, headings, metadata, SITE_URL (+105 more)

### Community 1 - "Pricing Copy"
Cohesion: 0.03
Nodes (132): faq, headings, metadata, SITE_URL, faq, headings, metadata, SITE_URL (+124 more)

### Community 2 - "Link Module"
Cohesion: 0.02
Nodes (103): metadata, faq, itemList, metadata, tocHeadings, faq, headings, metadata (+95 more)

### Community 3 - "Responsive Compare Table"
Cohesion: 0.02
Nodes (108): faq, itemList, metadata, tocHeadings, faq, headings, metadata, SITE_URL (+100 more)

### Community 4 - "Room Persistence"
Cohesion: 0.03
Nodes (115): departureResponse(), detachResponse(), Env, mediaSeatError(), hasValidInternalAuthorization(), drainUrl(), scheduled(), SchedulerEnv (+107 more)

### Community 5 - "Seo Page Layout"
Cohesion: 0.02
Nodes (96): faq, howToSteps, metadata, SITE_URL, tocHeadings, CrunchyrollWatchPartyWithDiscordPage(), faq, howToSteps (+88 more)

### Community 6 - "Overlay App"
Cohesion: 0.03
Nodes (101): HOLD_FIRE_SUPER_REACTION_EXPERIMENT, normalizeExperimentFlag(), useGhostCam(), attachAndPlayVideoElement(), ANIDACHI_COMPOSER_OPEN_ATTR, ANIDACHI_MESSAGE_COMPOSER_SHORTCUT_EVENT, ANIDACHI_MESSAGE_COMPOSER_SUBMIT_EVENT, isMessageComposerShortcutEvent() (+93 more)

### Community 7 - "Popup App"
Cohesion: 0.03
Nodes (77): rootElement, accountErrorState(), accountIdentityChanged(), accountLoadingState(), AccountOwnedState, accountReadyState(), AccountRequestGate, AccountRequestToken (+69 more)

### Community 8 - "Room Invite Notifications"
Cohesion: 0.04
Nodes (88): accountInboxFromBridge(), accountInboxHttpError(), AccountInboxHttpMessage, AccountInboxHttpMessageResponse, AccountInboxUnauthorizedError, decodeAccountInboxResponse(), handleAccountInboxHttpMessage(), isAccountInboxHttpMessage() (+80 more)

### Community 9 - "Room Session Storage"
Cohesion: 0.07
Nodes (89): assertTabId(), clearRoomSession(), clearRoomSessionDepartureIfMatch(), clearRoomSessionForClosedTab(), clearRoomSessionForDepartureIfMatch(), clearRoomSessionForDepartureIfMatchNow(), clearRoomSessionIfMatch(), clearRoomSessionIfMatchForTabNow() (+81 more)

### Community 10 - "Room State"
Cohesion: 0.04
Nodes (45): emptyMediaState(), HostStateUpdateErrorCode, HostStateUpdateResult, LEGACY_ROOM_CAPABILITIES, matchesCanonicalFingerprint(), MediaSeatChangeCode, MediaSeatChangeResult, NormalizedRoomSourceUpdate (+37 more)

### Community 11 - "Social API Operations"
Cohesion: 0.05
Nodes (83): AccountFriendsPage(), dynamic, metadata, AccountLayout(), dynamic, GET(), FriendInvitePage(), getExtensionUserProfile() (+75 more)

### Community 12 - "Oauth Transaction"
Cohesion: 0.05
Nodes (70): dynamic, GET(), dynamic, GET(), dynamic, GET(), dynamic, GET() (+62 more)

### Community 13 - "Html5 Video Adapter"
Cohesion: 0.05
Nodes (42): useActiveAdapterPlayback(), duckVideoVolume(), getDocumentVideoKey(), getStableVideoSourceKey(), Html5VideoAdapter, arePlayerOverlayGeometriesEqual(), DEFAULT_PLAYER_OVERLAY_GEOMETRY, normalizeBoundedValue() (+34 more)

### Community 14 - "Auth Client"
Cohesion: 0.05
Nodes (82): assertExtensionLogoutRedirect(), attemptWebsiteLogoutFlow(), AuthCommand, AuthMessage, AuthMessageResponse, buildExtensionConnectUrl(), buildExtensionLogoutUrl(), buildWebUrl() (+74 more)

### Community 15 - "Get Guide Links"
Cohesion: 0.03
Nodes (78): AniDachiVsRavePage(), AniDachiVsTelepartyPage(), AsyncWatchingGlossaryPage(), faq, metadata, tocHeadings, DubVsSubGlossaryPage(), faq (+70 more)

### Community 16 - "Room Client"
Cohesion: 0.04
Nodes (73): BackgroundPushEvent, dispatchPrivilegedRoomRuntimeMessage(), dispatchRoomDepartureRuntimeMessage(), PrivilegedRoomRuntimeDependencies, RemovedRoomTabDependencies, ROOM_ADMISSION_DEPARTURE_SETTLE_TIMEOUT_MS, waitForAdmissionCompletion(), PrivilegedOverlayContext (+65 more)

### Community 17 - "Room Session"
Cohesion: 0.05
Nodes (72): lifecycleApi, dynamic, POST(), dynamic, POST(), dynamic, POST(), activeRoomChanged() (+64 more)

### Community 18 - "Social Client"
Cohesion: 0.08
Nodes (77): PopupApp(), acceptFriendRequest(), acceptFriendRequestFromApi(), acceptFriendRequestHttpMessage(), acceptInviteHttpMessage(), acceptRoomInvite(), acceptRoomInviteFromApi(), addFriendGroupMember() (+69 more)

### Community 19 - "Shared Protocol Types"
Cohesion: 0.05
Nodes (71): getSecret(), isBoundedId(), isBoundedUrl(), isPositiveInteger(), RoomHistoryAttestationClaims, signRoomHistoryAttestation(), signRoomTokenForTest(), VerifiedRoomToken (+63 more)

### Community 20 - "Playback Sync Controller"
Cohesion: 0.09
...
### Community 21 - "Middleware Module"
Cohesion: 0.05
Nodes (48): ACCESS_TOKEN_COOKIE, catalogContext, envelope(), progressEvent(), lifecycleApi, files, AUTH_REFRESH_PATH, isStaticOrInternalAssetPath() (+40 more)

### Community 22 - "Watch Library"
Cohesion: 0.05
...
### Community 24 - "Log Debug"
Cohesion: 0.09
Nodes (12): logDebug(), createP2PRtcConfiguration(), createVideoElement(), formatCameraErrorMessage(), getCandidateProtocol(), getCandidateType(), mediaElementUsesTrack(), P2PMediaController (+4 more)

### Community 25 - "Account Module"
Cohesion: 0.03
Nodes (68): dynamic, parseRecentPeopleResponse(), AcceptedRoomInviteResponse, AcceptedRoomInviteResponseSchema, ACCOUNT_RESPONSE_SCHEMA_VERSION, AccountInboxActiveRoomInviteItemSchema, AccountInboxCountsSchema, AccountInboxFriendRequestItemSchema (+60 more)

### Community 26 - "Plan Entitlements"
Cohesion: 0.06
Nodes (63): CheckoutTier, getOrCreateStripeCustomer(), loginUrlForRequest(), POST(), dynamic, POST(), getBillingCustomerByUserId(), upsertBillingCustomer() (+55 more)

### Community 27 - "Server Module"
Cohesion: 0.08
Nodes (52): dynamic, POST(), dynamic, POST(), dynamic, POST(), dynamic, POST() (+44 more)

### Community 28 - "Room Durable Object"
Cohesion: 0.09
Nodes (7): closeInvalidRoomFrame(), consumeRoomFrameBoundary(), encode(), handleRoomWebSocketMessageBoundary(), RoomDurableObject, roomEndedEvent(), sendAndCloseEndedRoomSockets()

### Community 29 - "Route Module"
Cohesion: 0.08
Nodes (58): BillingPage(), dynamic, metadata, dynamic, maxDuration, POST(), dynamic, POST() (+50 more)

### Community 30 - "Watch History"
Cohesion: 0.03
Nodes (69): WatchLibraryResponseSchema, AccountGenerationSchema, addAggregateIssues(), CatalogRequestBaseSchema, CrunchyrollHistoryIdentitySchema, DisplayTitleSchema, DurableIdSchema, HttpUrlSchema (+61 more)

### Community 31 - "External References"
Cohesion: 0.03
Nodes (50): faq, headings, metadata, SITE_URL, faq, headings, metadata, SITE_URL (+42 more)
...
### Community 34 - "Popup Watch Drawer"
Cohesion: 0.06
Nodes (61): PopupEpisodeProgress(), BrowseMessage, Parser, PopupWatchBrowseRecovery, PopupWatchBrowseViews, usePopupWatchBrowse(), detailCursor(), detailMeta() (+53 more)

### Community 35 - "Crm Client"
Cohesion: 0.06
...
### Community 36 - "Cli Module"
Cohesion: 0.09
Nodes (53): POST(), GET(), alt, contentType, runtime, size, isContactDue(), appendTouch() (+45 more)

### Community 37 - "Cn Module"
Cohesion: 0.06
Nodes (44): ConnectClient(), ERROR_MESSAGES, IgAccount, IgStatus, TtAccount, TtStatus, YtAccount, YtStatus (+36 more)

### Community 38 - "Interface Preferences"
Cohesion: 0.05
...
### Community 39 - "Room Media Defaults"
Cohesion: 0.06
...
### Community 40 - "Device Push"
Cohesion: 0.06
Nodes (51): DELETE(), dynamic, POST(), AccountInboxPushResult, defaultDevicePushRepository, deferInboxChangedPushToUsers(), DeferredTaskScheduler, deliverAccountInboxChanged() (+43 more)

### Community 41 - "Watch History Storage"
Cohesion: 0.06
Nodes (52): parseWatchHistoryLease(), contextKey(), createWatchHistoryCatalogCoordinator(), begin(), commit(), createWatchHistoryPageResolver(), abortCatalogs(), eligible() (+44 more)

### Community 42 - "Content Module"
Cohesion: 0.05
...
### Community 43 - "Diagnostic Log"
Cohesion: 0.06
Nodes (49): cleanClassName(), clearDebugLog(), compactDebugData(), compactInputData(), compactVideoData(), controlsDebugSnapshot(), copyDebugFields(), DebugEntry (+41 more)

### Community 44 - "Progress Module"
Cohesion: 0.07
...
### Community 45 - "Popup People Panel.Test"
Cohesion: 0.05
...
### Community 46 - "Room Departure Retry"
Cohesion: 0.06
Nodes (40): acknowledgeRoomDepartureAdmissionHandoff(), claimRoomDepartureAdmissionHandoffCleanup(), createRoomDepartureRetryCoordinator(), defaultRoomDepartureRetryCoordinator, departPersistedRoomSession(), drainRoomDepartureRetries(), earliestAttempt(), exactIdentity() (+32 more)

### Community 47 - "Crunchyroll.Content Module"
Cohesion: 0.07
...
### Community 48 - "Create Watch History Client"
Cohesion: 0.11
Nodes (59): canCaptureWatchHistory(), personalEnvelopeEligible(), bestEffortFlushWatchHistoryBeforeSignOut(), browseHardRevision(), browsePath(), browseReadRevision(), browseResponseMatchesQuery(), browseResponseMeta() (+51 more)

### Community 49 - "Privileged Overlay Intent"
Cohesion: 0.08
Nodes (47): isAuthMessage(), activeRoomAuthorityClaimExecutionsByTab, assertIntentResponse(), authorityStorageKey(), authorityStorageMutationQueuesByTab, clearPrivilegedOverlayContextForTab(), clearRoomAuthorityClaimIfOwned(), createClaimOwnerId() (+39 more)

### Community 50 - "Chrome Extension Demo Async Overlay"
Cohesion: 0.06
...
### Community 52 - "Private Integration Blob"
Cohesion: 0.07
Nodes (44): POST(), GET(), compat, __dirname, eslintConfig, __filename, clearGmailTokens(), GmailStoredTokens (+36 more)

### Community 53 - "Route Module"
Cohesion: 0.11
...
### Community 55 - "P2P Media Harness"
Cohesion: 0.07
Nodes (53): esbuild, playwright, node:process, node:readline/promises, dependencies, playwright, name, private (+45 more)

### Community 56 - "Index Module"
Cohesion: 0.08
Nodes (44): HISTORY_OBSERVATION_SUSPENDED, HistoryObservation, HistoryObservationResult, HistoryPolicyInput, isValidHistoryMedia(), normalizeHistoryUrl(), ProviderPlaybackMetadata, SourceAdapterHistoryPolicy (+36 more)

### Community 57 - "Watch History Client"
Cohesion: 0.06
Nodes (45): dynamic, GET, dynamic, GET, dynamic, GET, dynamic, GET (+37 more)

### Community 58 - "Db Module"
Cohesion: 0.08
Nodes (47): ACTIVE_ROOM_CONFLICT_MESSAGE, ActiveRoomAssignment, ActiveRoomClaimDatabaseResult, activeRoomConflictResponseInput(), ActiveRoomCreateDatabaseResult, ActiveRoomReleaseDatabaseResult, ActiveRoomSessionDatabaseError, ActiveRoomSummary (+39 more)

### Community 59 - "Home Survey"
Cohesion: 0.09
Nodes (38): FooterPricingCta(), Hero(), JoinDiscordButton(), JoinDiscordButtonProps, trackDiscordClick(), ContactNavMenu(), fetchNavUser(), isWatchClusterPath() (+30 more)

### Community 60 - "Watch History V3 Routes"
Cohesion: 0.04
Nodes (41): dynamic, POST, dynamic, POST, dynamic, POST, dynamic, GET (+33 more)

### Community 61 - "Room State"
Cohesion: 0.07
...
### Community 62 - "Source Navigation"
Cohesion: 0.06
Nodes (33): isMediaTimeBuffered(), MediaReadyReason, READY_EVENTS, RemoteSeekAttempt, shouldDeferHostStateSeek(), shouldSeekForHostState(), shouldSeekForRemoteCommand(), shouldThrottleRemoteSeekAttempt() (+25 more)

### Community 63 - "Popup Watch Drawer"
Cohesion: 0.06
Nodes (39): HistoryConsent(), PopupHistorySettings(), PopupWatchCapacityNotice(), PopupWatchHistoryPanel(), defaultPopupWatchHistoryClient, PopupWatchHistoryClient, PopupWatchHistorySnapshot, requestPopupWatchHistory() (+31 more)

### Community 64 - "Source Navigation"
Cohesion: 0.07
Nodes (36): invalidCreateRoomSourceError(), normalizeCreateRoomInput(), CanonicalSourceNavigationResult, DefinitionLookup, ensureGenericSource(), navigationRejection(), resolveCanonicalSourceNavigation(), withRoomHash() (+28 more)

### Community 65 - "Create Watch History Client"
Cohesion: 0.06
Nodes (43): BrowseCommand, BrowseInput, defaultStoredWatchHistorySession(), emptyPartition(), handleWatchHistoryHttpMessage(), hasExactKeys(), historyPageTabs, historyReadSequences (+35 more)

### Community 66 - "Diagnostic Log"
Cohesion: 0.07
Nodes (45): ANIDACHI_BUILD_ID, API_HTTP_BASE, API_WS_BASE, VOICE_KEYWORD_EMOJI, WEB_HTTP_BASE, WXT_VAPID_PUBLIC_KEY, appendDiagnosticEntry(), clearDiagnosticEntries() (+37 more)

### Community 67 - "Oauth Module"
Cohesion: 0.09
Nodes (40): dynamic, failRedirect(), GET(), dynamic, GET(), buildSeed(), generateKeywordIdeas(), GenerateKeywordIdeasInput (+32 more)

### Community 68 - "Page Module"
Cohesion: 0.06
Nodes (30): metadata, metadata, FriendInviteClient(), initials(), Props, PublicProfile, readJson(), dynamic (+22 more)

### Community 69 - "P2P Media Harness"
Cohesion: 0.09
Nodes (48): node:http, API_DIR, appendWorkerVar(), buildWorkerArgs(), bundleHarness(), cleanupHarness(), closeHarnessServer(), createVoiceTestWav() (+40 more)

### Community 70 - "Graphify Module"
Cohesion: 0.04
...
### Community 71 - "Reaction Shortcuts"
Cohesion: 0.07
...
### Community 74 - "Watch History V3 Routes"
Cohesion: 0.08
Nodes (35): dynamic, GET, checkPersonalHistoryOperation(), personalHistoryError(), PersonalHistoryReadFence, paid, withPersonalHistoryRead(), applyPersonalWatchProgress() (+27 more)

### Community 75 - "Room Persistence"
Cohesion: 0.10
...
### Community 76 - "Room Hibernation Runtime"
Cohesion: 0.06
...
### Community 77 - "Watch History V3 Routes"
Cohesion: 0.07
Nodes (35): AccountWatchLibraryPage(), dynamic, metadata, Dependencies, loadWatchLibraryData(), dynamic, GET, dynamic (+27 more)

### Community 78 - "Watch Library Client"
Cohesion: 0.08
...
### Community 79 - "Account Inbox Cache"
Cohesion: 0.08
Nodes (32): ACCOUNT_INBOX_CACHE_VERSION, accountInboxCacheKeyForUser(), accountInboxItemInstanceKey(), CachedAccountInbox, clearCachedAccountInboxForUser(), getCachedAccountInboxForUser(), inboxStructure(), isCanonicalUtcTimestamp() (+24 more)

### Community 80 - "Json Unauthorized Unless Kreatli Session"
Cohesion: 0.09
Nodes (34): dynamic, GET(), OPTIONAL, dynamic, GET(), INSTAGRAM_SCOPES, clearCookies(), dynamic (+26 more)

### Community 81 - "Extension Codes"
Cohesion: 0.08
...
### Community 82 - "Verify Kreatli Crm Session"
Cohesion: 0.11
Nodes (36): dynamic, errorToShortString(), failRedirect(), GET(), dynamic, GET(), POST(), createGmailOAuth2() (+28 more)

### Community 83 - "Account Runtime And Acceptance"
Cohesion: 0.05
...
### Community 84 - "Overlay Layout Editor"
Cohesion: 0.10
...
### Community 85 - "Blob Reconciliation"
Cohesion: 0.09
Nodes (38): assertContact(), BlobHeadResult, BlobReadResult, CONTACT_STATUSES, contentTypeFor(), CrmMeta, digest(), isObject() (+30 more)

### Community 86 - "Room Socket Attachment"
Cohesion: 0.06
Nodes (15): app, closeRoomRateLimitedSocket(), consumeParsedRoomEventBoundary(), getRoomEventClass(), isRoomEventInScope(), persistRoomEndAfterDisablingAutoResponse(), ROOM_ADMISSION_JOIN_DEADLINE_MS, ROOM_ADMISSION_PENDING_PER_SUBJECT_LIMIT (+7 more)

### Community 87 - "Internal Web Client"
Cohesion: 0.08
...
### Community 88 - "Room Departure"
Cohesion: 0.10
Nodes (32): handleRemovedRoomTab(), ConfirmedRoomDepartureOutcome, confirmedRuntimeDeparture(), confirmExplicitRoomDeparture(), ConfirmExplicitRoomDepartureDependencies, departActiveWebsiteRoomFromApi(), departWebsiteRoomFromApi(), explicitDepartureError() (+24 more)

### Community 89 - "Overlay Room Rail"
Cohesion: 0.09
Nodes (26): ParticipantPillVisibility, MainControlPresentation, MainControlRevealPhase, ParticipantPillPresentation, ParticipantRailPresentation, resolveMainControlPresentation(), resolveParticipantPillPresentation(), resolveParticipantRailPresentation() (+18 more)

### Community 90 - "Voice Audio Preferences"
Cohesion: 0.09
Nodes (26): MicrophoneIntent, shouldPublishMicrophone(), ParticipantAudioContourControl(), ParticipantAudioControlProps, ParticipantAudioInlineControl(), ParticipantMuteButton(), applyParticipantAudioSliderValue(), clampParticipantAudioVolume() (+18 more)

### Community 91 - "Registry Module"
Cohesion: 0.09
Nodes (16): SourceAdapterDefinition, findBestVideo(), findPlayerContainer(), findVideosDeep(), isUsableVideo(), scoreVideo(), crunchyrollDefinition, findCrunchyrollPlayerContainer() (+8 more)

### Community 92 - "Player Chrome"
Cohesion: 0.10
...
### Community 93 - "Watch History"
Cohesion: 0.08
Nodes (33): dynamic, GET, runtime, HISTORY_PRIVATE_HEADERS, aggregate(), fail(), fingerprint(), progressFingerprint() (+25 more)

### Community 94 - "Watch History Crunchyroll Catalog Progress"
Cohesion: 0.09
...
### Community 95 - "Vitest Module"
Cohesion: 0.10
Nodes (25): canReadWatchHistory(), createWatchHistoryLease(), historyServerTime(), WatchHistoryLease, usesStoredWatchHistorySession(), applyPersonalHistoryResume(), takePersonalHistoryResume(), input() (+17 more)

### Community 96 - "Watch Library Routes.Test"
Cohesion: 0.10
Nodes (28): dynamic, POST, dynamic, GET, PATCH, dynamic, POST, dynamic (+20 more)

### Community 97 - "Ghost Cam"
Cohesion: 0.11
Nodes (27): GhostCamOptions, GhostCamSession, IncomingP2PSignalSender, p2pSignalMatchesActiveGeneration(), p2pSignalMetadata(), replayPendingP2PSignals(), syncRemoteVoiceParticipant(), useP2PGhostCam() (+19 more)

### Community 98 - "P2P Media"
Cohesion: 0.06
...
### Community 99 - "Room Client"
Cohesion: 0.07
Nodes (18): assertRoomHttpResponse(), bridgeError(), buildRoomWebSocketUrl(), connectWebsiteRoom(), createRoom(), createRoomHttpMessage(), sendRoomHttpMessage(), confirmedRoomSession() (+10 more)

### Community 100 - "Pseo New Guides"
Cohesion: 0.08
Nodes (21): metadata, metadata, metadata, metadata, metadata, metadata, metadata, metadata (+13 more)

### Community 101 - "Account Data Watch History Social"
Cohesion: 0.08
...
### Community 104 - "Adapter Playback Snapshot"
Cohesion: 0.09
...
### Community 105 - "Plan Entitlements"
Cohesion: 0.10
Nodes (27): dynamic, POST(), dynamic, GET(), loginRedirectUrl(), POST(), refreshSessionFromCookie(), checkoutSessionUserId() (+19 more)

### Community 106 - "Home Survey"
Cohesion: 0.10
Nodes (29): Props, AnalyticsEvents(), onScroll(), Props, WaitlistReferralCard(), ensureReady(), initAmplitudeClient(), startInit() (+21 more)

### Community 107 - "Room Flow And P2 P"
Cohesion: 0.09
...
### Community 108 - "Room State"
Cohesion: 0.12
Nodes (9): RoomSendDisposition, RoomPeopleSectionProps, createRoomConnectionId(), RoomClient, RoomMediaSession, MediaIntent, ParticipantMediaState, RoomMediaKind (+1 more)

### Community 109 - "Strict Module"
Cohesion: 0.09
Nodes (26): assertPreTransitionPrerequisite(), assertV3Prerequisite(), DISPOSABLE_ACKNOWLEDGEMENT, DISPOSABLE_MARKER_NAME, PRE_TRANSITION_MIGRATION, readConfiguredIdentity(), requireDisposableTarget(), requireOutputPath() (+18 more)

### Community 110 - "Task 1 Shared Session And"
Cohesion: 0.06
...
### Community 111 - "Overlay Layout Model"
Cohesion: 0.10
...
### Community 112 - "Store Module"
Cohesion: 0.11
Nodes (27): POST(), dynamic, KreatliCrmPage(), CONTACT_CATEGORIES, CONTACT_MESSAGE_SEGMENT, ContactCategory, ContactMessageRecord, isContactCategory() (+19 more)

### Community 113 - "Survey Lead"
Cohesion: 0.16
Nodes (29): GET(), AccountWaitlistStatus, buildResult(), buildSurveyNote(), buildSurveySegments(), creditReferrer(), getAccountWaitlistStatus(), mergeSegments() (+21 more)

### Community 114 - "History Browser"
Cohesion: 0.08
Nodes (29): dynamic, { GET, POST }, runtime, createWatchHistoryEditorHandlers(), fail(), historyEditorError(), productionStore, ack (+21 more)

### Community 115 - "Home Survey"
Cohesion: 0.08
...
### Community 116 - "Strict Module"
Cohesion: 0.09
Nodes (26): dir, identity(), json(), quote(), snapshot(), sql(), target, cleanup() (+18 more)

### Community 117 - "Overlay Layout Engine"
Cohesion: 0.14
...
### Community 118 - "Popup Watch Drawer"
Cohesion: 0.11
Nodes (28): subscribeToPopupWatchHistorySnapshot(), createListWatchHistoryMessage(), click(), clientFixture(), findButton(), findInput(), fixtureBrowseDetail(), fixtureBrowseEpisodes() (+20 more)

### Community 119 - "Player Chrome"
Cohesion: 0.10
...
### Community 120 - "Page Module"
Cohesion: 0.10
Nodes (18): BlouLoginForm(), safeNextParam(), BlouLoginPage(), dynamic, metadata, dynamic, metadata, RoomStatusResponse (+10 more)

### Community 121 - "Dependencies Module"
Cohesion: 0.06
...
### Community 122 - "Catalog Module"
Cohesion: 0.12
Nodes (21): checkHistoryAbort(), cmsPath(), collectCrunchyrollHistoryCatalog(), HistoryJsonLoader, historyRows(), isCrunchyrollControlResult(), resolveCrunchyrollHistoryMetadata(), safeGuid() (+13 more)

### Community 123 - "Public Media Blob.Test"
Cohesion: 0.09
...
### Community 125 - "Layout Module"
Cohesion: 0.09
Nodes (21): metadata, geistMono, geistSans, metadata, shouldNoindex, viewport, AnidachiLogoLink(), AuthMinimalNav() (+13 more)

### Community 126 - "Route Module"
Cohesion: 0.17
Nodes (26): dynamic, GET(), safeRefreshTiktok(), GET(), processInstagramAccount(), processTikTokAccount(), GET(), processInstagramReel() (+18 more)

### Community 127 - "Inventory Module"
Cohesion: 0.06
...
### Community 129 - "Feature Requests"
Cohesion: 0.12
Nodes (23): POST(), CATEGORY_LABELS, buildEmail(), clientIp(), FeatureRequestPostDependencies, handleFeatureRequestPost(), rateBucket, rateLimited() (+15 more)

### Community 130 - "Room Source"
Cohesion: 0.12
...
### Community 131 - "Production Room Realtime And P2"
Cohesion: 0.10
...
### Community 133 - "Room Session"
Cohesion: 0.13
Nodes (19): dynamic, GET(), maxDuration, POST(), dynamic, POST(), dynamic, POST() (+11 more)

### Community 134 - "Migrate Private Integration Blobs"
Cohesion: 0.12
...
### Community 136 - "Anidachi Auth Integration Implementation Plan"
Cohesion: 0.07
...
### Community 138 - "Privileged Overlay Wiring.Test"
Cohesion: 0.11
...
### Community 140 - "Watch History V3 Local Verification"
Cohesion: 0.12
...
### Community 141 - "Watch History Catalog And Progress"
Cohesion: 0.12
...
### Community 144 - "Private Integration Blob"
Cohesion: 0.15
Nodes (22): clearStateCookie(), dynamic, GET(), getOrigin(), ShortLivedTokenResponse, POST(), GET(), ensureCredentials() (+14 more)

### Community 145 - "Main Repository Monorepo Migration Implementation"
Cohesion: 0.07
...
### Community 146 - "Ani Dachi Pre Release Security"
Cohesion: 0.13
...
### Community 149 - "Watch History Room Authority Threat"
Cohesion: 0.08
...
### Community 155 - "Anidachi Seo Aeo Pages"
Cohesion: 0.08
...
### Community 156 - "Personal History Mvp Staging Delivery"
Cohesion: 0.12
...
### Community 157 - "Commercial Room, P2 P, And"
Cohesion: 0.08
...
### Community 158 - "Source Adapter Architecture Implementation Plan"
Cohesion: 0.08
...
### Community 159 - "Canonical Runtime Flow"
Cohesion: 0.10
...
### Community 160 - "Voice Audio Preferences"
Cohesion: 0.12
...
### Community 161 - "P2 Pmedia Controller"
Cohesion: 0.18
Nodes (6): MediaCaptureIntents, MicrophoneTerminalFailureReason, classifyMicrophoneTerminalFailure(), formatMicrophoneErrorMessage(), microphoneErrorName(), p2pAudioTrackSwapNeedsNegotiation()
...
### Community 166 - "Scripts Module"
Cohesion: 0.08
Nodes (23): name, private, scripts, blob:migrate:private, build, cache:jikan, check, crm (+15 more)

### Community 167 - "Node:Fs Module"
Cohesion: 0.09
Nodes (16): challenge, codeHash, psqlArgs, query(), stateHash, waitForActivity(), legacyCodeHash, psqlArgs (+8 more)

### Community 168 - "Compiler Options"
Cohesion: 0.08
Nodes (23): compilerOptions, allowJs, esModuleInterop, incremental, isolatedModules, jsx, module, moduleResolution (+15 more)

### Community 169 - "Anidachi Architecture And Stack Notes"
Cohesion: 0.08
...
### Community 170 - "Deferred Together Group History Specification"
Cohesion: 0.12
...
Cohesion: 0.16
Nodes (16): node:url, API_DIR, b64url(), Client, __dirname, main(), playbackStateFor(), PORT (+8 more)

### Community 172 - "Ani Dachi Repository Overview"
Cohesion: 0.09
...
### Community 173 - "Overlay Layout Runtime"
Cohesion: 0.23
...
### Community 174 - "Verify Kreatli Crm Session"
Cohesion: 0.14
Nodes (15): dynamic, POST(), Body, dynamic, POST(), LoginForm(), dynamic, KreatliCrmLoginPage() (+7 more)

### Community 175 - "Portfolio Audit"
Cohesion: 0.16
...
### Community 176 - "Account Subscription Cancellation"
Cohesion: 0.11
...
### Community 177 - "Overlay Layout Engine V2 Design"
Cohesion: 0.09
...
### Community 178 - "Deferred Together: Together Mvp Revision"
Cohesion: 0.13
...
### Community 185 - "Auth Artifact Cleanup.Test"
Cohesion: 0.10
...
### Community 186 - "Invitation Delivery Reliability Implementation Plan"
Cohesion: 0.10
Nodes (21): ANIDACHI_NOTIFICATION_DRAIN_SECRET, Configuration change evidence checklist, Cloudflare, Distinct Worker and analytics bindings by environment, Narrow CRM-only private Blob authority, Environment And Secrets Matrix, GitHub deployment and extension environment ownership, Matched per-environment Web Worker internal authority (+13 more)

### Community 187 - "Watch History V3 Staging Verification"
Cohesion: 0.14
...
### Community 188 - "Watch History V2 Clean Mvp"
Cohesion: 0.09
...
### Community 189 - "Personal History And Plans Mvp"
Cohesion: 0.12
...
### Community 190 - "Room Invite Notifications"
Cohesion: 0.20
Nodes (20): getCachedExtensionSession(), getStoredAuthTokens(), beginNotificationRetry(), claimNotificationRetry(), clearNotificationRetryAccount(), completeNotificationRetry(), expired(), Lane (+12 more)

### Community 191 - "Room Invite Target Status"
Cohesion: 0.16
...
### Community 192 - "Invites Client"
Cohesion: 0.14
Nodes (13): dynamic, metadata, EditableProfile, ProfileClient(), ProfileResponse, WaitlistStatus, change(), dom (+5 more)

### Community 193 - "Public Module"
Cohesion: 0.10
...
### Community 194 - "Development Flow Quality System Plan"
Cohesion: 0.10
...
### Community 195 - "Friends And Groups Link First"
Cohesion: 0.17
...
### Community 196 - "Linked In Sales Navigator Connection"
Cohesion: 0.10
...
### Community 199 - "Ani Dachi Extension Icon 48Px"
Cohesion: 0.13
...
### Community 200 - "Overlay Room Rail"
Cohesion: 0.15
Nodes (11): MainControlVisibility, clearTimer(), pointInsideRect(), pointInsideViewport(), TOP_BUBBLE_HIDE_DELAY_MS, TOP_BUBBLE_REVEAL_DELAY_MS, TopBubbleRevealState, useTopBubbleReveal() (+3 more)

### Community 201 - "Room Client"
Cohesion: 0.14
Nodes (13): connectRoomHttpMessage(), RoomAdmissionHandoff, roomAdmissionHandoffMessage, createDepartureRetryScheduler(), createDepartureRetryStorage(), createSessionStorage(), deferred(), roomResponse() (+5 more)

### Community 202 - "Room Invite Notification Runtime.Test"
Cohesion: 0.14
Nodes (12): alarms, diagnostic, json(), registered(), state, accountInboxItemKey(), accountInboxSeenItems(), appendAccountInboxPage() (+4 more)

### Community 203 - "Package Module"
Cohesion: 0.10
Nodes (19): typescript, typescript, dependencies, zod, devDependencies, typescript, vitest, exports (+11 more)

### Community 204 - "Strict Module"
Cohesion: 0.11
Nodes (13): begin(), cases, commit(), failed, first, foreign, omitted, outputPath (+5 more)

### Community 205 - "Anidachi Project Operating Manual"
Cohesion: 0.10
...
### Community 206 - "Shared Watch Progress Tracker"
Cohesion: 0.15
...
### Community 207 - "Development Workflow Hardening Implementation Plan"
Cohesion: 0.10
...
### Community 208 - "Plan Code Canonicalization And Billing"
Cohesion: 0.10
...
### Community 209 - "Account Data History Social And"
Cohesion: 0.21
...
Cohesion: 0.26
Nodes (18): node:fs, createDriver(), apply(), document(), finish(), inventory(), prefix(), prepare() (+10 more)
...
### Community 212 - "Reaction Shortcuts"
Cohesion: 0.21
...
### Community 213 - "Adapter Playback Snapshot"
Cohesion: 0.22
...
### Community 214 - "You Tube Playback Synchronization Hardening"
Cohesion: 0.11
...
### Community 215 - "Watch Drawer Browse Local Verification"
Cohesion: 0.12
...
### Community 218 - "Release Channel Build.Test"
Cohesion: 0.12
...
### Community 219 - "Get Guide Links"
Cohesion: 0.14
Nodes (15): AnimeWatchPartyPage(), faq, metadata, pillarItemList, SITE_URL, tocHeadings, AnimeWatchPartyToolkitPage(), faq (+7 more)

### Community 220 - "Server Module"
Cohesion: 0.14
Nodes (16): dynamic, GET(), maxDuration, dynamic, GET(), createAccountResponseMeta(), cleanInviteMessage(), isRecentRelationshipEligible() (+8 more)

### Community 221 - "Components Module"
Cohesion: 0.11
Nodes (17): aliases, components, hooks, lib, ui, utils, iconLibrary, rsc (+9 more)

### Community 222 - "Public Module"
Cohesion: 0.13
...
### Community 223 - "Survey → Subscription Conversion (Planner"
Cohesion: 0.11
...
### Community 224 - "Crunchyroll Adapter Notes"
Cohesion: 0.14
...
### Community 225 - "Anidachi Development Environments"
Cohesion: 0.11
...
### Community 226 - "Ani Dachi New Chat Project"
Cohesion: 0.11
...
### Community 227 - "Open Claw: You Tube Shorts"
Cohesion: 0.11
...
### Community 228 - "Compiler Options"
Cohesion: 0.11
...
### Community 232 - "Chrome Web Store Listing —"
Cohesion: 0.12
...
### Community 233 - "Watch History V3 Routes"
Cohesion: 0.16
...
### Community 235 - "Invitation Delivery Reliability Implementation Plan"
Cohesion: 0.17
...
### Community 242 - "Shared Protocol Types"
Cohesion: 0.17
...
### Community 243 - "Dev Dependencies"
Cohesion: 0.12
Nodes (15): @biomejs/biome, devDependencies, @biomejs/biome, turbo, typescript, vitest, engines, node (+7 more)

### Community 244 - "Maintenance Admission"
Cohesion: 0.12
Nodes (16): In-flight work and existing socket/job boundary, Statement-trigger runtime write holds and cron suspension, Source-controlled production DB Worker and Vercel delivery holds, Loopback marked task-container rehearsal guard, Production 35 To 60 Transition, Baseline schema inventory and file-hash drift refusal, Committed-prefix resume or full baseline DB and runtime rollback, Pinned 35 baseline and exact unchanged 60-file target (+8 more)

### Community 245 - "Production Recovery And Release"
Cohesion: 0.12
Nodes (16): Hosted rehearsal external closure drain checkpoint and controlled reopening, Compatible runtime then DB unlock under continuing external maintenance, Original postgres or cli_login_postgres with effective postgres fence, Real logical backup local restore and narrow hosted application restore, Task 5 separate media policy and production extension gates, Official Supabase backup restore and clone limitations, 2026 09 12 Production Promotion Preparation, Failure decisions preserve maintenance and matching DB/runtime recovery (+8 more)

### Community 246 - "Social Rooms Subscriptions Execution Plan"
Cohesion: 0.17
...
### Community 247 - "Cn Module"
Cohesion: 0.18
Nodes (10): AccountEntryLink(), destinations, NavUser, UserMenu(), dom, mount(), open(), trigger() (+2 more)

### Community 248 - "Storage Module"
Cohesion: 0.23
Nodes (12): ensureAllCredentials(), ensureAuthClient(), getCredentialsForChannel(), isInvalidGrant(), probeChannelHealth(), uploadShortVideo(), uploadShortVideoFromUrl(), UploadShortVideoInput (+4 more)

### Community 249 - "Watch History Capacity Concurrency Contract"
Cohesion: 0.20
Nodes (14): args, contend(), event(), labels, literal(), live, marker, ports (+6 more)

### Community 250 - "20260814010000 Watch History V2 Foundation"
Cohesion: 0.25
...
### Community 251 - "Pull Request Template"
Cohesion: 0.13
...
### Community 252 - "Maintenance Admission"
Cohesion: 0.15
...
### Community 253 - "Personal History And Plans Mvp"
Cohesion: 0.13
...
### Community 255 - "Voice Controls And Participant Audio"
Cohesion: 0.13
...
### Community 256 - "Interface Visibility Settings Design"
Cohesion: 0.13
...
### Community 257 - "Personal History Mvp Design"
Cohesion: 0.14
...
### Community 260 - "Ani Dachi Seo Content Guidelines"
Cohesion: 0.14
...
### Community 264 - "Handoff For Ai Working On"
Cohesion: 0.14
...
### Community 267 - "Two Phase Production Promotion"
Cohesion: 0.16
...
### Community 268 - "Waitlist And Crm Durable Storage"
Cohesion: 0.23
...
### Community 269 - "Ani Dachi Contributor Startup Contract"
Cohesion: 0.19
...
### Community 277 - "Room Invite Notifications"
Cohesion: 0.17
...
### Community 278 - "Scratchpad Module"
Cohesion: 0.17
...
### Community 279 - "Project Architecture And Development"
Cohesion: 0.31
...
### Community 280 - "Codex Hosted Semantic Extraction"
Cohesion: 0.17
...
### Community 281 - "Personal History Mvp Staging Delivery"
Cohesion: 0.23
...
### Community 282 - "September 12 Prelaunch Remediation Verification"
Cohesion: 0.27
...
### Community 283 - "One Canonical Personal Episode Progress"
Cohesion: 0.24
...
### Community 285 - "V1 Product Decisions (Historical)"
Cohesion: 0.17
...
### Community 286 - "Shared Pure Visibility Policy"
Cohesion: 0.21
...
### Community 289 - "Overlay Layout Engine.Test"
Cohesion: 0.23
...
### Community 290 - "Overlay Media Session"
Cohesion: 0.24
...
### Community 291 - "Room Session Storage.Test"
Cohesion: 0.17
Nodes (4): BackgroundDependencies, DelayedRemoveStorageArea, MemoryStorageArea, StorageAreaLike

### Community 292 - "Friends Workspace()"
Cohesion: 0.26
Nodes (9): FriendsWorkspace(), action(), closeModal(), dismissModal(), editGroup(), generateLink(), openModal(), saveGroup() (+1 more)

### Community 293 - "Page Module"
Cohesion: 0.32
Nodes (7): ExtensionCheck(), COPY, RoomMobileHandoff(), RoomMobileHandoffProps, isMobileUserAgent(), shareOrCopyUrl(), useMobileDevice()

### Community 294 - "Watch History V3 Sql.Test"
Cohesion: 0.20
...
### Community 297 - "Watch History V3.Test"
Cohesion: 0.17
...
### Community 298 - "Project Knowledge Map"
Cohesion: 0.17
...
### Community 299 - "Account Library And Manual Progress"
Cohesion: 0.27
...
### Community 300 - "Popup People And Social Directory"
Cohesion: 0.17
...
### Community 302 - "Smoke Staging Web"
Cohesion: 0.29
...
### Community 303 - "Incremental Re Extraction"
Cohesion: 0.18
...
### Community 304 - "Download On The App Store"
Cohesion: 0.31
...
### Community 305 - "20260816090000 Watch History V2 Bounded"
Cohesion: 0.18
...
### Community 309 - "Watch History Capacity"
Cohesion: 0.20
...
### Community 310 - "P2P Scorecard"
Cohesion: 0.29
Nodes (10): analyzeFile(), fail(), get(), median(), ms(), pairKind(), parseExport(), paths (+2 more)

### Community 311 - "P2P Media Harness"
Cohesion: 0.31
Nodes (8): b64url(), createHarnessRoomToken(), getHarnessHostIdentity(), getP95(), LEGACY_TTFM_BUDGET_MS, summarizeSelectedCandidatePairs(), TTFM_P95_BUDGET_MS, REPO

### Community 312 - "Project Planes"
Cohesion: 0.27
...
### Community 313 - "Max Participant Id Chars"
Cohesion: 0.29
...
### Community 314 - "Seo Trust & Authority Plan"
Cohesion: 0.20
...
### Community 315 - "Ani Dachi Logo Asset"
Cohesion: 0.33
...
### Community 316 - "20260819133849 Auth Channel Rotation"
Cohesion: 0.38
...
### Community 323 - "Panel Account Title"
Cohesion: 0.39
...
### Community 324 - "Overlay Layout Ghost Preview"
Cohesion: 0.33
...
### Community 325 - "Room Quota Display"
Cohesion: 0.39
Nodes (7): applyRoomUsageSnapshot(), AuthoritativeQuotaAnchor, isNewerRoomUsage(), nonnegative(), quotaDayFromResetAt(), roomQuotaRemainingSeconds(), RoomQuotaSnapshot

### Community 326 - "Conversion Metrics (Ga4)"
Cohesion: 0.22
...
### Community 327 - "Host Avatar Asset"
Cohesion: 0.28
...
### Community 328 - "Personal Mvp Activation Contract"
Cohesion: 0.28
Nodes (8): activation, args, delay(), policy(), readme, sql(), target, until()

### Community 329 - "Public Module"
Cohesion: 0.22
...
### Community 330 - "20260907194413 Personal History Access"
Cohesion: 0.25
...
### Community 331 - "Graphify Reference: Extra Exports And"
Cohesion: 0.22
Nodes (8): graphify reference: extra exports and benchmark, Step 6b - Wiki (only if --wiki flag), Step 7 - Neo4j export (only if --neo4j or --neo4j-push flag), Step 7a - FalkorDB export (only if --falkordb or --falkordb-push flag), Step 7b - SVG export (only if --svg flag), Step 7c - GraphML export (only if --graphml flag), Step 7d - MCP server (only if --mcp flag), Step 8 - Token reduction benchmark (only if total_words > 5000)

### Community 332 - "Executor'S Feedback Or Assistance Requests"
Cohesion: 0.22
...
### Community 333 - "Participant Session Identity"
Cohesion: 0.28
...
### Community 334 - "Social Rooms, Friends, Groups, And"
Cohesion: 0.22
...
### Community 335 - "Global Constraints"
Cohesion: 0.22
...
### Community 336 - "Real Web Rtc Two Browser"
Cohesion: 0.25
...
### Community 339 - "Crunchyroll.Content Module"
Cohesion: 0.25
...
### Community 343 - "Natsuki Avatar Asset"
Cohesion: 0.43
...
### Community 349 - "Global Constraints"
Cohesion: 0.25
...
### Community 350 - "Global Constraints"
Cohesion: 0.25
...
### Community 351 - "Approved Voice Ux Simplification V2"
Cohesion: 0.25
...
### Community 352 - "Production Acceptance Snapshot: 685 Survey"
Cohesion: 0.29
...
### Community 353 - "You Tube Adapter Notes"
Cohesion: 0.25
...
### Community 354 - "Internal Web Client"
Cohesion: 0.29
Nodes (6): ROOM_PRESENCE_MAX_AGE_MS, RoomPresenceAcknowledgementSchema, RoomPresenceEvidenceSchema, RoomPresenceParticipantSchema, value, zod

### Community 355 - "Crunchyroll.Content Module"
Cohesion: 0.48
...
### Community 357 - "Ani Dachi Apple Touch Icon"
Cohesion: 0.43
...
### Community 365 - "Anidachi Seo Aeo Pages"
Cohesion: 0.29
...
### Community 366 - "Project Status Board"
Cohesion: 0.29
...
### Community 367 - "Site, Extension, Auth, And Database"
Cohesion: 0.29
...
### Community 368 - "Watch History Capacity"
Cohesion: 0.29
...
### Community 369 - "Voice Ux Simplification V2"
Cohesion: 0.29
...
### Community 370 - "Participant Audio Controls"
Cohesion: 0.29
...
### Community 371 - "Shared Pure Visibility Policy"
Cohesion: 0.33
...
### Community 372 - "Watch History Catalog And Progress"
Cohesion: 0.29
...
### Community 373 - "Account Data Watch History Social"
Cohesion: 0.29
...
### Community 384 - "Anidachi Private"
Cohesion: 0.40
...
### Community 385 - "20260908071729 Room Media Negotiation Fence"
Cohesion: 0.40
...
### Community 386 - "Personal History Access.Test"
Cohesion: 0.33
Nodes (3): access_results, saved_order, saved_progress

### Community 390 - "Watch History V3 Episode Previews.Test"
Cohesion: 0.40
Nodes (3): bounded_preview, pg_temp.preview_tail(), preview_pages

### Community 392 - "Graphify Reference: Query, Path, Explain"
Cohesion: 0.33
Nodes (5): For /graphify explain, For /graphify path, graphify reference: query, path, explain, Step 0 — Constrained query expansion (REQUIRED before traversal), Step 1 — Traversal

### Community 393 - "High Level Task Breakdown (Historical)"
Cohesion: 0.33
...
### Community 394 - "Sitewide Cta → Plan Picker"
Cohesion: 0.33
...
### Community 395 - "Account Subscription Cancellation"
Cohesion: 0.33
...
### Community 397 - "Billing And Entitlements"
Cohesion: 0.33
...
### Community 400 - "Always Visible Compact Participant Pills"
Cohesion: 0.33
...
### Community 401 - "Final Staging Runtime Acceptance"
Cohesion: 0.33
...
### Community 402 - "Exact Assignment Release"
Cohesion: 0.33
...
### Community 403 - "Account Data History Social And"
Cohesion: 0.53
...
### Community 404 - "Accepted Catalog Read"
Cohesion: 0.33
...
### Community 421 - "Anidachi Seo Aeo Pages"
Cohesion: 0.40
...
### Community 422 - "Service Level Objectives"
Cohesion: 0.40
...
### Community 427 - "Protocol Agent Instructions"
Cohesion: 0.40
Nodes (4): packages/protocol Agent Instructions, Rules, Source Of Truth, Verification

### Community 428 - "Production History 35 To 60"
Cohesion: 0.67
...
### Community 431 - "20260602 Extension Auth"
Cohesion: 0.67
...
### Community 436 - "20260908070552 Room Media Compatibility Fence"
Cohesion: 0.67
...
### Community 439 - "Graphify Reference: Add A Url"
Cohesion: 0.50
Nodes (3): For /graphify add, For --watch, graphify reference: add a URL and watch a folder

### Community 440 - "Graphify Reference: Commit Hook And"
Cohesion: 0.50
Nodes (3): For git commit hook, For native CLAUDE.md integration, graphify reference: commit hook and native CLAUDE.md integration

### Community 441 - "Graphify Reference: Incremental Update And"
Cohesion: 0.50
Nodes (3): For --cluster-only, For --update (incremental re-extraction), graphify reference: incremental update and cluster-only

### Community 442 - "Maintenance Admission"
Cohesion: 0.50
Nodes (4): Schema 3 durable canonical episode authority, Production 35-to-60 preservation prerequisite, Immutable private ten-relation preservation archive, Task 2 recoverable artifact and operator restore capability

### Community 443 - "Experimental Features"
Cohesion: 0.50
Nodes (3): Experimental Features, Hold Fire Super Reaction, P2P Media Transport

### Community 444 - "Manual Staging Release Gate"
Cohesion: 0.50
Nodes (4): Manual Staging Release Gate, Ultra-Light P2P Reliability, P2P Media Engine Block, Release Gates and Rollback

### Community 445 - "Privacy Security And Abuse Controls"
Cohesion: 0.50
Nodes (4): Abuse Controls, Chrome Web Store, Privacy Security And Abuse Controls, Supabase

### Community 446 - "Audio Speech Activity Classification"
Cohesion: 0.50
...
### Community 450 - "Current Operational Source Of Truth"
Cohesion: 0.50
...
### Community 451 - "Account Mvp Workspace"
Cohesion: 0.50
...
### Community 452 - "Account Data Watch History Social"
Cohesion: 0.50
...
### Community 453 - "Account Data Watch History Social"
Cohesion: 0.50
...
### Community 454 - "Five Object Crm Reconciliation"
Cohesion: 0.50
...
### Community 455 - "Launch Chrome"
Cohesion: 0.83
Nodes (3): port_in_use(), print_port_conflict_help(), launch-chrome.sh script

### Community 456 - "Production History 35 To 60"
Cohesion: 1.00
...
## Knowledge Gaps
- **3609 isolated node(s):** `CtaCopyKey`, `SeoGuideOption`, `SeoGuideRelatedLink`, `SeoGuideStep`, `GuideLinkItem` (+3604 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 4972 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
...
- **What is the exact relationship between `Architecture stack reference to Supabase Auth` and `Custom website OAuth and cookie sessions backed by Supabase tables`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `react` connect `Page Module` to `External References`, `Feature Requests`, `Invites Client`, `Pricing Copy`, `Overlay App`, `Popup App`, `Privileged Overlay Wiring.Test`, `Html5 Video Adapter`, `Reaction Pop`, `Invites Client`, `Voice Audio Preferences`, `Popup Watch Drawer`, `Watch Library Client`, `Voice Audio Preferences`, `Page Module`, `Popup Watch Drawer`, `Use Camera Interaction Lock`, `Crm Client`, `Cn Module`, `Interface Preferences`, `Room Media Defaults`, `Page Module`, `Content Module`, `Popup People Panel.Test`, `Chrome Extension Demo Async Overlay`, `Home Survey`, `Room State`, `Popup Watch Drawer`, `Invites Client`, `Panel Account Title`, `Overlay Layout Ghost Preview`, `Page Module`, `Reaction Shortcuts`, `Overlay Room Rail`, `Billing Module`, `Watch Library Client`, `Account Inbox Cache`, `Overlay Layout Editor`, `Popup Watch Drawer`, `Overlay Room Rail`, `Voice Audio Preferences`, `Ghost Cam`, `Overlay Layout Editor.Test`, `Home Survey`, `Discord Contact`, `Home Survey`, `Popup Watch Drawer`, `Cn Module`, `Layout Module`?**
  _High betweenness centrality (0.085) - this node is a cross-community bridge._
- **Why does `vitest` connect `Index Module` to `Room Persistence`, `Overlay App`, `Popup App`, `Room Invite Notifications`, `Room Session Storage`, `Room State`, `Html5 Video Adapter`, `Auth Client`, `Room Client`, `Room Session`, `Social Client`, `Shared Protocol Types`, `Playback Sync Controller`, `Middleware Module`, `Account Module`, `Watch History`, `Interface Preferences`, `Room Media Defaults`, `Watch History Storage`, `Content Module`, `Diagnostic Log`, `Progress Module`, `Popup People Panel.Test`, `Room Departure Retry`, `Privileged Overlay Intent`, `Room State`, `Source Navigation`, `Popup Watch Drawer`, `Source Navigation`, `Create Watch History Client`, `Diagnostic Log`, `Reaction Shortcuts`, `Room Persistence`, `Room Hibernation Runtime`, `Watch History V3 Routes`, `Account Inbox Cache`, `Extension Codes`, `Overlay Layout Editor`, `Room Socket Attachment`, `Internal Web Client`, `Room Departure`, `Overlay Room Rail`, `Voice Audio Preferences`, `Registry Module`, `Player Chrome`, `Watch History`, `Vitest Module`, `Ghost Cam`, `P2P Media`, `Room Client`, `Adapter Playback Snapshot`, `Room State`, `Overlay Layout Model`, `Popup Watch Drawer`, `Player Chrome`, `Catalog Module`, `Ice Servers`, `Catalog Module`, `Privileged Overlay Wiring.Test`, `Reaction Pop`, `P2P Ice`, `Artwork Select`, `User Identity`, `Popup Watch Drawer`, `Voice Audio Preferences`, `Use Camera Interaction Lock`, `Voice Activity`, `Overlay Layout Runtime`, `Room Rate Limiter`, `Watch History Storage`, `Room Invite Target Status`, `Index Module`, `Overlay Room Rail`, `Room Client`, `Room Invite Notification Runtime.Test`, `Reaction Shortcuts`, `Adapter Playback Snapshot`, `Popup Watch Drawer`, `Release Channel Build.Test`, `Popup Styles`, `Ghost Cam Size`, `Overlay Layout Editor.Test`, `Overlay App`, `Index Module`, `Overlay Layout Engine.Test`, `Overlay Media Session`, `Panel Account Title`, `Overlay Layout Ghost Preview`, `Room Quota Display`, `Room Tab Lock`, `Internal Web Client`, `Overlay App`, `Index Module`, `Room Client`, `Voice Audio Preferences`, `Node:Fs Module`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `.next/**` connect `Link Module` to `External References`, `Pricing Copy`, `Responsive Compare Table`, `Seo Page Layout`, `Social API Operations`, `Oauth Transaction`, `Page Module`, `Tasks Module`, `Get Guide Links`, `Page Module`, `Invites Client`, `Route Module`, `External References`, `Page Module`, `Cn Module`, `Portfolio Audit`, `Verify Kreatli Crm Session`, `Invites Client`, `Page Module`, `Watch History V3 Routes`, `Json Unauthorized Unless Kreatli Session`, `Get Guide Links`, `Pseo New Guides`, `External References`, `External References`, `Get Guide Links`, `Page Module`, `Layout Module`?**
