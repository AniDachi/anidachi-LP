# Graph Report - prelaunch-fixes  (2026-09-12)

## Corpus Check
- Incremental slice processed: 8 changed files (2 code, 6 documents).
- Full corpus: 1,334 files · ~1,317,642 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 12433 nodes · 27584 edges · 779 communities (451 shown, 286 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 446 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `acbad4a8`
...
- Progress Module
- Route Module
- Crunchyroll.Content Module
- Voice Audio Preferences
- Popup People Panel.Test
- Oauth Module
- Diagnostic Log
- Create Watch History Client
- Room Departure Retry
- Room Source
- Crm Client
- Middleware Module
- Privileged Overlay Intent
...
- Cn Module
- Room State
- Json Unauthorized Unless Kreatli Session
- Room Session
- Room Departure
- Get Guide Links
- Private Integration Blob
- Graphify Module
- Reaction Shortcuts
...
- Page Module
- Index Module
- Watch Library Client
- Account Inbox Cache
- Billing Module
- Verify Kreatli Crm Session
- Home Survey
- Cli Module
- P2P Media Harness
- Page Module
...
- Dependencies Module
- Room State
- Public Media Blob.Test
- Home Survey
- Migrate Private Integration Blobs
- Room Client
- Room Invite Notifications
- Popup Watch Drawer
- Watch History Storage
...
- P2P Scorecard
- Project Planes
- Overlay Media Session
- Room Quota Display
- Max Participant Id Chars
- Room Invite Notification Runtime.Test
...
- Overlay Layout Engine.Test
- Seo Page Layout
- Conversion Metrics (Ga4)
- Host Avatar Asset
- Personal Mvp Activation Contract
- Public Module
...
- Watch History V3 Episode Previews.Test
- Watch History V3 Resource Bounds.Test
...
- Extraction Spec
- Watch History V2 Clean Mvp
- Task 10: Full Automated Gates
- Task 4: Add The Authenticated
...
- **Independent production delivery admission and database controls** — docs_superpowers_plans_2026_09_12_production_promotion_preparation_three_controls, docs_releases_personal_history_mvp_production_35_to_60_transition_delivery_holds, docs_releases_personal_history_mvp_maintenance_admission_configuration, docs_releases_personal_history_mvp_production_35_to_60_transition_database_holds [EXTRACTED 1.00]
...
## Communities (779 total, 286 thin omitted)

### Community 0 - "Pricing Copy"
Cohesion: 0.03
Nodes (132): faq, headings, metadata, SITE_URL, faq, headings, metadata, SITE_URL (+124 more)

### Community 1 - "Overlay App"
Cohesion: 0.03
Nodes (122): useActiveAdapterPlayback(), HOLD_FIRE_SUPER_REACTION_EXPERIMENT, normalizeExperimentFlag(), useGhostCam(), attachAndPlayVideoElement(), ANIDACHI_COMPOSER_OPEN_ATTR, ANIDACHI_MESSAGE_COMPOSER_SHORTCUT_EVENT, ANIDACHI_MESSAGE_COMPOSER_SUBMIT_EVENT (+114 more)

### Community 2 - "Seo Page Layout"
Cohesion: 0.02
Nodes (100): faq, howToSteps, metadata, SITE_URL, tocHeadings, CrunchyrollWatchPartyWithDiscordPage(), faq, howToSteps (+92 more)

### Community 3 - "External References"
Cohesion: 0.02
Nodes (71): metadata, faq, headings, metadata, SITE_URL, faq, headings, metadata (+63 more)

### Community 4 - "External References"
Cohesion: 0.02
Nodes (71): faq, itemList, metadata, tocHeadings, faq, headings, metadata, SITE_URL (+63 more)

### Community 5 - "Social API Operations"
Cohesion: 0.05
Nodes (89): AccountFriendsPage(), dynamic, metadata, dynamic, GET(), getExtensionUserProfile(), acceptFriendInviteLink(), acceptFriendRequest() (+81 more)

### Community 6 - "Get Guide Links"
Cohesion: 0.02
Nodes (84): AnimeWatchPartyPage(), faq, metadata, pillarItemList, SITE_URL, tocHeadings, AnimeWatchPartyToolkitPage(), faq (+76 more)

### Community 7 - "Responsive Compare Table"
Cohesion: 0.03
Nodes (75): faq, itemList, metadata, tocHeadings, faq, headings, metadata, SITE_URL (+67 more)

### Community 8 - "Watch History V3 Routes"
Cohesion: 0.04
Nodes (72): dynamic, POST, dynamic, POST, dynamic, POST, dynamic, GET (+64 more)

### Community 9 - "Popup Watch Drawer"
Cohesion: 0.05
Nodes (75): PopupEpisodeProgress(), HistoryConsent(), PopupHistorySettings(), BrowseMessage, Parser, PopupWatchBrowseRecovery, PopupWatchBrowseViews, usePopupWatchBrowse() (+67 more)

### Community 10 - "Log Debug"
Cohesion: 0.08
Nodes (16): logDebug(), MicrophoneTerminalFailureReason, classifyMicrophoneTerminalFailure(), createP2PRtcConfiguration(), createVideoElement(), formatCameraErrorMessage(), formatMicrophoneErrorMessage(), getCandidateProtocol() (+8 more)

### Community 11 - "Html5 Video Adapter"
Cohesion: 0.05
Nodes (59): isMediaTimeBuffered(), MediaReadyReason, READY_EVENTS, RemoteSeekAttempt, shouldDeferHostStateSeek(), shouldSeekForHostState(), shouldSeekForRemoteCommand(), shouldThrottleRemoteSeekAttempt() (+51 more)

### Community 12 - "Popup App"
Cohesion: 0.04
Nodes (67): rootElement, accountErrorState(), accountIdentityChanged(), accountLoadingState(), AccountOwnedState, accountReadyState(), AccountRequestGate, AccountRequestToken (+59 more)

### Community 13 - "Auth Client"
Cohesion: 0.05
Nodes (84): clearCachedAccountInboxForUser(), assertExtensionLogoutRedirect(), attemptWebsiteLogoutFlow(), AuthCommand, AuthMessage, AuthMessageResponse, buildExtensionConnectUrl(), buildExtensionLogoutUrl() (+76 more)

### Community 14 - "Account Module"
Cohesion: 0.03
Nodes (81): dynamic, GET(), maxDuration, POST(), createAccountResponseMeta(), createOwnedAccountResponseMeta(), deferInboxPushOutboxDrain(), cleanInviteMessage() (+73 more)

### Community 15 - "Playback Sync Controller"
Cohesion: 0.09
Nodes (11): ActiveAdapterPlaybackOptions, readCurrentResourceDisplay(), isMediaSettling(), waitForMediaReady(), PlaybackSyncController, VideoAdapter, createHarness(), createHarness() (+3 more)

### Community 16 - "Social Client"
Cohesion: 0.08
Nodes (79): WEB_HTTP_BASE, PopupApp(), acceptFriendRequest(), acceptFriendRequestFromApi(), acceptFriendRequestHttpMessage(), acceptInviteHttpMessage(), acceptRoomInvite(), acceptRoomInviteFromApi() (+71 more)

### Community 17 - "Room Invite Notifications"
Cohesion: 0.05
Nodes (78): getStoredAuthTokens(), beginNotificationRetry(), claimNotificationRetry(), clearNotificationRetryAccount(), completeNotificationRetry(), expired(), Lane, newIntent() (+70 more)

### Community 18 - "Link Module"
Cohesion: 0.04
Nodes (66): sitemap(), faq, metadata, tocHeadings, WatchActionAnimeWithFriendsPage(), faq, metadata, tocHeadings (+58 more)

### Community 19 - "Room Persistence"
Cohesion: 0.05
Nodes (72): departureResponse(), detachResponse(), Env, hasValidInternalAuthorization(), drainUrl(), scheduled(), SchedulerEnv, PARTICIPANT_DISCONNECT_STORAGE_KEY (+64 more)

### Community 20 - "Watch History"
Cohesion: 0.03
Nodes (72): Dependencies, WatchHistoryCatalogAcknowledgement, WatchLibraryResponseSchema, MAX_ROOM_HISTORY_ATTESTATION_CHARS, AccountGenerationSchema, addAggregateIssues(), CatalogRequestBaseSchema, CrunchyrollHistoryIdentitySchema (+64 more)

### Community 21 - "Invites Client"
Cohesion: 0.04
Nodes (55): metadata, AcceptInviteResponse, AccountInboxItem, acknowledgeInboxPageSeen(), ActiveRoomInvite, Avatar(), formatDate(), FriendRequestRow() (+47 more)

### Community 22 - "Server Module"
Cohesion: 0.08
Nodes (53): dynamic, GET(), dynamic, POST(), dynamic, POST(), dynamic, POST() (+45 more)

### Community 23 - "Plan Entitlements"
Cohesion: 0.06
Nodes (62): CheckoutTier, getOrCreateStripeCustomer(), loginUrlForRequest(), POST(), dynamic, POST(), getBillingCustomerByUserId(), upsertBillingCustomer() (+54 more)

### Community 24 - "Content Module"
Cohesion: 0.04
...
### Community 25 - "Create Watch History Client"
Cohesion: 0.04
Nodes (66): BrowseCommand, BrowseInput, emptyPartition(), handleWatchHistoryHttpMessage(), hasExactKeys(), historyPageTabs, historyReadSequences, inferredObservationDisplayMode() (+58 more)

### Community 26 - "Portfolio Audit"
Cohesion: 0.05
Nodes (65): getGoogleMarketingAuthClient(), fetchGa4LandingByChannel(), fetchGa4LandingConversions(), fetchGa4TopPages(), Ga4LandingChannelRow, Ga4LandingConversionRow, Ga4PageRow, resolveGa4PropertyName() (+57 more)

### Community 27 - "Registry Module"
Cohesion: 0.05
Nodes (31): SourceAdapterHistoryPolicy, CanonicalSourceNavigationResult, DefinitionLookup, ensureGenericSource(), navigationRejection(), resolveCanonicalSourceNavigation(), withRoomHash(), SourceAdapterDefinition (+23 more)

### Community 28 - "Watch Library"
Cohesion: 0.06
Nodes (68): createRoom(), db(), getActiveRoomByClientRequestId(), getSupabaseServiceClient(), listRoomMembers(), getLegacyWatchLibraryEntitlements(), roomSourceCreationColumns, ProfileRow (+60 more)

### Community 29 - "Room Client"
Cohesion: 0.05
Nodes (62): PrivilegedOverlayContext, AdmittedRoom, assertRoomHttpResponse(), bridgeError(), buildRoomWebSocketUrl(), cleanupCancelledRoomAdmission(), clearUnobservedCancelledAdmission(), ConfirmedAdmissionDepartureOutcome (+54 more)

### Community 30 - "Room Durable Object"
Cohesion: 0.10
Nodes (5): handleRoomWebSocketMessageBoundary(), mediaSeatError(), RoomDurableObject, roomEndedEvent(), sendAndCloseEndedRoomSockets()

### Community 31 - "External References"
Cohesion: 0.03
Nodes (50): faq, headings, metadata, SITE_URL, escapeXml(), GET(), faq, headings (+42 more)

### Community 32 - "Page Module"
Cohesion: 0.06
...
### Community 34 - "Room Session Storage"
Cohesion: 0.10
Nodes (66): resolveRoomMediaDefaults(), clearRoomSessionForDepartureIfMatchNow(), clearRoomSessionIfMatch(), clearRoomSessionIfMatchForTabNow(), confirmRoomSessionForTabNow(), createBoundedSessionValue(), createDepartureRetryRecord(), createParticipantSessionId() (+58 more)

### Community 35 - "Oauth Transaction"
Cohesion: 0.07
Nodes (51): dynamic, GET(), dynamic, GET(), dynamic, GET(), dynamic, GET() (+43 more)

### Community 36 - "Room Session"
Cohesion: 0.07
Nodes (49): lifecycleApi, dynamic, GET(), maxDuration, POST(), dynamic, POST(), dynamic (+41 more)

### Community 37 - "P2P Media"
Cohesion: 0.04
Nodes (59): createLocalAudioLevelMeter(), LocalAudioLevelMeter, addOptionalNumbers(), applyP2PCodecPreferences(), copyDefinedStat(), countMatches(), createP2PMediaSignalDedupeKey(), DEFAULT_STUN_SERVERS (+51 more)

### Community 38 - "Extension Codes"
Cohesion: 0.06
Nodes (54): dynamic, POST(), ExtensionConnectMobileConfirm(), dynamic, ExtensionConnectPage(), metadata, Props, dynamic (+46 more)

### Community 39 - "Diagnostic Log"
Cohesion: 0.06
Nodes (57): ANIDACHI_BUILD_ID, API_HTTP_BASE, API_WS_BASE, VOICE_KEYWORD_EMOJI, WXT_VAPID_PUBLIC_KEY, appendDiagnosticEntry(), clearDiagnosticEntries(), clearDiagnosticsFromPage() (+49 more)

### Community 40 - "Progress Module"
Cohesion: 0.07
...
### Community 41 - "Route Module"
Cohesion: 0.10
Nodes (54): AccountResult, blobUrlToProxyUrl(), POST(), prepareTikTokImages(), publishToTtAccount(), AccountResult, blobUrlToProxyUrl(), maxDuration (+46 more)

### Community 42 - "Crunchyroll.Content Module"
Cohesion: 0.07
Nodes (60): BitmovinLikePlayer, BitmovinNamespace, BitmovinPlayerConstructor, BitmovinPlayerMethod, clampMediaTime(), clickElement(), CrunchyrollKatamariPlayer, delay() (+52 more)

### Community 43 - "Voice Audio Preferences"
Cohesion: 0.05
Nodes (33): HotkeyState, MicrophoneIntent, shouldPublishMicrophone(), VoiceMode, isWithinOverlayHotkeyBoundary(), OVERLAY_HOTKEY_BOUNDARY_ATTRIBUTE, overlayHotkeyBoundaryProps, OverlayInteractionBoundaryProps (+25 more)

### Community 44 - "Popup People Panel.Test"
Cohesion: 0.05
Nodes (33): InboxInviteAction, PopupInboxPanel(), AccountInboxItem, buildPopupInboxModel(), buildPopupPeopleModel(), cloneFriend(), cloneGroup(), cloneInboxItem() (+25 more)

### Community 45 - "Oauth Module"
Cohesion: 0.07
Nodes (46): dynamic, failRedirect(), GET(), dynamic, GET(), POST(), LoginForm(), dynamic (+38 more)

### Community 46 - "Diagnostic Log"
Cohesion: 0.06
Nodes (39): cleanClassName(), clearDebugLog(), compactDebugData(), compactInputData(), compactVideoData(), controlsDebugSnapshot(), copyDebugFields(), DebugEntry (+31 more)

### Community 47 - "Create Watch History Client"
Cohesion: 0.11
Nodes (58): subscribeToPopupWatchHistorySnapshot(), bestEffortFlushWatchHistoryBeforeSignOut(), browseHardRevision(), browsePath(), browseReadRevision(), browseResponseMatchesQuery(), browseResponseMeta(), capturePauseKey() (+50 more)

### Community 48 - "Room Departure Retry"
Cohesion: 0.06
Nodes (38): acknowledgeRoomDepartureAdmissionHandoff(), claimRoomDepartureAdmissionHandoffCleanup(), createRoomDepartureRetryCoordinator(), defaultRoomDepartureRetryCoordinator, departPersistedRoomSession(), drainRoomDepartureRetries(), earliestAttempt(), exactIdentity() (+30 more)

### Community 49 - "Room Source"
Cohesion: 0.07
Nodes (46): BillingPage(), dynamic, metadata, dynamic, POST(), dynamic, POST(), wantsJson() (+38 more)

### Community 50 - "Crm Client"
Cohesion: 0.07
Nodes (51): addContactAction(), applyImportAction(), CrmActionState, deleteContactAction(), exportCsvDataAction(), exportSurveyLeadsCsvAction(), guard(), ImportPreviewResult (+43 more)

### Community 51 - "Middleware Module"
Cohesion: 0.05
Nodes (30): alt, contentType, runtime, size, catalogContext, envelope(), progressEvent(), files (+22 more)

### Community 52 - "Privileged Overlay Intent"
Cohesion: 0.08
Nodes (46): dispatchPrivilegedRoomRuntimeMessage(), isAuthMessage(), activeRoomAuthorityClaimExecutionsByTab, assertIntentResponse(), authorityStorageKey(), authorityStorageMutationQueuesByTab, clearPrivilegedOverlayContextForTab(), clearRoomAuthorityClaimIfOwned() (+38 more)

### Community 53 - "Chrome Extension Demo Async Overlay"
Cohesion: 0.06
...
### Community 55 - "Room Media Defaults"
Cohesion: 0.07
...
Cohesion: 0.07
Nodes (46): POST(), ActiveRoomClaimResult, ActiveRoomCreateResult, ActiveRoomSummary, beginStripeEventProcessing(), beginStripeSubscriptionRefresh(), BillingCustomerRow, commitStripeSubscriptionRefresh() (+38 more)

### Community 57 - "Cn Module"
Cohesion: 0.07
Nodes (35): AccountResult, IgAccount, PublishClient(), PublishStatus, TabType, TtAccount, YtAccount, metadata (+27 more)

### Community 58 - "Room State"
Cohesion: 0.07
Nodes (19): getMediaAction(), MediaActionInput, orderRoomParticipants(), PanelCameraControl(), PanelCameraControlProps, participantInitials(), participantMediaStatus(), participantOrderRank() (+11 more)

### Community 59 - "Json Unauthorized Unless Kreatli Session"
Cohesion: 0.07
Nodes (40): dynamic, GET(), OPTIONAL, dynamic, GET(), INSTAGRAM_SCOPES, dynamic, GET() (+32 more)

### Community 60 - "Room Session"
Cohesion: 0.07
Nodes (46): activeRoomChanged(), authRequired(), CurrentAssignment, departResolvedAssignment(), DepartureDependencies, DepartureMode, ExactAssignment, handleActiveRoomRecoveryDeparture() (+38 more)

### Community 61 - "Room Departure"
Cohesion: 0.08
Nodes (43): handleRoomAdmissionHandoffMessage(), ConfirmedRoomDepartureOutcome, confirmedRuntimeDeparture(), confirmExplicitRoomDeparture(), ConfirmExplicitRoomDepartureDependencies, departActiveWebsiteRoomFromApi(), departExactRoomSession(), departWebsiteRoomFromApi() (+35 more)

### Community 62 - "Get Guide Links"
Cohesion: 0.05
Nodes (40): BestWayToWatchCrunchyrollWithFriendsPage(), faq, metadata, SITE_URL, tocHeadings, DoesEveryoneNeedCrunchyrollPremiumPage(), faq, metadata (+32 more)

### Community 63 - "Private Integration Blob"
Cohesion: 0.08
Nodes (39): dynamic, POST(), compat, __dirname, eslintConfig, __filename, clearGoogleAdsTokens(), GoogleAdsStoredTokens (+31 more)

### Community 64 - "Graphify Module"
Cohesion: 0.04
...
### Community 65 - "Reaction Shortcuts"
Cohesion: 0.07
...
### Community 66 - "Interface Preferences"
Cohesion: 0.06
...
### Community 67 - "Plan Entitlements"
Cohesion: 0.08
Nodes (39): dynamic, POST(), dynamic, GET(), loginRedirectUrl(), POST(), refreshSessionFromCookie(), checkoutSessionUserId() (+31 more)

### Community 68 - "Store Module"
Cohesion: 0.09
Nodes (38): POST(), GET(), metadata, CATEGORY_LABELS, ContactForm(), CONTACT_CATEGORIES, CONTACT_MESSAGE_SEGMENT, ContactCategory (+30 more)

### Community 69 - "Internal Web Client"
Cohesion: 0.07
...
### Community 70 - "Overlay Room Rail"
Cohesion: 0.07
...
### Community 71 - "Watch History Storage"
Cohesion: 0.08
Nodes (38): usesStoredWatchHistorySession(), activeGenerationsFromPartitions(), createWatchHistoryStorage(), clearRebuildableAccountData(), discardAllOtherOwnerOutboxes(), discardOtherOwnerOutbox(), ensureMigration(), otherOwnerPendingSummary() (+30 more)

### Community 72 - "Page Module"
Cohesion: 0.07
Nodes (29): metadata, FriendInviteClient(), initials(), Props, PublicProfile, readJson(), dynamic, FriendInvitePage() (+21 more)

### Community 73 - "Index Module"
Cohesion: 0.09
Nodes (39): HISTORY_OBSERVATION_SUSPENDED, HistoryObservation, HistoryObservationResult, HistoryPolicyInput, isValidHistoryMedia(), normalizeHistoryUrl(), ProviderPlaybackMetadata, canonicalSourceUrl() (+31 more)

### Community 74 - "Watch Library Client"
Cohesion: 0.08
Nodes (36): clock(), episodeLabel(), HistoryActions(), HistoryBrowser(), HistoryPlatform, historyPlatforms, InspectorHandle, isTitleWatched() (+28 more)

### Community 75 - "Account Inbox Cache"
Cohesion: 0.08
Nodes (32): ACCOUNT_INBOX_CACHE_VERSION, accountInboxCacheKeyForUser(), accountInboxItemInstanceKey(), CachedAccountInbox, getCachedAccountInboxForUser(), inboxStructure(), isCanonicalUtcTimestamp(), isCurrentStoredAccount() (+24 more)

### Community 76 - "Billing Module"
Cohesion: 0.07
Nodes (33): BillingClient(), formatDate(), PLAN_NAMES, dynamic, POST, dynamic, POST, dynamic (+25 more)

### Community 77 - "Verify Kreatli Crm Session"
Cohesion: 0.10
Nodes (37): dynamic, errorToShortString(), failRedirect(), GET(), dynamic, GET(), Body, dynamic (+29 more)

### Community 78 - "Home Survey"
Cohesion: 0.11
...
### Community 80 - "P2P Media Harness"
Cohesion: 0.09
Nodes (43): node:http, API_DIR, appendWorkerVar(), buildWorkerArgs(), bundleHarness(), cleanupHarness(), closeHarnessServer(), createVoiceTestWav() (+35 more)

### Community 81 - "Page Module"
Cohesion: 0.08
Nodes (25): BlouLoginForm(), safeNextParam(), BlouLoginPage(), dynamic, metadata, dynamic, metadata, ExtensionCheck() (+17 more)

### Community 82 - "Route Module"
Cohesion: 0.12
Nodes (38): publishToIgAccount(), dynamic, GET(), safeRefreshTiktok(), GET(), processInstagramAccount(), processTikTokAccount(), GET() (+30 more)

### Community 83 - "Middleware Module"
Cohesion: 0.10
Nodes (33): ACCESS_TOKEN_COOKIE, AUTH_REFRESH_PATH, isStaticOrInternalAssetPath(), shouldAutoRefreshWebsiteSession(), admissions, isPublicMarketingPath(), needsSessionMiddleware(), buildStagingAccessCookieValue() (+25 more)

### Community 84 - "Blob Reconciliation"
Cohesion: 0.08
Nodes (39): assertContact(), BlobHeadResult, BlobReadResult, CONTACT_STATUSES, contentTypeFor(), CrmMeta, digest(), isObject() (+31 more)

### Community 85 - "Account Runtime And Acceptance"
Cohesion: 0.05
Nodes (44): Watch Library account workspace, Versioned owner-bound account read contracts, Atomic recipient resolution and invite action ledger, Bounded hourly auth-artifact cleanup, Bounded query-owned history browse and local read cache, Durable private Blob waitlist and public-form recovery, Current Development State, Persisted exact departure and connect handoff recovery (+36 more)

### Community 86 - "Survey Lead"
Cohesion: 0.12
Nodes (32): POST(), GET(), AccountWaitlistStatus, buildResult(), buildSurveyNote(), buildSurveySegments(), creditReferrer(), getAccountWaitlistStatus() (+24 more)

### Community 87 - "Strict Module"
Cohesion: 0.08
Nodes (33): assertPreTransitionPrerequisite(), assertV3Prerequisite(), DATABASE_PREREQUISITE_SQL, DISPOSABLE_ACKNOWLEDGEMENT, DISPOSABLE_MARKER_NAME, PRE_TRANSITION_MIGRATION, readConfiguredIdentity(), requireDisposableTarget() (+25 more)

### Community 88 - "Room Hibernation Runtime"
Cohesion: 0.07
...
### Community 89 - "Ghost Cam"
Cohesion: 0.10
Nodes (28): GhostCamOptions, GhostCamSession, IncomingP2PSignalSender, p2pSignalMatchesActiveGeneration(), p2pSignalMetadata(), replayPendingP2PSignals(), syncRemoteVoiceParticipant(), useP2PGhostCam() (+20 more)

### Community 90 - "Overlay Layout Editor"
Cohesion: 0.10
...
### Community 91 - "Player Chrome"
Cohesion: 0.10
Nodes (35): arePlayerOverlayGeometriesEqual(), AvailableElementRect, childListMutationMayChangeChromeRoots(), childListMutationTouchesChromeRoots(), clampNumber(), getActiveFallbackChromeElements(), getAvailableElementRects(), getAvailableRect() (+27 more)

### Community 92 - "Room State"
Cohesion: 0.07
Nodes (37): PlanEntitlements, AccountEntitlementsMetadata, AccountEntitlementsMetadataSchema, Epoch, getPlanPolicy(), isWatchHistoryAccessCurrent(), PlanCodeSchema, PlanPolicySchema (+29 more)

### Community 93 - "Overlay Layout Engine"
Cohesion: 0.12
...
### Community 94 - "Route Module"
Cohesion: 0.16
Nodes (34): dynamic, maxDuration, POST(), dynamic, POST(), resolveAccountEntitlements(), activeRoomConflictResponse(), claimActiveRoomSession() (+26 more)

### Community 95 - "Watch History Crunchyroll Catalog Progress"
Cohesion: 0.09
...
### Community 96 - "Watch Library Routes.Test"
Cohesion: 0.10
Nodes (28): dynamic, POST, dynamic, GET, PATCH, dynamic, POST, dynamic (+20 more)

### Community 97 - "Room State"
Cohesion: 0.09
Nodes (3): emptyMediaState(), RoomState, room()

### Community 98 - "Room State"
Cohesion: 0.11
Nodes (11): RoomSendDisposition, RoomPeopleSectionProps, createRoomConnectionId(), RoomClient, RoomClientOptions, RoomMediaSession, MediaIntent, ParticipantMediaState (+3 more)

### Community 99 - "Watch History"
Cohesion: 0.09
Nodes (31): dynamic, GET, runtime, aggregate(), fail(), fingerprint(), progressFingerprint(), readWatchHistoryGrid() (+23 more)

### Community 100 - "Pseo New Guides"
Cohesion: 0.08
Nodes (21): metadata, metadata, metadata, metadata, metadata, metadata, metadata, metadata (+13 more)

### Community 101 - "Maintenance Admission"
Cohesion: 0.06
Nodes (38): Schema 3 durable canonical episode authority, Production 35-to-60 preservation prerequisite, Synthetic hosted rehearsal candidate without hosted pass, Non-superuser pg_net removal and managed log boundary, Ordinary postgres-only hosted execution policy, Hosted rehearsal external closure drain checkpoint and controlled reopening, Compatible runtime then DB unlock under continuing external maintenance, Statement-trigger runtime write holds and cron suspension (+30 more)

### Community 102 - "Room Persistence"
Cohesion: 0.15
Nodes (35): acknowledgeParticipantDisconnect(), acknowledgeStoredParticipantDisconnect(), cancelParticipantDisconnectForJoin(), cancelStoredParticipantDisconnectForJoin(), claimDueParticipantDisconnects(), claimDueStoredParticipantDisconnects(), claimParticipantDisconnect(), claimStoredParticipantDisconnect() (+27 more)

### Community 103 - "Adapter Playback Snapshot"
Cohesion: 0.09
...
### Community 104 - "Home Survey"
Cohesion: 0.08
Nodes (30): PlanSurveyOpenContext, SurveyStep, isStaleDefaultSurvey(), isValidSegment(), OpenSurveyArgs, PlanSurveyContext, PlanSurveyContextValue, PlanSurveyProvider() (+22 more)

### Community 105 - "Account Data Watch History Social"
Cohesion: 0.08
...
### Community 107 - "Shared Protocol Types"
Cohesion: 0.08
Nodes (29): MAX_ICE_CANDIDATE_BYTES, MAX_REACTION_EMOJI_CHARS, MAX_SDP_BYTES, MAX_URL_CHARS, MAX_VIDEO_FINGERPRINT_CHARS, MAX_WATCH_TITLE_CHARS, CanonicalPlanCodeSchema, ClientEventSchema (+21 more)

### Community 108 - "Dev Dependencies"
Cohesion: 0.06
Nodes (36): devDependencies, happy-dom, @types/chrome, @types/react, @types/react-dom, typescript, vitest, wxt (+28 more)

### Community 109 - "P2P Media"
Cohesion: 0.07
Nodes (16): classifyRemoteVideoActivity(), decideP2PIceRestart(), decideP2PSignalConnection(), getP2PAudioTransceiverDirection(), isPoliteP2PPeer(), reconcilePeerAction(), shouldInitiateP2POffers(), dispatchRemoteAudioTrack() (+8 more)

### Community 110 - "Room Client"
Cohesion: 0.09
Nodes (21): cancelRoomAdmissionForTab(), connectRoomHttpMessage(), RoomAdmissionCancellation, RoomAdmissionCleanupOwnership, RoomAdmissionFence, RoomAdmissionHandoff, RoomAdmissionReservation, RoomDepartureRetryAttemptOutcome (+13 more)

### Community 111 - "Catalog Module"
Cohesion: 0.11
Nodes (25): checkHistoryAbort(), cmsPath(), collectCrunchyrollHistoryCatalog(), createMessageId(), HistoryJsonLoader, historyRows(), isCrunchyrollControlResult(), resolveCrunchyrollHistoryMetadata() (+17 more)

### Community 112 - "Invites Client"
Cohesion: 0.08
Nodes (22): EditableProfile, ProfileClient(), ProfileResponse, WaitlistStatus, LoginOAuthButtons(), oauthHref(), Props, Provider (+14 more)

### Community 113 - "Watch Library Client"
Cohesion: 0.09
Nodes (30): AccountWatchLibraryPage(), dynamic, metadata, loadWatchHistoryTitleEpisodePage(), accessFixture(), buttonByLabel(), buttonByText(), capacityFixture() (+22 more)

### Community 114 - "Feature Requests"
Cohesion: 0.11
Nodes (27): POST(), dynamic, KreatliCrmPage(), CATEGORY_LABELS, buildEmail(), clientIp(), FeatureRequestPostDependencies, handleFeatureRequestPost() (+19 more)

### Community 115 - "Invites Client"
Cohesion: 0.09
Nodes (23): CurrentUser, Directory, Editor, EMPTY, FriendsWorkspace(), action(), closeModal(), dismissModal() (+15 more)

### Community 116 - "Account Inbox"
Cohesion: 0.10
Nodes (31): AccountInboxApiError, AccountInboxCountRow, accountInboxCountsFromRow(), accountInboxDatabaseError(), AccountInboxEntryRow, accountInboxItemFromRow(), AccountInboxPageRpcData, buildAccountInboxPage() (+23 more)

### Community 117 - "Room Flow And P2 P"
Cohesion: 0.09
...
### Community 118 - "Task 1 Shared Session And"
Cohesion: 0.06
...
### Community 119 - "P2P Media Harness"
Cohesion: 0.14
...
### Community 120 - "Watch History V3 Routes"
Cohesion: 0.08
Nodes (23): dynamic, GET, dynamic, GET, dynamic, GET, AccountEntitlements, HistoryAccessError (+15 more)

### Community 121 - "History Browser"
Cohesion: 0.08
Nodes (29): dynamic, { GET, POST }, runtime, createWatchHistoryEditorHandlers(), fail(), historyEditorError(), productionStore, ack (+21 more)

### Community 122 - "Player Chrome"
Cohesion: 0.10
...
### Community 123 - "Dependencies Module"
Cohesion: 0.06
...
### Community 124 - "Room State"
Cohesion: 0.08
Nodes (20): RoomSocketVerifiedIdentity, HostStateUpdateErrorCode, HostStateUpdateResult, LEGACY_ROOM_CAPABILITIES, matchesCanonicalFingerprint(), MediaSeatChangeCode, MediaSeatChangeResult, NormalizedRoomSourceUpdate (+12 more)

### Community 125 - "Public Media Blob.Test"
Cohesion: 0.09
Nodes (28): GET(), GOOGLE_ADS_TOKENS_BLOB_PATH, INSTAGRAM_CREDENTIALS_BLOB_PATH, CONTACT_MESSAGES_BLOB_PATH, FEATURE_REQUESTS_BLOB_PATH, KREATLI_CRM_CONTACTS_BLOB_PATH, KREATLI_CRM_META_BLOB_PATH, KREATLI_CRM_TOUCHES_BLOB_PATH (+20 more)

### Community 126 - "Home Survey"
Cohesion: 0.11
Nodes (27): AnalyticsEvents(), onScroll(), ensureReady(), initAmplitudeClient(), startInit(), trackAmplitudeEvent(), UNIFIED_OPTIONS, GA_MEASUREMENT_ID (+19 more)

### Community 127 - "Migrate Private Integration Blobs"
Cohesion: 0.10
...
### Community 129 - "Room Client"
Cohesion: 0.09
Nodes (27): BackgroundPushEvent, dispatchRoomDepartureRuntimeMessage(), handleRemovedRoomTab(), PrivilegedRoomRuntimeDependencies, RemovedRoomTabDependencies, ROOM_ADMISSION_DEPARTURE_SETTLE_TIMEOUT_MS, waitForAdmissionCompletion(), isDiagnosticMessage() (+19 more)

### Community 130 - "Room Invite Notifications"
Cohesion: 0.15
Nodes (25): accountInboxFromBridge(), accountInboxHttpError(), AccountInboxHttpMessage, AccountInboxHttpMessageResponse, AccountInboxUnauthorizedError, decodeAccountInboxResponse(), handleAccountInboxHttpMessage(), isAccountInboxHttpMessage() (+17 more)

### Community 131 - "Popup Watch Drawer"
Cohesion: 0.12
Nodes (26): PopupWatchHistoryPanel(), createListWatchHistoryMessage(), click(), clientFixture(), findButton(), findInput(), fixtureBrowseDetail(), fixtureBrowseEpisodes() (+18 more)

### Community 132 - "Watch History Storage"
Cohesion: 0.10
Nodes (25): canCaptureWatchHistory(), canReadWatchHistory(), createWatchHistoryLease(), historyServerTime(), parseWatchHistoryLease(), personalEnvelopeEligible(), WatchHistoryLease, contextKey() (+17 more)

### Community 133 - "Inventory Module"
Cohesion: 0.06
...
### Community 135 - "Overlay Room Rail"
Cohesion: 0.11
...
### Community 138 - "Production Room Realtime And P2"
Cohesion: 0.10
...
### Community 139 - "Room Persistence"
Cohesion: 0.16
Nodes (26): nextParticipantDisconnectAlarmAt(), ParticipantDisconnectState, ROOM_LIFECYCLE_STORAGE_KEY, claimStoredRoomEndAttempt(), acknowledgeStoredRoomSourceAttempt(), claimStoredRoomSourceAttempt(), enqueueStoredRoomSource(), ensureStoredRoomSourcePending() (+18 more)

### Community 140 - "Rules Module"
Cohesion: 0.07
...
### Community 141 - "Anidachi Auth Integration Implementation Plan"
Cohesion: 0.07
...
### Community 143 - "Shared Protocol Types"
Cohesion: 0.15
Nodes (25): getSecret(), isBoundedId(), isBoundedUrl(), isPositiveInteger(), RoomHistoryAttestationClaims, signRoomHistoryAttestation(), signRoomTokenForTest(), VerifiedRoomToken (+17 more)

### Community 144 - "Overlay Layout Model"
Cohesion: 0.13
...
### Community 145 - "Privileged Overlay Wiring.Test"
Cohesion: 0.11
...
### Community 147 - "Watch History V3 Local Verification"
Cohesion: 0.12
...
### Community 148 - "Watch History Catalog And Progress"
Cohesion: 0.12
...
### Community 151 - "Db Module"
Cohesion: 0.14
Nodes (20): POST(), sanitizeDiscordHandle(), createStripeClient(), getStripeSecretKey(), resolveStripeMode(), STRIPE_API_VERSION, StripeConfigError, stripeEnvForMode() (+12 more)

### Community 152 - "Node:Fs Module"
Cohesion: 0.17
Nodes (22): psqlArgs, query(), waitForLock(), node:child_process, child, createDriver(), apply(), document() (+14 more)

### Community 153 - "Main Repository Monorepo Migration Implementation"
Cohesion: 0.07
...
### Community 154 - "Ani Dachi Pre Release Security"
Cohesion: 0.13
...
### Community 155 - "P2P Ice"
Cohesion: 0.16
Nodes (24): buildIceServersRequest(), CachedIceServers, cachedIceServersByScope, clearP2PIceServersCacheForTest(), cloneIceServers(), dedupeIceServers(), getIceServerUrls(), hasTurnServer() (+16 more)

### Community 156 - "Room Session Storage.Test"
Cohesion: 0.09
...
### Community 157 - "Strict Module"
Cohesion: 0.12
Nodes (19): dir, identity(), json(), quote(), snapshot(), sql(), target, cleanup() (+11 more)

### Community 158 - "Watch History Room Authority Threat"
Cohesion: 0.08
...
### Community 159 - "Node:Fs Module"
Cohesion: 0.09
Nodes (19): checks, d, finished, identity, input(), operatorFenceSources(), q(), read() (+11 more)

### Community 160 - "Include Module"
Cohesion: 0.08
Nodes (23): @cloudflare/workers-types, compilerOptions, types, extends, include, src, test, compilerOptions (+15 more)

### Community 161 - "User Identity"
Cohesion: 0.15
...
### Community 162 - "Popup Watch Drawer"
Cohesion: 0.19
Nodes (19): PopupTab, boolean(), forgetPopupView(), HistoryView, PopupView, position(), readPopupHistoryView(), readPopupView() (+11 more)

### Community 163 - "Vitest Module"
Cohesion: 0.17
Nodes (17): applyPersonalHistoryResume(), takePersonalHistoryResume(), input(), launch(), historyOwner, intent(), now, buildPersonalHistoryResumeUrl() (+9 more)

### Community 164 - "Anidachi Seo Aeo Pages"
Cohesion: 0.08
...
### Community 165 - "Personal History Mvp Staging Delivery"
Cohesion: 0.12
Nodes (25): Actual relay physical media distributed 15 4 8 acceptance open, Authority refresh invalidates queued samples across eligibility changes, Complete candidate stats bounded five second resampling, Confirmed main content clock eligibility for personal history, External production delivery traffic and recovery prerequisites open, Final extension local proof 153 focused and 1916 full tests, LIVE Stripe and actual paid period expiry acceptance open, Loaded staging real YouTube ad and MV3 acceptance open (+17 more)

### Community 166 - "Hosted Recovery Rehearsal"
Cohesion: 0.10
Nodes (25): Full public and migration-history aggregate digests, Application restore TOC preserves owners and object ACLs, Application cleanup restore and hold reinstall in one transaction, Original backup-bound transition input and independent hashes, Unchanged first 35 migrations with password-free db-url, Inactive two-job cron baseline before synthetic fixture, Drained consistent full synthetic recovery checkpoint, Free hosted 35 to 60 to 35 rehearsal commands (+17 more)

### Community 167 - "Commercial Room, P2 P, And"
Cohesion: 0.08
...
### Community 168 - "Source Adapter Architecture Implementation Plan"
Cohesion: 0.08
...
### Community 169 - "Canonical Runtime Flow"
Cohesion: 0.10
...
### Community 170 - "Room Socket Attachment"
Cohesion: 0.09
Nodes (13): app, closeInvalidRoomFrame(), closeRoomRateLimitedSocket(), consumeParsedRoomEventBoundary(), consumeRoomFrameBoundary(), encode(), getRoomEventClass(), isRoomEventInScope() (+5 more)

### Community 171 - "Use Camera Interaction Lock"
Cohesion: 0.13
...
### Community 181 - "Watch History Storage"
Cohesion: 0.13
...
### Community 183 - "Invitation Delivery Reliability Implementation Plan"
Cohesion: 0.09
...
### Community 188 - "Room Socket Attachment"
Cohesion: 0.13
...
### Community 189 - "Room Rate Limiter"
Cohesion: 0.17
Nodes (5): CLASS_LIMITS, RoomEventClass, RoomRateLimitDecision, RoomRateLimiter, RoomSubjectRateLimiters

### Community 190 - "Wxt.Config Module"
Cohesion: 0.10
Nodes (18): deriveChromiumExtensionId(), ExtensionChannel, getExtensionManifestKey(), LOCAL_EXTENSION_ID, LOCAL_EXTENSION_MANIFEST_KEY, resolveExtensionChannel(), STAGING_EXTENSION_ID, STAGING_EXTENSION_MANIFEST_KEY (+10 more)

### Community 191 - "Popup Watch Drawer"
Cohesion: 0.15
Nodes (20): aggregate, browse(), button(), change(), click(), clientFixture(), detail(), episode (+12 more)

### Community 192 - "Kreatli Crm Data Schema"
Cohesion: 0.13
...
### Community 193 - "Auth Artifact Cleanup.Test"
Cohesion: 0.10
...
### Community 195 - "Watch History V2 Clean Mvp"
Cohesion: 0.09
...
### Community 196 - "Personal History And Plans Mvp"
Cohesion: 0.12
...
### Community 197 - "Html5 Video Adapter"
Cohesion: 0.12
Nodes (4): duckVideoVolume(), getDocumentVideoKey(), getStableVideoSourceKey(), Html5VideoAdapter

### Community 198 - "Overlay Layout Editor.Test"
Cohesion: 0.10
Nodes (5): OverlayLayoutEditorProps, OverlayLayoutContext, OverlayLayoutDefinition, measuredLayoutContext, RenderedEditor

### Community 199 - "Private Integration Blob"
Cohesion: 0.20
Nodes (17): clearStateCookie(), dynamic, GET(), getOrigin(), ShortLivedTokenResponse, POST(), GET(), clearAllCredentials() (+9 more)

### Community 200 - "Json Unauthorized Unless Kreatli Session"
Cohesion: 0.20
Nodes (16): clearCookies(), dynamic, GET(), getOrigin(), POST(), GET(), clearBlob(), clearCredentials() (+8 more)

### Community 201 - "Db Module"
Cohesion: 0.21
Nodes (18): ACTIVE_ROOM_CONFLICT_MESSAGE, ActiveRoomAssignment, ActiveRoomClaimDatabaseResult, activeRoomConflictResponseInput(), ActiveRoomCreateDatabaseResult, ActiveRoomReleaseDatabaseResult, ActiveRoomSessionDatabaseError, ActiveRoomSummary (+10 more)

### Community 202 - "Public Module"
Cohesion: 0.10
...
### Community 203 - "Development Flow Quality System Plan"
Cohesion: 0.10
...
### Community 204 - "Friends And Groups Link First"
Cohesion: 0.17
Nodes (21): Atomic private group modal with retained drafts, Background social bridge owner and revision fencing, Deliberate one time friend link generation, Extension People MVP plan, Loaded staging People artifact 6dd848dc read only smoke, Real group save and two account link acceptance remain open, Atomic owner plan friendship revision checked group saves, Atomic single recipient friend link consumption (+13 more)

### Community 205 - "P2P Media Harness"
Cohesion: 0.10
Nodes (19): esbuild, playwright, dependencies, playwright, name, private, scripts, chrome (+11 more)

### Community 206 - "Linked In Sales Navigator Connection"
Cohesion: 0.10
...
### Community 209 - "Room Invite Target Status"
Cohesion: 0.17
...
### Community 210 - "Node:Fs Module"
Cohesion: 0.14
Nodes (14): providerDirectories, sharedOverlayRuntimeFiles, sourceAdaptersDirectory, sourceDirectory, legacyCodeHash, psqlArgs, secondLegacyCodeHash, node:fs (+6 more)

### Community 211 - "Package Module"
Cohesion: 0.10
Nodes (19): typescript, typescript, dependencies, zod, devDependencies, typescript, vitest, exports (+11 more)

### Community 212 - "Strict Module"
Cohesion: 0.11
Nodes (13): begin(), cases, commit(), failed, first, foreign, omitted, outputPath (+5 more)

### Community 213 - "Anidachi Project Operating Manual"
Cohesion: 0.10
...
### Community 214 - "Shared Watch Progress Tracker"
Cohesion: 0.15
...
### Community 215 - "Development Workflow Hardening Implementation Plan"
Cohesion: 0.10
...
### Community 216 - "Plan Code Canonicalization And Billing"
Cohesion: 0.10
...
### Community 220 - "Adapter Playback Snapshot"
Cohesion: 0.22
...
### Community 221 - "Watch History Client"
Cohesion: 0.15
...
### Community 225 - "Popup Watch Drawer"
Cohesion: 0.20
...
### Community 232 - "Anidachi Development Environments"
Cohesion: 0.11
...
### Community 233 - "Ani Dachi New Chat Project"
Cohesion: 0.11
...
### Community 234 - "Open Claw: You Tube Shorts"
Cohesion: 0.11
...
### Community 235 - "Compiler Options"
Cohesion: 0.11
...
### Community 236 - "Shared Protocol Types"
Cohesion: 0.21
Nodes (15): attachmentToVerifiedRoomToken(), createRoomSocketAttachment(), isNonNegativeInteger(), isRecord(), parseAdmission(), parseRoomSocketAttachment(), parseVerifiedIdentity(), ROOM_SOCKET_ATTACHMENT_VERSION (+7 more)

### Community 237 - "Popup Styles"
Cohesion: 0.21
...
### Community 238 - "Chrome Web Store Listing —"
Cohesion: 0.12
...
### Community 240 - "Maintenance Admission"
Cohesion: 0.12
Nodes (17): Manual Free-plan hosted rehearsal path, Hosted proof closes only tested DB operator recovery questions, Temporary Free-project rehearsal window, Two active Free-project limit and zero-cost creation boundary, Normal test-room drain before publication shutdown, Pause exact staging project and recheck production health, Supabase capacity pause and Cloudflare publication references, Three named staging jobs and pending delivery drain (+9 more)

### Community 241 - "Watch History Local Read Implementation"
Cohesion: 0.17
...
Cohesion: 0.13
Nodes (13): anon, cleanup_removed_friend_memberships_v1, public.accept_friend_link_v1(), public.save_friend_group_v1(), validate_friend_group_member_v1, authenticated, public, public.cleanup_removed_friend_memberships_v1 (+5 more)

### Community 245 - "Package Module"
Cohesion: 0.12
Nodes (15): devDependencies, typescript, vite, vitest, vitest, name, private, scripts (+7 more)

### Community 246 - "Ghost Cam Size"
Cohesion: 0.22
...
### Community 248 - "Shared Protocol Types"
Cohesion: 0.17
...
### Community 251 - "Social Rooms Subscriptions Execution Plan"
Cohesion: 0.17
...
### Community 252 - "P2P Media Harness"
Cohesion: 0.20
Nodes (13): record(), runVersionedMediaCase(), runVersionedMediaFaults(), shouldPrintHarnessDebug(), signRoomToken(), startPeer(), b64url(), createHarnessRoomToken() (+5 more)

### Community 253 - "Popup App"
Cohesion: 0.22
Nodes (13): CachedSocialSnapshot, getCachedSocialSnapshotForUser(), isCanonicalUtcTimestamp(), isRecord(), isSocialSnapshotCacheFresh(), parseCachedSocialSnapshot(), setCachedSocialSnapshotForUser(), SOCIAL_SNAPSHOT_CACHE_MAX_AGE_MS (+5 more)

### Community 254 - "Create Watch History Client"
Cohesion: 0.21
Nodes (11): acknowledgeWatchHistoryEvent(), enqueueWatchHistoryEvent(), eventMatchesDeletion(), orderWatchHistoryOutbox(), personalRequest(), removeWatchHistoryEventsForDeletion(), WatchHistoryOutboxEntry, watchHistoryOutboxKey() (+3 more)

### Community 255 - "Cn Module"
Cohesion: 0.17
Nodes (11): ConnectClient(), ERROR_MESSAGES, IgAccount, IgStatus, TtAccount, TtStatus, YtAccount, YtStatus (+3 more)

### Community 256 - "Cn Module"
Cohesion: 0.18
Nodes (10): AccountEntryLink(), destinations, NavUser, UserMenu(), dom, mount(), open(), trigger() (+2 more)

### Community 257 - "Watch History V3 Routes"
Cohesion: 0.16
...
### Community 258 - "Watch History Capacity Concurrency Contract"
Cohesion: 0.20
Nodes (14): args, contend(), event(), labels, literal(), live, marker, ports (+6 more)

### Community 259 - "20260814010000 Watch History V2 Foundation"
Cohesion: 0.25
...
### Community 260 - "Pull Request Template"
Cohesion: 0.13
...
### Community 261 - "Maintenance Admission"
Cohesion: 0.15
Nodes (15): Default-open Web and Worker maintenance admission, Server-only ANIDACHI_MAINTENANCE_MODE, Shared protocol maintenance parser, Maintenance Admission, Website HTTP failure retains owner-guarded editor state, Existing Web asset and metadata exclusions, Retained unacknowledged extension history entries, Local maintenance contract and consumer verification (+7 more)

### Community 262 - "Personal History And Plans Mvp"
Cohesion: 0.13
...
### Community 264 - "Voice Controls And Participant Audio"
Cohesion: 0.13
...
### Community 265 - "Interface Visibility Settings Design"
Cohesion: 0.13
...
### Community 266 - "Source Navigation"
Cohesion: 0.19
Nodes (14): boundedCanonicalRoomSource(), canonicalizeProviderUrl(), CanonicalRoomSource, CanonicalRoomSourceUrlResult, crunchyrollWatchPath(), currentRuntimeYouTubeFingerprint(), isYouTubeVideoId(), providerForHostname() (+6 more)

### Community 267 - "Room Persistence"
Cohesion: 0.32
Nodes (11): acknowledgeRoomUsageDay(), createRoomMeterState(), MAX_PENDING_USAGE_DAYS, parseRoomMeterState(), reconcileLegacyRoomMeter(), reconcileRoomMeter(), roomUsageBuckets(), roomUsageSummary() (+3 more)

### Community 268 - "Personal History Mvp Design"
Cohesion: 0.14
...
### Community 275 - "Handoff For Ai Working On"
Cohesion: 0.14
...
### Community 278 - "Two Phase Production Promotion"
Cohesion: 0.16
...
### Community 279 - "Waitlist And Crm Durable Storage"
Cohesion: 0.23
...
### Community 280 - "Ani Dachi Contributor Startup Contract"
Cohesion: 0.19
...
### Community 286 - "Scratchpad Module"
Cohesion: 0.17
...
### Community 287 - "Project Architecture And Development"
Cohesion: 0.31
Nodes (13): Direct first WebRTC with Cloudflare TURN fallback, Extension viewing and capture client plane, Inactive policy 1 capture 1 media protocol 2, Personal writer independent of host created history sessions, Production database Worker Web ordered transition gate, Project Architecture And Development, Provider video remains on each viewer provider page, Removed LiveKit transport requires a new deliberate decision (+5 more)

### Community 288 - "Codex Hosted Semantic Extraction"
Cohesion: 0.17
...
### Community 289 - "Personal History Mvp Staging Delivery"
Cohesion: 0.23
Nodes (13): Paid personal capture and retained Free read Resume delete, Shared media policy activation and C04 recovery remain gated, C04 active policy compatible recovery remains unperformed, Database prerequisites before compatible Web Worker and client, Free retained history reads Resume and deletion stay allowed, Historical 177 non ended legacy database room records, Historical September 8 inactive staging delivery identities, Immutable artifact hashes and loaded browser identity are distinct (+5 more)

### Community 290 - "September 12 Prelaunch Remediation Verification"
Cohesion: 0.27
Nodes (13): Legacy 8000 ms harness boundary restored, Actual P2PMediaController RoomClient and local Worker, Bundled production verifier regression with legacy compatibility, Complete camera receiver nearest rank p95 strictly below 6000 ms, Forced relay requires actual selected relay at every endpoint, Legacy per direction 8000 ms first frame boundary, Media v2 host p0 session s0 real Worker ICE preflight, Production issuer audience and participant session token fixture (+5 more)

### Community 291 - "One Canonical Personal Episode Progress"
Cohesion: 0.24
...
### Community 292 - "Global Constraints"
Cohesion: 0.15
...
### Community 293 - "V1 Product Decisions (Historical)"
Cohesion: 0.17
...
### Community 294 - "Shared Pure Visibility Policy"
Cohesion: 0.21
...
### Community 297 - "Server Module"
Cohesion: 0.24
Nodes (9): ApiSession, cleanAvatarUrl(), createProfilePatchHandler(), ProfilePatchDependencies, ProfileUpdate, cleanDisplayName(), normalizeHandle(), PublicProfile (+1 more)

### Community 298 - "Watch History V3 Sql.Test"
Cohesion: 0.20
...
### Community 301 - "Watch History V3.Test"
Cohesion: 0.17
...
### Community 302 - "Project Knowledge Map"
Cohesion: 0.17
...
### Community 303 - "Account Library And Manual Progress"
Cohesion: 0.27
...
### Community 304 - "Popup People And Social Directory"
Cohesion: 0.17
...
### Community 306 - "Smoke Staging Web"
Cohesion: 0.29
...
### Community 307 - "Incremental Re Extraction"
Cohesion: 0.18
...
### Community 309 - "Download On The App Store"
Cohesion: 0.31
...
### Community 310 - "20260816090000 Watch History V2 Bounded"
Cohesion: 0.18
...
### Community 312 - "Resources Progress Menu Implementation Plan"
Cohesion: 0.18
...
### Community 314 - "Watch History Capacity"
Cohesion: 0.20
...
### Community 317 - "Overlay Media Session"
Cohesion: 0.27
Nodes (8): CameraEnabledForRoomConnectionInput, DEFAULT_LOCAL_CAMERA_ENABLED, P2PMediaSessionInput, P2PMediaSessionState, persistRoomSessionForCurrentJoin(), PersistRoomSessionForCurrentJoinInput, RoomConnectionStatus, HarnessState

### Community 318 - "Room Quota Display"
Cohesion: 0.36
Nodes (8): applyRoomUsageSnapshot(), AuthoritativeQuotaAnchor, authoritativeQuotaRemainingSeconds(), isNewerRoomUsage(), nonnegative(), quotaDayFromResetAt(), roomQuotaRemainingSeconds(), RoomQuotaSnapshot

### Community 319 - "Max Participant Id Chars"
Cohesion: 0.29
Nodes (7): loadVoiceModePreference(), parseVoiceModePreference(), persistVoiceModePreference(), StorageAreaLike, VOICE_MODE_PREFERENCE_VERSION, VoiceModePreferenceRecord, voiceModePreferenceStorageKeyForUser()

### Community 320 - "Room Invite Notification Runtime.Test"
Cohesion: 0.22
Nodes (5): alarms, diagnostic, json(), registered(), state

### Community 321 - "Seo Trust & Authority Plan"
Cohesion: 0.20
...
### Community 322 - "Ani Dachi Logo Asset"
Cohesion: 0.33
...
### Community 323 - "20260819133849 Auth Channel Rotation"
Cohesion: 0.38
...
### Community 326 - "Mvp Plan Pricing"
Cohesion: 0.20
...
### Community 328 - "Completed Public Product Recovery Record"
Cohesion: 0.20
...
### Community 329 - "Watch Drawer Browse Implementation Plan"
Cohesion: 0.20
...
### Community 330 - "Panel Account Title"
Cohesion: 0.39
...
### Community 331 - "Overlay Layout Ghost Preview"
Cohesion: 0.33
...
### Community 332 - "Overlay Layout Engine.Test"
Cohesion: 0.31
...
### Community 334 - "Conversion Metrics (Ga4)"
Cohesion: 0.22
...
### Community 335 - "Host Avatar Asset"
Cohesion: 0.28
...
### Community 336 - "Personal Mvp Activation Contract"
Cohesion: 0.28
Nodes (8): activation, args, delay(), policy(), readme, sql(), target, until()

### Community 337 - "Public Module"
Cohesion: 0.22
...
### Community 338 - "20260907194413 Personal History Access"
Cohesion: 0.25
...
### Community 339 - "Graphify Reference: Extra Exports And"
Cohesion: 0.22
Nodes (8): graphify reference: extra exports and benchmark, Step 6b - Wiki (only if --wiki flag), Step 7 - Neo4j export (only if --neo4j or --neo4j-push flag), Step 7a - FalkorDB export (only if --falkordb or --falkordb-push flag), Step 7b - SVG export (only if --svg flag), Step 7c - GraphML export (only if --graphml flag), Step 7d - MCP server (only if --mcp flag), Step 8 - Token reduction benchmark (only if total_words > 5000)

### Community 340 - "Executor'S Feedback Or Assistance Requests"
Cohesion: 0.22
...
### Community 341 - "Participant Session Identity"
Cohesion: 0.28
...
### Community 342 - "Social Rooms, Friends, Groups, And"
Cohesion: 0.22
...
### Community 344 - "Real Web Rtc Two Browser"
Cohesion: 0.25
...
### Community 349 - "Crunchyroll.Content Module"
Cohesion: 0.25
...
### Community 353 - "Natsuki Avatar Asset"
Cohesion: 0.43
...
### Community 362 - "Approved Voice Ux Simplification V2"
Cohesion: 0.25
...
### Community 363 - "Production Acceptance Snapshot: 685 Survey"
Cohesion: 0.29
...
### Community 364 - "You Tube Adapter Notes"
Cohesion: 0.25
...
### Community 367 - "Ani Dachi Apple Touch Icon"
Cohesion: 0.43
...
### Community 368 - "Link Module"
Cohesion: 0.29
Nodes (5): faq, headings, itemList, metadata, SITE_URL

### Community 369 - "Get Guide Links"
Cohesion: 0.29
Nodes (6): faq, metadata, RaveAlternativesForYoutubePage(), SITE_URL, tocHeadings, PRICING_RAVE_COMPARE_YOUTUBE_FAQ

### Community 370 - "Node:Test Module"
Cohesion: 0.52
Nodes (6): enabled, exactRecord(), parseResourceDetailPage(), parseResourceEpisodeCursor(), parseResourceTitlePage(), RecordValue

### Community 371 - "Ani Dachi Web Logo Asset"
Cohesion: 0.52
...
### Community 374 - "Anidachi Seo Aeo Pages"
Cohesion: 0.29
...
### Community 375 - "Project Status Board"
Cohesion: 0.29
...
### Community 376 - "Site, Extension, Auth, And Database"
Cohesion: 0.29
...
### Community 377 - "Watch History Capacity"
Cohesion: 0.29
...
### Community 378 - "Voice Ux Simplification V2"
Cohesion: 0.29
...
### Community 379 - "Participant Audio Controls"
Cohesion: 0.29
...
### Community 380 - "Shared Pure Visibility Policy"
Cohesion: 0.33
...
### Community 381 - "Watch History Catalog And Progress"
Cohesion: 0.29
...
### Community 382 - "Account Data Watch History Social"
Cohesion: 0.29
...
### Community 392 - "Anidachi Private"
Cohesion: 0.40
...
### Community 393 - "20260908071729 Room Media Negotiation Fence"
Cohesion: 0.40
...
### Community 394 - "Personal History Access.Test"
Cohesion: 0.33
Nodes (3): access_results, saved_order, saved_progress

### Community 398 - "Watch History V3 Episode Previews.Test"
Cohesion: 0.40
Nodes (3): bounded_preview, pg_temp.preview_tail(), preview_pages

### Community 400 - "Graphify Reference: Query, Path, Explain"
Cohesion: 0.33
Nodes (5): For /graphify explain, For /graphify path, graphify reference: query, path, explain, Step 0 — Constrained query expansion (REQUIRED before traversal), Step 1 — Traversal

### Community 401 - "High Level Task Breakdown (Historical)"
Cohesion: 0.33
...
### Community 402 - "Sitewide Cta → Plan Picker"
Cohesion: 0.33
...
### Community 403 - "Account Subscription Cancellation"
Cohesion: 0.33
...
### Community 404 - "Global Constraints"
Cohesion: 0.47
...
### Community 405 - "Billing And Entitlements"
Cohesion: 0.33
...
### Community 408 - "Always Visible Compact Participant Pills"
Cohesion: 0.33
...
### Community 409 - "Final Staging Runtime Acceptance"
Cohesion: 0.33
...
### Community 410 - "Exact Assignment Release"
Cohesion: 0.33
...
### Community 411 - "Account Data History Social And"
Cohesion: 0.53
...
### Community 412 - "Accepted Catalog Read"
Cohesion: 0.33
...
### Community 428 - "Vercel Module"
Cohesion: 0.40
Nodes (4): ignoreCommand, regions, $schema, sfo1

### Community 429 - "Anidachi Seo Aeo Pages"
Cohesion: 0.40
...
### Community 430 - "Anidachi Seo Aeo Pages"
Cohesion: 0.40
...
### Community 431 - "Service Level Objectives"
Cohesion: 0.40
...
### Community 434 - "V2 Staging Acceptance Matrix"
Cohesion: 0.40
Nodes (5): Mode and Privacy, Recovery and Load, Room-Scoped Restore, UI and Indicators, V2 Staging Acceptance Matrix

### Community 435 - "Account Data Watch History Social"
Cohesion: 0.40
Nodes (5): Conditional Invite Response, Historical Invite Expiry Transition, Missed Invite Presentation, Room Full Preserves Pending Invite, Room Lifecycle Invite Actionability

### Community 436 - "Protocol Agent Instructions"
Cohesion: 0.40
Nodes (4): packages/protocol Agent Instructions, Rules, Source Of Truth, Verification

### Community 437 - "Production History 35 To 60"
Cohesion: 0.67
Nodes (4): API typecheck unit runtime and Wrangler dry run gates, Deploy API workflow, Main Worker deployment hold, Staging only Worker deployment pipeline

### Community 440 - "20260602 Extension Auth"
Cohesion: 0.67
Nodes (3): public.devices, public.extension_auth_codes, public.users

### Community 443 - "Public Module"
Cohesion: 0.50
Nodes (3): public.watch_catalog_read_v3(), public.watch_catalog_snapshots, public.watch_episode_progress

### Community 445 - "20260908070552 Room Media Compatibility Fence"
Cohesion: 0.67
...
### Community 458 - "Current Operational Source Of Truth"
Cohesion: 0.50
...
### Community 459 - "Account Mvp Workspace"
Cohesion: 0.50
...
### Community 460 - "Account Data Watch History Social"
Cohesion: 0.50
...
### Community 461 - "Account Data Watch History Social"
Cohesion: 0.50
Nodes (4): Immutable Invite Recipient Snapshot, Invite Recipient And Sender Bounds, Invite Retry Compatibility Bridge, Semantic Room Invite Dedupe

### Community 462 - "Five Object Crm Reconciliation"
Cohesion: 0.50
...
## Knowledge Gaps
- **3611 isolated node(s):** `DataTableColumn`, `CtaCopyKey`, `SeoGuideOption`, `SeoGuideRelatedLink`, `SeoGuideStep` (+3606 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 4995 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
...
- **Why does `react` connect `Page Module` to `Cn Module`, `Overlay App`, `Pricing Copy`, `Popup Watch Drawer`, `External References`, `Overlay Room Rail`, `Popup Watch Drawer`, `Layout Module`, `Html5 Video Adapter`, `Popup App`, `Invites Client`, `Playback Sync Controller`, `Privileged Overlay Wiring.Test`, `Invites Client`, `Reaction Pop`, `Content Module`, `Page Module`, `Voice Audio Preferences`, `Popup Watch Drawer`, `Voice Audio Preferences`, `Popup People Panel.Test`, `Use Camera Interaction Lock`, `Crm Client`, `Chrome Extension Demo Async Overlay`, `Room Media Defaults`, `Cn Module`, `Room State`, `Popup Watch Drawer`, `Reaction Shortcuts`, `Interface Preferences`, `Store Module`, `Overlay Room Rail`, `Overlay Layout Editor.Test`, `Page Module`, `Panel Account Title`, `Overlay Layout Ghost Preview`, `Account Inbox Cache`, `Billing Module`, `Watch Library Client`, `Home Survey`, `Ghost Cam`, `Overlay Layout Editor`, `Popup Watch Drawer`, `Home Survey`, `Invites Client`, `Watch Library Client`, `Feature Requests`, `Invites Client`, `Home Survey`, `Cn Module`?**
  _High betweenness centrality (0.087) - this node is a cross-community bridge._
- **Why does `next/server` connect `Server Module` to `Social API Operations`, `Watch History V3 Routes`, `Account Module`, `Plan Entitlements`, `Db Module`, `Device Push`, `Oauth Transaction`, `Room Session`, `Extension Codes`, `Route Module`, `Server Module`, `Oauth Module`, `Room Source`, `Middleware Module`, `Db Module`, `Json Unauthorized Unless Kreatli Session`, `Private Integration Blob`, `Plan Entitlements`, `Store Module`, `Private Integration Blob`, `Json Unauthorized Unless Kreatli Session`, `Billing Module`, `Verify Kreatli Crm Session`, `Route Module`, `Middleware Module`, `Survey Lead`, `Watch History Client`, `Route Module`, `Watch Library Routes.Test`, `Storage Module`, `Watch History`, `Feature Requests`, `Invites Client`, `Watch History V3 Routes`, `History Browser`, `Public Media Blob.Test`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `vitest` connect `Registry Module` to `Overlay App`, `Popup Watch Drawer`, `Html5 Video Adapter`, `Popup App`, `Auth Client`, `Account Module`, `Playback Sync Controller`, `Social Client`, `Room Invite Notifications`, `Room Persistence`, `Watch History`, `Content Module`, `Create Watch History Client`, `Room Client`, `Room Session`, `Extension Codes`, `Diagnostic Log`, `Progress Module`, `Voice Audio Preferences`, `Popup People Panel.Test`, `Diagnostic Log`, `Room Departure Retry`, `Privileged Overlay Intent`, `Room Media Defaults`, `Room State`, `Room Session`, `Room Departure`, `Reaction Shortcuts`, `Interface Preferences`, `Internal Web Client`, `Overlay Room Rail`, `Watch History Storage`, `Index Module`, `Account Inbox Cache`, `Middleware Module`, `Room Hibernation Runtime`, `Ghost Cam`, `Overlay Layout Editor`, `Player Chrome`, `Room State`, `Room State`, `Room State`, `Watch History`, `Room Persistence`, `Adapter Playback Snapshot`, `Shared Protocol Types`, `P2P Media`, `Room Client`, `Catalog Module`, `Player Chrome`, `Room State`, `Room Client`, `Room Invite Notifications`, `Popup Watch Drawer`, `Watch History Storage`, `Ice Servers`, `Overlay Room Rail`, `Catalog Module`, `Room Persistence`, `Shared Protocol Types`, `Overlay Layout Model`, `Privileged Overlay Wiring.Test`, `Reaction Pop`, `P2P Ice`, `Room Session Storage.Test`, `User Identity`, `Popup Watch Drawer`, `Vitest Module`, `Room Socket Attachment`, `Use Camera Interaction Lock`, `Voice Activity`, `Artwork Select`, `Overlay Layout Runtime`, `Watch History Storage`, `Index Module`, `Room Socket Attachment`, `Room Rate Limiter`, `Popup Watch Drawer`, `Html5 Video Adapter`, `Overlay Layout Editor.Test`, `Room Invite Target Status`, `Node:Fs Module`, `Reaction Shortcuts`, `Adapter Playback Snapshot`, `Popup Watch Drawer`, `Release Channel Build.Test`, `Shared Protocol Types`, `Popup Styles`, `Ghost Cam Size`, `Popup App`, `Create Watch History Client`, `Room Persistence`, `Overlay App`, `Index Module`, `Overlay Media Session`, `Room Quota Display`, `Room Invite Notification Runtime.Test`, `Panel Account Title`, `Overlay Layout Ghost Preview`, `Overlay Layout Engine.Test`, `Room Tab Lock`, `Overlay App`, `Index Module`, `Room Hibernation Runtime`, `Voice Audio Preferences`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
Host-session semantic extraction token usage is not separately metered; zero counters are placeholders, not a claim of zero token consumption.
