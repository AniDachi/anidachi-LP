...
## Corpus Check
- Incremental slice processed: 4 changed files (1 SQL, 3 documents); counts below describe the full corpus.
- SQL coverage: the installed parser emitted 1 file node and 0 relationship edges for the reviewed receipt source.
- 1338 files · ~1,324,375 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 12501 nodes · 27724 edges · 768 communities (441 shown, 285 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 455 edges (avg confidence: 0.85)
- Token cost: unmetered Codex-hosted semantic extraction (3 documents, 1 subagent); host token usage was unavailable. AST extraction is deterministic. Numeric placeholders are not measured zero usage.

## Graph Freshness
- Built from commit: `0ab1b054`
...
- MemoryStorageArea
- how-to-watch-crunchyroll-with-friends-without-account-sharing/page.tsx
...
## Communities (768 total, 285 thin omitted)

### Community 0 - "next/link"
Cohesion: 0.01
Nodes (245): metadata, faq, itemList, metadata, tocHeadings, AniDachiVsTwosevenPage(), faq, headings (+237 more)

### Community 1 - "react"
Cohesion: 0.02
Nodes (184): metadata, EditableProfile, ProfileResponse, WaitlistStatus, BlouLoginForm(), safeNextParam(), dynamic, metadata (+176 more)

### Community 2 - "getGuideLinks"
Cohesion: 0.02
Nodes (203): faq, headings, metadata, SITE_URL, faq, headings, metadata, SITE_URL (+195 more)

### Community 3 - "getResolvedSiteOrigin"
Cohesion: 0.01
Nodes (127): faq, headings, metadata, SITE_URL, faq, headings, metadata, SITE_URL (+119 more)

### Community 4 - "room-invite-notifications.ts"
Cohesion: 0.04
Nodes (118): BackgroundPushEvent, ROOM_ADMISSION_DEPARTURE_SETTLE_TIMEOUT_MS, accountInboxFromBridge(), accountInboxHttpError(), AccountInboxHttpMessage, AccountInboxHttpMessageResponse, AccountInboxUnauthorizedError, decodeAccountInboxResponse() (+110 more)

### Community 5 - "overlay-app.tsx"
Cohesion: 0.03
Nodes (108): useActiveAdapterPlayback(), HOLD_FIRE_SUPER_REACTION_EXPERIMENT, normalizeExperimentFlag(), useGhostCam(), attachAndPlayVideoElement(), ANIDACHI_COMPOSER_OPEN_ATTR, ANIDACHI_MESSAGE_COMPOSER_SHORTCUT_EVENT, ANIDACHI_MESSAGE_COMPOSER_SUBMIT_EVENT (+100 more)

### Community 6 - "getSession"
Cohesion: 0.04
Nodes (93): BillingPage(), dynamic, metadata, dynamic, GET(), maxDuration, POST(), dynamic (+85 more)

### Community 7 - "watch-history-v3-routes.ts"
Cohesion: 0.03
Nodes (86): AccountWatchLibraryPage(), dynamic, metadata, Dependencies, loadWatchLibraryData(), dynamic, POST, dynamic (+78 more)

### Community 8 - "invites-client.tsx"
Cohesion: 0.03
Nodes (77): AccountNav(), PRIMARY, SECONDARY, PLAN_NAMES, metadata, AcceptInviteResponse, AccountInboxItem, acknowledgeInboxPageSeen() (+69 more)

### Community 9 - "protocol/src/index.ts"
Cohesion: 0.04
Nodes (81): getSecret(), isBoundedId(), isBoundedUrl(), isPositiveInteger(), RoomHistoryAttestationClaims, signRoomHistoryAttestation(), signRoomTokenForTest(), verifyRoomToken() (+73 more)

### Community 10 - "room-client.ts"
Cohesion: 0.03
Nodes (85): PrivilegedRoomRuntimeDependencies, RemovedRoomTabDependencies, waitForAdmissionCompletion(), PrivilegedOverlayContext, PrivilegedOverlayIntentDependencies, AdmittedRoom, assertRoomHttpResponse(), bridgeError() (+77 more)

### Community 11 - ".next/**"
Cohesion: 0.02
Nodes (80): faq, itemList, metadata, tocHeadings, faq, headings, metadata, SITE_URL (+72 more)

### Community 12 - "anidachi-auth/watch-history-access.ts"
Cohesion: 0.03
Nodes (80): dynamic, GET, dynamic, GET, dynamic, GET, runtime, dynamic (+72 more)

### Community 13 - "auth-client.ts"
Cohesion: 0.04
Nodes (89): assertExtensionLogoutRedirect(), attemptWebsiteLogoutFlow(), AuthCommand, AuthMessage, AuthMessageResponse, buildExtensionConnectUrl(), buildExtensionLogoutUrl(), buildWebUrl() (+81 more)

### Community 14 - "VideoAdapter"
Cohesion: 0.07
Nodes (14): ActiveAdapterPlaybackOptions, readCurrentResourceDisplay(), isMediaSettling(), waitForMediaReady(), PlaybackSyncController, ActiveAdapterHooks, AdapterManager, VideoAdapter (+6 more)

### Community 15 - "social.ts"
Cohesion: 0.05
Nodes (86): AccountFriendsPage(), dynamic, metadata, AccountLayout(), acceptFriendInviteLink(), acceptFriendRequest(), acceptRoomInvite(), addFriendGroupMember() (+78 more)

### Community 16 - "room-session-storage.ts"
Cohesion: 0.07
Nodes (84): handleRoomAdmissionHandoffMessage(), resolveRoomMediaDefaults(), assertTabId(), clearRoomSessionForClosedTab(), clearRoomSessionForDepartureIfMatch(), clearRoomSessionForDepartureIfMatchNow(), clearRoomSessionIfMatch(), clearRoomSessionIfMatchForTabNow() (+76 more)

### Community 17 - "account.ts"
Cohesion: 0.03
Nodes (80): dynamic, dynamic, GET(), maxDuration, createAccountResponseMeta(), createOwnedAccountResponseMeta(), cleanInviteMessage(), listRoomInvites() (+72 more)

### Community 18 - "RoomState"
Cohesion: 0.04
Nodes (28): emptyMediaState(), HostStateUpdateErrorCode, HostStateUpdateResult, LEGACY_ROOM_CAPABILITIES, matchesCanonicalFingerprint(), MediaSeatChangeCode, MediaSeatChangeResult, NormalizedRoomSourceUpdate (+20 more)

### Community 19 - "session.ts"
Cohesion: 0.05
Nodes (68): dynamic, POST(), dynamic, GET(), loginRedirectUrl(), POST(), refreshSessionFromCookie(), checkoutSessionUserId() (+60 more)

### Community 20 - "api/src/index.ts"
Cohesion: 0.05
Nodes (73): departureResponse(), detachResponse(), Env, mediaSeatError(), hasValidInternalAuthorization(), drainUrl(), scheduled(), SchedulerEnv (+65 more)

### Community 21 - "watch-library.ts"
Cohesion: 0.05
Nodes (77): createRoom(), db(), getActiveRoomByClientRequestId(), getSupabaseServiceClient(), listRoomMembers(), resolveWatchHistoryAccess(), RoomMemberRow, RoomRow (+69 more)

### Community 22 - "core/types.ts"
Cohesion: 0.05
Nodes (47): duckVideoVolume(), usePlayerOverlayGeometry(), arePlayerOverlayGeometriesEqual(), DEFAULT_PLAYER_OVERLAY_GEOMETRY, normalizeBoundedValue(), normalizeDimension(), normalizeNonNegativeInteger(), normalizePlayerOverlayGeometry() (+39 more)

### Community 23 - "popup-watch-drawer.tsx"
Cohesion: 0.06
Nodes (65): PopupTab, PopupEpisodeProgress(), boolean(), forgetPopupView(), HistoryView, PopupView, position(), readPopupHistoryView() (+57 more)

### Community 24 - "watch-history.ts"
Cohesion: 0.03
Nodes (71): Dependencies, WatchHistoryCatalogAcknowledgement, WatchLibraryResponseSchema, AccountGenerationSchema, addAggregateIssues(), CatalogRequestBaseSchema, DisplayTitleSchema, DurableIdSchema (+63 more)

### Community 25 - "Social Client"
Cohesion: 0.09
...
### Community 26 - "Room Durable Object"
Cohesion: 0.10
Nodes (5): encode(), handleRoomWebSocketMessageBoundary(), RoomDurableObject, roomEndedEvent(), sendAndCloseEndedRoomSockets()

### Community 27 - "canonicalizeRoomSourceUrl"
Cohesion: 0.05
Nodes (49): invalidCreateRoomSourceError(), normalizeCreateRoomInput(), CanonicalSourceNavigationResult, DefinitionLookup, ensureGenericSource(), navigationRejection(), resolveCanonicalSourceNavigation(), withRoomHash() (+41 more)

### Community 28 - "Page Module"
Cohesion: 0.06
...
### Community 29 - "p2p-media.ts"
Cohesion: 0.04
Nodes (63): createLocalAudioLevelMeter(), LocalAudioLevelMeter, addOptionalNumbers(), applyP2PCodecPreferences(), configureSender(), copyDefinedStat(), countMatches(), createP2PMediaSignalDedupeKey() (+55 more)

### Community 30 - "db.ts"
Cohesion: 0.06
Nodes (59): POST(), ACTIVE_ROOM_CONFLICT_MESSAGE, ActiveRoomAssignment, ActiveRoomClaimDatabaseResult, activeRoomConflictResponseInput(), ActiveRoomCreateDatabaseResult, ActiveRoomReleaseDatabaseResult, ActiveRoomSessionDatabaseError (+51 more)

### Community 31 - "watch-history-controller.ts"
Cohesion: 0.06
Nodes (53): HISTORY_OBSERVATION_SUSPENDED, HistoryObservation, HistoryObservationResult, HistoryPolicyInput, isValidHistoryMedia(), normalizeHistoryUrl(), ProviderPlaybackMetadata, SourceAdapterHistoryPolicy (+45 more)

### Community 32 - "next/server"
Cohesion: 0.08
Nodes (48): dynamic, POST(), dynamic, POST(), dynamic, POST(), dynamic, POST() (+40 more)

### Community 33 - "anidachi-auth/watch-history-browse.ts"
Cohesion: 0.04
Nodes (58): dynamic, GET, dynamic, GET, dynamic, GET, dynamic, GET (+50 more)

### Community 34 - "video/prepare/route.ts"
Cohesion: 0.10
Nodes (58): AccountResult, blobUrlToProxyUrl(), POST(), prepareTikTokImages(), publishToIgAccount(), AccountResult, blobUrlToProxyUrl(), maxDuration (+50 more)

### Community 35 - "watch_history_v3_disposable_target.mjs"
Cohesion: 0.05
...
### Community 37 - "P2PMediaController"
Cohesion: 0.10
Nodes (9): logDebug(), createP2PRtcConfiguration(), getCandidateProtocol(), getCandidateType(), mediaElementUsesTrack(), P2PMediaController, summarizeP2PSdp(), summarizeSignal() (+1 more)

### Community 38 - "watch-history-v3.ts"
Cohesion: 0.09
Nodes (60): buildHostAuthoritativeWatchHistoryRoomSource(), buildWatchHistoryTitleEpisodesV3Response(), buildWatchHistoryV3Response(), EvidenceCase, GENERATED_AT, compareEpisodeRows(), compareObservationDescending(), databaseRowKey() (+52 more)

### Community 39 - "content.tsx"
Cohesion: 0.06
...
### Community 40 - "room-media-defaults.ts"
Cohesion: 0.06
Nodes (35): CAMERA_OPTIONS, MICROPHONE_OPTIONS, resolveOptionIndex(), RoomDefaultControl(), RoomDefaultsSettingsPanel(), RoomDefaultsSettingsPanelProps, CAMERA_ENABLED_PREFERENCE_VERSION, CameraEnabledPreferenceRecord (+27 more)

### Community 41 - "Progress Module"
Cohesion: 0.07
...
### Community 42 - "[roomId]/connect/route.ts"
Cohesion: 0.10
Nodes (49): dynamic, maxDuration, POST(), dynamic, POST(), wantsJson(), dynamic, GET() (+41 more)

### Community 43 - "p2p-media-harness.mjs"
Cohesion: 0.07
...
### Community 44 - "crunchyroll.content.ts"
Cohesion: 0.07
Nodes (58): BitmovinLikePlayer, BitmovinNamespace, BitmovinPlayerConstructor, BitmovinPlayerMethod, clampMediaTime(), clickElement(), CrunchyrollKatamariPlayer, delay() (+50 more)

### Community 45 - "room-departure-retry.ts"
Cohesion: 0.06
...
### Community 46 - "private-integration-blob.ts"
Cohesion: 0.06
Nodes (48): dynamic, POST(), compat, __dirname, eslintConfig, __filename, clearGoogleAdsTokens(), GoogleAdsStoredTokens (+40 more)

### Community 47 - "privileged-overlay-intent.ts"
Cohesion: 0.08
Nodes (48): dispatchPrivilegedRoomRuntimeMessage(), isAuthMessage(), activeRoomAuthorityClaimExecutionsByTab, assertIntentResponse(), authorityStorageKey(), authorityStorageMutationQueuesByTab, clearPrivilegedOverlayContextForTab(), clearRoomAuthorityClaimIfOwned() (+40 more)

### Community 48 - "verifyKreatliCrmSession"
Cohesion: 0.07
Nodes (46): dynamic, failRedirect(), GET(), dynamic, GET(), POST(), BlouLoginPage(), LoginForm() (+38 more)

### Community 49 - "voice-audio-preferences.ts"
Cohesion: 0.06
Nodes (37): MicrophoneIntent, shouldPublishMicrophone(), VoiceMode, isWithinOverlayHotkeyBoundary(), OVERLAY_HOTKEY_BOUNDARY_ATTRIBUTE, overlayHotkeyBoundaryProps, OverlayInteractionBoundaryProps, getNextVoiceMode() (+29 more)

### Community 50 - "chrome-extension-demo-async-overlay.tsx"
Cohesion: 0.05
...
### Community 51 - "account-inbox-cache.ts"
Cohesion: 0.07
Nodes (41): ACCOUNT_INBOX_CACHE_VERSION, accountInboxCacheKeyForUser(), accountInboxItemInstanceKey(), CachedAccountInbox, clearCachedAccountInboxForUser(), getCachedAccountInboxForUser(), inboxStructure(), isCanonicalUtcTimestamp() (+33 more)

### Community 52 - "crm-client.tsx"
Cohesion: 0.07
Nodes (49): addContactAction(), CrmActionState, deleteContactAction(), exportCsvDataAction(), exportSurveyLeadsCsvAction(), guard(), ImportPreviewResult, logTouchAction() (+41 more)

### Community 53 - "send-connection-requests.mjs"
Cohesion: 0.07
Nodes (53): esbuild, playwright, node:process, node:readline/promises, dependencies, playwright, name, private (+45 more)

### Community 54 - "createWatchHistoryClient"
Cohesion: 0.13
Nodes (55): canCaptureWatchHistory(), canReadWatchHistory(), personalEnvelopeEligible(), bestEffortFlushWatchHistoryBeforeSignOut(), browseHardRevision(), browseReadRevision(), browseResponseMatchesQuery(), browseResponseMeta() (+47 more)

### Community 55 - "youtube/adapter.ts"
Cohesion: 0.06
Nodes (21): AdapterOverlayBinding, AdapterPlaybackSnapshot, clampVolumePercent(), YouTubeVideoAdapter, YouTubeVolumePlayer, youtubeDefinition, AD_CONTAINER_SELECTOR, finiteNonNegative() (+13 more)

### Community 56 - "Free hosted 35 to 60 to 35 rehearsal commands"
Cohesion: 0.06
Nodes (51): Hosted recovery acceptance failed after row equality, Conditional managed-role policy reviewed with fresh hosted evidence pending, Original-binding immutable ACL artifact packages, PostgreSQL ACL normalization REVOKE and platform role references, Full public and migration-history aggregate digests, Application restore TOC with observed surplus-grant failure, Application cleanup restore and hold reinstall in one transaction, Original backup-bound transition input and independent hashes (+43 more)

### Community 57 - "reaction-shortcuts.ts"
Cohesion: 0.07
Nodes (24): ANIDACHI_EMOJI_CATALOG, DockScaleStyle, ReactionShortcutEditor(), ReactionShortcutEditorProps, assignReactionShortcut(), DEFAULT_REACTION_SHORTCUTS, getDefaultReactionShortcutPreferences(), isReactionEmoji() (+16 more)

### Community 58 - "Graphify Module"
Cohesion: 0.04
...
### Community 59 - "crunchyroll/adapter.ts"
Cohesion: 0.07
Nodes (22): controlsDebugSnapshot(), elementDebugSnapshot(), finiteOrNull(), inputDebugSnapshot(), readBuffered(), rectSnapshot(), videoDebugSnapshot(), startDebugProbe() (+14 more)

### Community 60 - "popup-watch-history.tsx"
Cohesion: 0.07
Nodes (36): HistoryConsent(), PopupHistorySettings(), PopupWatchCapacityNotice(), boundProjectedWatchHistoryItem(), compareCodeUnits(), compareWatchHistoryEpisodesNewest(), defaultPopupWatchHistoryClient, groupWatchHistoryItems() (+28 more)

### Community 61 - "billing.ts"
Cohesion: 0.06
Nodes (37): BillingClient(), formatDate(), dynamic, POST, dynamic, POST, dynamic, GET (+29 more)

### Community 62 - "Popup App"
Cohesion: 0.06
...
### Community 63 - "overlay-interface-settings.tsx"
Cohesion: 0.07
...
### Community 64 - "overlay-interface-settings.test.tsx"
Cohesion: 0.07
...
### Community 65 - "playback-sync-controller.ts"
Cohesion: 0.07
...
### Community 66 - "plan-entitlements.ts"
Cohesion: 0.10
Nodes (41): CheckoutTier, getOrCreateStripeCustomer(), loginUrlForRequest(), POST(), SuccessPage(), getBillingCustomerByUserId(), upsertBillingCustomer(), verifyAccessToken() (+33 more)

### Community 67 - "Node:Fs Module"
Cohesion: 0.08
...
### Community 69 - "account-inbox.ts"
Cohesion: 0.09
Nodes (37): dynamic, GET(), dynamic, POST(), AccountInboxApiError, AccountInboxCountRow, accountInboxCountsFromRow(), accountInboxDatabaseError() (+29 more)

### Community 70 - "node:assert/strict"
Cohesion: 0.06
Nodes (22): catalogContext, envelope(), progressEvent(), files, source, SOURCE_URL, user, isPublicMarketingPath() (+14 more)

### Community 71 - "Portfolio Audit"
Cohesion: 0.10
...
### Community 72 - "how-to-host-a-crunchyroll-watch-party/page.tsx"
Cohesion: 0.05
Nodes (35): DoesEveryoneNeedCrunchyrollPremiumPage(), faq, metadata, SITE_URL, tocHeadings, faq, HowToHostACrunchyrollWatchPartyPage(), howToSteps (+27 more)

### Community 73 - "room-departure.ts"
Cohesion: 0.09
Nodes (36): dispatchRoomDepartureRuntimeMessage(), handleRemovedRoomTab(), clearRoomAuthorityRequestForTab(), ConfirmedRoomDepartureOutcome, confirmedRuntimeDeparture(), confirmExplicitRoomDeparture(), ConfirmExplicitRoomDepartureDependencies, departActiveWebsiteRoomFromApi() (+28 more)

### Community 74 - "watch-library-client.test.tsx"
Cohesion: 0.08
Nodes (39): bindWatchHistoryPageRefresh(), clampProgress(), deleteConfirmation(), deleteScopeKey(), errorMessage(), formatProgressPercent(), getWatchHistoryAggregateLabel(), historyAuthorityState() (+31 more)

### Community 75 - "cli.ts"
Cohesion: 0.11
Nodes (38): applyImportAction(), previewImportAction(), runPreview(), buildImportPreview(), detectDelimiter(), guessEmailColumn(), mapHeaderToField(), mergeSegments() (+30 more)

### Community 76 - "blob-reconciliation.ts"
Cohesion: 0.08
Nodes (39): assertContact(), BlobHeadResult, BlobReadResult, CONTACT_STATUSES, contentTypeFor(), CrmMeta, digest(), isObject() (+31 more)

### Community 77 - "Account Runtime And Acceptance"
Cohesion: 0.05
...
### Community 78 - "Overlay Layout Editor"
Cohesion: 0.10
...
### Community 79 - "room-media.ts"
Cohesion: 0.06
Nodes (39): PlanEntitlements, AccountEntitlementsMetadata, AccountEntitlementsMetadataSchema, Epoch, getPlanPolicy(), isWatchHistoryAccessCurrent(), PlanCodeSchema, PlanPolicy (+31 more)

### Community 80 - "internal-web-client.ts"
Cohesion: 0.08
Nodes (33): boundedInternalWebCallbackTimeout(), fetchAndReadJsonWithBoundedTimeout(), INTERNAL_WEB_CALLBACK_TIMEOUT_MS, internalWebCallbackConfig(), InternalWebLifecycleEnv, isLoopbackHostname(), notifyWebParticipantDeparted(), notifyWebRoomEnded() (+25 more)

### Community 81 - "gmail.ts"
Cohesion: 0.11
Nodes (34): dynamic, errorToShortString(), failRedirect(), GET(), dynamic, GET(), POST(), createGmailOAuth2() (+26 more)

### Community 82 - "participant-disconnect.ts"
Cohesion: 0.13
...
### Community 83 - ".acquireMicrophoneTrack"
Cohesion: 0.12
Nodes (8): MicrophoneTerminalFailureReason, classifyMicrophoneTerminalFailure(), createVideoElement(), formatCameraErrorMessage(), formatMicrophoneErrorMessage(), microphoneErrorName(), p2pAudioTrackSwapNeedsNegotiation(), stopStream()

### Community 84 - "Popup People Panel.Test"
Cohesion: 0.08
...
### Community 86 - "Watch History Crunchyroll Catalog Progress"
Cohesion: 0.09
...
### Community 87 - "popup-watch-history.test.tsx"
Cohesion: 0.10
Nodes (32): subscribeToPopupWatchHistorySnapshot(), createListWatchHistoryMessage(), usesStoredWatchHistorySession(), click(), clientFixture(), findButton(), findInput(), fixtureBrowseDetail() (+24 more)

### Community 88 - "watch-library-routes.test.ts"
Cohesion: 0.10
Nodes (28): dynamic, POST, dynamic, GET, PATCH, dynamic, POST, dynamic (+20 more)

### Community 89 - "middleware.ts"
Cohesion: 0.11
Nodes (30): AUTH_REFRESH_PATH, isStaticOrInternalAssetPath(), shouldAutoRefreshWebsiteSession(), admissions, buildStagingAccessCookieValue(), canBearerBypassStagingGate(), canBypassStagingGate(), Env (+22 more)

### Community 90 - "p2p-media.test.ts"
Cohesion: 0.06
Nodes (18): classifyRemoteVideoActivity(), decideP2PIceRestart(), decideP2PSignalConnection(), getP2PAudioTransceiverDirection(), isPoliteP2PPeer(), planP2PVideoSenderSync(), reconcilePeerAction(), shouldInitiateP2POffers() (+10 more)

### Community 91 - "Pseo New Guides"
Cohesion: 0.08
Nodes (21): metadata, metadata, metadata, metadata, metadata, metadata, metadata, metadata (+13 more)

### Community 92 - "Production 35 To 60 Transition"
Cohesion: 0.06
Nodes (38): Schema 3 durable canonical episode authority, Local application ACL recovery green with hosted gate open, Production 35-to-60 preservation prerequisite, Executed synthetic hosted rehearsal with failed recovery acceptance, Non-superuser pg_net removal and managed log boundary, Ordinary postgres-only hosted execution policy, Statement-trigger runtime write holds and cron suspension, Source-controlled production DB Worker and Vercel delivery holds (+30 more)

### Community 93 - "node:fs"
Cohesion: 0.10
Nodes (27): providerDirectories, sharedOverlayRuntimeFiles, sourceAdaptersDirectory, sourceDirectory, alt, contentType, runtime, size (+19 more)

### Community 94 - "oauth-routes.test.ts"
Cohesion: 0.11
Nodes (27): dynamic, GET(), dynamic, GET(), dynamic, GET(), dynamic, GET() (+19 more)

### Community 95 - "survey-lead.ts"
Cohesion: 0.15
Nodes (30): GET(), HomeSurveyAnswers, AccountWaitlistStatus, buildResult(), buildSurveyNote(), buildSurveySegments(), creditReferrer(), getAccountWaitlistStatus() (+22 more)

### Community 96 - "Account Data Watch History Social"
Cohesion: 0.08
...
### Community 99 - "store.ts"
Cohesion: 0.15
Nodes (29): Body, dynamic, POST(), GET(), appendTouch(), assertLocalCrmRuntime(), blobReadText(), blobUpdateText() (+21 more)

### Community 100 - "Room Flow And P2 P"
Cohesion: 0.09
...
### Community 101 - "Participant"
Cohesion: 0.13
Nodes (27): GhostCamOptions, GhostCamSession, IncomingP2PSignalSender, p2pSignalMatchesActiveGeneration(), replayPendingP2PSignals(), syncRemoteVoiceParticipant(), GhostVideo, IncomingP2PSignal (+19 more)

### Community 102 - "watch-history-storage.ts"
Cohesion: 0.10
Nodes (30): activeGenerationsFromPartitions(), createWatchHistoryStorage(), clearRebuildableAccountData(), discardAllOtherOwnerOutboxes(), discardOtherOwnerOutbox(), ensureMigration(), otherOwnerPendingSummary(), readRoot() (+22 more)

### Community 103 - "Task 1 Shared Session And"
Cohesion: 0.06
...
### Community 104 - "Overlay Layout Model"
Cohesion: 0.10
...
### Community 105 - "tiktok/storage.ts"
Cohesion: 0.14
Nodes (29): clearCookies(), dynamic, GET(), getOrigin(), POST(), publishToTtAccount(), publishToTtAccount(), processTikTokAccount() (+21 more)

### Community 106 - "debug-log.ts"
Cohesion: 0.11
Nodes (28): ANIDACHI_BUILD_ID, API_HTTP_BASE, API_WS_BASE, VOICE_KEYWORD_EMOJI, WXT_VAPID_PUBLIC_KEY, cleanClassName(), clearDebugLog(), compactDebugData() (+20 more)

### Community 107 - "diagnostic-log.ts"
Cohesion: 0.10
Nodes (29): clearDiagnosticEntries(), clearDiagnosticsFromPage(), compactDiagnosticPageData(), compactPageDebug(), compactPageDebugEntry(), createClearDiagnosticsMessage(), createDiagnosticsFilename(), createJsonDataUrl() (+21 more)

### Community 108 - "Overlay Layout Engine"
Cohesion: 0.14
...
Cohesion: 0.11
Nodes (14): SourceAdapterDefinition, findBestVideo(), findPlayerContainer(), findVideosDeep(), isUsableVideo(), scoreVideo(), crunchyrollDefinition, findCrunchyrollPlayerContainer() (+6 more)

### Community 110 - "public-media-blob.test.ts"
Cohesion: 0.09
...
### Community 111 - "Dependencies Module"
Cohesion: 0.06
...
### Community 112 - "watch-history-client.ts"
Cohesion: 0.08
Nodes (30): parseWatchHistoryLease(), BrowseCommand, BrowseInput, browsePath(), cancelWatchHistoryCatalogForTab(), defaultStoredWatchHistorySession(), emptyPartition(), handleWatchHistoryHttpMessage() (+22 more)

### Community 113 - "youtube/storage.ts"
Cohesion: 0.14
Nodes (26): GET(), dynamic, GET(), safeRefreshTiktok(), ensureAllCredentials(), ensureAuthClient(), getCredentialsForChannel(), isInvalidGrant() (+18 more)

### Community 114 - "feature-requests.ts"
Cohesion: 0.12
...
Cohesion: 0.13
Nodes (24): sanitizeOAuthExtensionReturnTo(), HandleOAuthCallbackDependencies, HandleOAuthCallbackOptions, OAuthProfile, redirectAndClearTransaction(), callbackRequest(), fixedStart(), consumeOAuthLoginTransaction() (+16 more)

### Community 117 - "p2p-ice.ts"
Cohesion: 0.14
...
### Community 118 - "Inventory Module"
Cohesion: 0.06
...
### Community 120 - "room-source-persistence.ts"
Cohesion: 0.15
Nodes (27): nextParticipantDisconnectAlarmAt(), ROOM_LIFECYCLE_STORAGE_KEY, RoomLifecycleState, acknowledgeStoredRoomSourceAttempt(), claimStoredRoomSourceAttempt(), enqueueStoredRoomSource(), ensureStoredRoomSourcePending(), hasExactKeys() (+19 more)
...
### Community 122 - "Production Room Realtime And P2"
Cohesion: 0.10
...
### Community 123 - "bridge-client.ts"
Cohesion: 0.13
Nodes (24): isControlRequest(), checkHistoryAbort(), cmsPath(), collectCrunchyrollHistoryCatalog(), HistoryJsonLoader, historyRows(), resolveCrunchyrollHistoryMetadata(), safeGuid() (+16 more)

### Community 124 - "extension/test/watch-history-browse.test.ts"
Cohesion: 0.10
...
### Community 125 - "contact-messages.ts"
Cohesion: 0.13
Nodes (22): POST(), CATEGORY_LABELS, ContactForm(), CONTACT_CATEGORIES, CONTACT_MESSAGE_SEGMENT, ContactCategory, ContactMessageRecord, isContactCategory() (+14 more)

### Community 126 - "room-source.ts"
Cohesion: 0.13
Nodes (23): dynamic, POST(), persistRoomSource(), assignCleanString(), handleRoomCreateRequestBody(), invalidRequest(), parseRoomCreateRequestBody(), RoomCreateFailure (+15 more)

### Community 127 - "Portfolio Audit"
Cohesion: 0.11
Nodes (25): guideLinks, INTERNAL_TOOL_APP_SEGMENTS, INTERNAL_TOOL_ROBOTS_DISALLOW, isInternalToolPath(), APP_DIR, discoverStaticSitemapUrlPaths(), EXCLUDED_TOP_LEVEL, EXCLUDED_URL_PATHS (+17 more)

### Community 128 - "migrate-private-integration-blobs.ts"
Cohesion: 0.12
Nodes (23): readResult(), stream(), streamingReadResult(), assertReadableResult(), authFromEnvironment(), BlobAuth, BlobHeadResult, BlobListRow (+15 more)

### Community 129 - "Rules Module"
Cohesion: 0.07
...
### Community 130 - "Anidachi Auth Integration Implementation Plan"
Cohesion: 0.07
...
### Community 132 - "catalog.ts"
Cohesion: 0.15
Nodes (26): array(), Availability, boundedString(), classifyAvailability(), compareOrder(), compatibleSeason(), CrunchyrollCatalogInput, CrunchyrollCatalogPartialReason (+18 more)

### Community 133 - "Privileged Overlay Wiring.Test"
Cohesion: 0.11
...
### Community 134 - "[token]/page.tsx"
Cohesion: 0.10
Nodes (18): FriendInviteClient(), initials(), Props, PublicProfile, readJson(), dynamic, FriendInvitePage(), metadata (+10 more)

### Community 135 - "Page Module"
Cohesion: 0.07
...
### Community 136 - "Watch History V3 Local Verification"
Cohesion: 0.12
...
### Community 137 - "Watch History Catalog And Progress"
Cohesion: 0.12
...
### Community 141 - "Main Repository Monorepo Migration Implementation"
Cohesion: 0.07
...
### Community 142 - "Ani Dachi Pre Release Security"
Cohesion: 0.13
...
### Community 144 - "voice-activity.ts"
Cohesion: 0.12
Nodes (14): audioActivityStatsChanged(), classifyPeerHealth(), getAudioTrackFromElement(), summarizeIceServers(), summarizeStats(), AUDIO_QUIET_SAMPLES_BEFORE_CLEAR, AUDIO_SPEECH_LEVEL_THRESHOLD, AudioActivityStats (+6 more)

### Community 145 - "popup-watch-browse.test.tsx"
Cohesion: 0.12
Nodes (24): usePopupWatchBrowse(), PopupWatchHistoryPanel(), aggregate, browse(), button(), change(), click(), clientFixture() (+16 more)

### Community 146 - "Watch History Room Authority Threat"
Cohesion: 0.08
...
### Community 148 - "harness-entry.ts"
Cohesion: 0.11
...
### Community 149 - "profile/page.tsx"
Cohesion: 0.11
Nodes (17): dynamic, metadata, ProfileClient(), change(), dom, initial, input(), render() (+9 more)

### Community 150 - "jsonUnauthorizedUnlessKreatliSession"
Cohesion: 0.13
Nodes (17): dynamic, GET(), OPTIONAL, dynamic, GET(), INSTAGRAM_SCOPES, GET(), dynamic (+9 more)

### Community 151 - "Anidachi Seo Aeo Pages"
Cohesion: 0.08
...
### Community 152 - "Personal History Mvp Staging Delivery"
Cohesion: 0.12
...
### Community 153 - "Commercial Room, P2 P, And"
Cohesion: 0.08
...
### Community 154 - "Source Adapter Architecture Implementation Plan"
Cohesion: 0.08
...
### Community 155 - "Canonical Runtime Flow"
Cohesion: 0.10
...
### Community 156 - "Use Camera Interaction Lock"
Cohesion: 0.13
...
### Community 159 - "instagram/storage.ts"
Cohesion: 0.17
Nodes (20): clearStateCookie(), dynamic, GET(), getOrigin(), ShortLivedTokenResponse, POST(), ensureCredentials(), getStoredCredentials() (+12 more)

### Community 160 - "extension-codes.ts"
Cohesion: 0.18
Nodes (18): dynamic, POST(), ExtensionConnectPage(), dynamic, GET(), consumeExtensionAuthCode(), ConsumeExtensionAuthCodeInput, createExtensionAuthCode() (+10 more)

### Community 161 - "group-editor-route.ts"
Cohesion: 0.14
Nodes (16): FriendsWorkspace(), action(), closeModal(), dismissModal(), editGroup(), generateLink(), openModal(), saveGroup() (+8 more)

### Community 162 - "Scripts Module"
Cohesion: 0.08
Nodes (23): name, private, scripts, blob:migrate:private, build, cache:jikan, check, crm (+15 more)

### Community 163 - "Anidachi Architecture And Stack Notes"
Cohesion: 0.08
...
### Community 164 - "Deferred Together Group History Specification"
Cohesion: 0.12
...
### Community 165 - "Ani Dachi Repository Overview"
Cohesion: 0.09
...
### Community 166 - "Overlay Layout Runtime"
Cohesion: 0.23
...
### Community 167 - "Account Subscription Cancellation"
Cohesion: 0.11
...
### Community 168 - "Invitation Delivery Reliability Implementation Plan"
Cohesion: 0.09
...
### Community 169 - "Overlay Layout Engine V2 Design"
Cohesion: 0.09
...
### Community 170 - "Deferred Together: Together Mvp Revision"
Cohesion: 0.13
...
### Community 173 - "Room Socket Attachment"
Cohesion: 0.13
...
### Community 177 - "Kreatli Crm Data Schema"
Cohesion: 0.13
...
### Community 178 - "Auth Artifact Cleanup.Test"
Cohesion: 0.10
...
### Community 179 - "Watch History V3 Staging Verification"
Cohesion: 0.14
...
### Community 180 - "Watch History V2 Clean Mvp"
Cohesion: 0.09
...
### Community 181 - "Personal History And Plans Mvp"
Cohesion: 0.12
...
### Community 184 - "node:crypto"
Cohesion: 0.16
Nodes (16): ExtensionConnectMobileConfirm(), dynamic, metadata, Props, createExtensionAuthLoginRedirect(), EXTENSION_AUTH_HANDOFF_TTL_SECONDS, extensionAuthHandoffKey(), extensionAuthLoginRedirectForEnvelope() (+8 more)

### Community 185 - "Public Module"
Cohesion: 0.10
...
### Community 186 - "Development Flow Quality System Plan"
Cohesion: 0.10
...
### Community 187 - "Friends And Groups Link First"
Cohesion: 0.17
...
### Community 188 - "Linked In Sales Navigator Connection"
Cohesion: 0.10
...
### Community 189 - "RecentP2PSignalBuffer"
Cohesion: 0.17
...
### Community 190 - "Ani Dachi Extension Icon 48Px"
Cohesion: 0.13
...
### Community 194 - "Shared Watch Progress Tracker"
Cohesion: 0.15
...
### Community 195 - "Development Workflow Hardening Implementation Plan"
Cohesion: 0.10
...
### Community 196 - "Plan Code Canonicalization And Billing"
Cohesion: 0.10
...
### Community 197 - "Account Data History Social And"
Cohesion: 0.21
...
### Community 198 - "protocol/src/auth.ts"
Cohesion: 0.13
...
### Community 199 - "Shared Protocol Types"
Cohesion: 0.19
Nodes (17): VerifiedRoomToken, attachmentToVerifiedRoomToken(), createRoomSocketAttachment(), isNonNegativeInteger(), isRecord(), parseAdmission(), parseRoomSocketAttachment(), parseVerifiedIdentity() (+9 more)

### Community 200 - "hotkeys.ts"
Cohesion: 0.20
Nodes (16): getEmojiHotkey(), getHotkeyAction(), hasBlockedModifier(), HotkeyAction, HotkeyEventLike, HotkeyState, isEditableElement(), isEditableEventTarget() (+8 more)

### Community 201 - "RoomClient"
Cohesion: 0.21
Nodes (5): createRoomConnectionId(), isOlderHistoryBoundary(), RoomClient, sameHistoryBoundary(), RoomHistoryAuthority

### Community 202 - "src/watch-history-access.ts"
Cohesion: 0.15
Nodes (14): createWatchHistoryLease(), historyServerTime(), bindWatchHistoryPreferenceListener(), isRecord(), LocalPreferenceAuthority, preferenceSignature(), StorageChange, StorageChangedEventLike (+6 more)

### Community 203 - "Dev Dependencies"
Cohesion: 0.11
...
### Community 204 - "You Tube Playback Synchronization Hardening"
Cohesion: 0.11
...
### Community 205 - "Watch Drawer Browse Local Verification"
Cohesion: 0.12
...
### Community 208 - "Release Channel Build.Test"
Cohesion: 0.12
...
### Community 212 - "Survey → Subscription Conversion (Planner"
Cohesion: 0.11
...
### Community 213 - "Crunchyroll Adapter Notes"
Cohesion: 0.14
...
### Community 214 - "Maintenance Admission"
Cohesion: 0.12
...
### Community 215 - "Maintenance Admission"
Cohesion: 0.12
Nodes (18): Manual Free-plan hosted rehearsal path, Hosted proof closes only tested DB operator recovery questions, Temporary Free-project rehearsal window, Authorized zero-cost rehearsal window closed, Two active Free-project limit and zero-cost creation boundary, Normal test-room drain before publication shutdown, Pause exact staging project and recheck production health, Supabase capacity pause and Cloudflare publication references (+10 more)

### Community 216 - "Anidachi Development Environments"
Cohesion: 0.11
...
### Community 217 - "Ani Dachi New Chat Project"
Cohesion: 0.11
...
### Community 218 - "Open Claw: You Tube Shorts"
Cohesion: 0.11
...
### Community 219 - "Compiler Options"
Cohesion: 0.11
...
### Community 223 - "Chrome Web Store Listing —"
Cohesion: 0.12
...
### Community 225 - "Watch History Local Read Implementation"
Cohesion: 0.17
...
### Community 233 - "watch-history-catalog.test.ts"
Cohesion: 0.17
Nodes (11): contextKey(), createWatchHistoryCatalogCoordinator(), begin(), commit(), createWatchHistoryPageResolver(), abortCatalogs(), eligible(), resolve() (+3 more)

### Community 235 - "Dev Dependencies"
Cohesion: 0.12
Nodes (15): @biomejs/biome, devDependencies, @biomejs/biome, turbo, typescript, vitest, engines, node (+7 more)

### Community 236 - "Invitation Delivery Reliability Implementation Plan"
Cohesion: 0.17
...
### Community 237 - "Social Rooms Subscriptions Execution Plan"
Cohesion: 0.17
...
### Community 238 - "Package Module"
Cohesion: 0.13
Nodes (15): @anidachi/protocol, dependencies, @anidachi/protocol, lucide-react, motion, react, react-dom, zustand (+7 more)

### Community 239 - "Package Module"
Cohesion: 0.13
Nodes (15): devDependencies, @cloudflare/vitest-pool-workers, typescript, vitest, wrangler, vitest, typescript, typescript (+7 more)

### Community 240 - "room-metering.ts"
Cohesion: 0.29
Nodes (12): acknowledgeRoomUsageDay(), createRoomMeterState(), MAX_PENDING_USAGE_DAYS, parseRoomMeterState(), reconcileLegacyRoomMeter(), reconcileRoomMeter(), RoomMeterState, roomUsageBuckets() (+4 more)

### Community 241 - "watch-history-authority.ts"
Cohesion: 0.19
Nodes (11): serverJwtSecret(), OTHER_SECRET, SECRET, token(), verify(), visibleAuthority, ValidatedWatchHistoryAuthority, verifyWatchHistoryAuthority() (+3 more)

### Community 242 - "Watch History Capacity Concurrency Contract"
Cohesion: 0.20
Nodes (14): args, contend(), event(), labels, literal(), live, marker, ports (+6 more)

### Community 243 - "20260814010000 Watch History V2 Foundation"
Cohesion: 0.25
...
### Community 246 - "Personal History And Plans Mvp"
Cohesion: 0.13
...
### Community 248 - "Voice Controls And Participant Audio"
Cohesion: 0.13
...
### Community 249 - "Interface Visibility Settings Design"
Cohesion: 0.13
...
### Community 250 - "Personal History Mvp Design"
Cohesion: 0.14
...
### Community 251 - "Wxt.Config Module"
Cohesion: 0.14
...
### Community 252 - "best-anime-to-watch-with-friends/page.tsx"
Cohesion: 0.16
Nodes (9): faq, headings, itemList, metadata, faq, metadata, tocHeadings, DataTableColumn (+1 more)

### Community 253 - "Ani Dachi Seo Content Guidelines"
Cohesion: 0.14
...
### Community 257 - "Handoff For Ai Working On"
Cohesion: 0.14
...
### Community 260 - "Two Phase Production Promotion"
Cohesion: 0.16
...
### Community 261 - "Waitlist And Crm Durable Storage"
Cohesion: 0.23
...
### Community 262 - "Package Module"
Cohesion: 0.14
Nodes (13): dependencies, zod, exports, name, private, scripts, build, check (+5 more)

### Community 263 - "Ani Dachi Contributor Startup Contract"
Cohesion: 0.19
...
### Community 266 - "Middleware Module"
Cohesion: 0.15
...
### Community 267 - "Room Invite Notifications"
Cohesion: 0.17
...
### Community 268 - "Scratchpad Module"
Cohesion: 0.17
...
### Community 269 - "Project Architecture And Development"
Cohesion: 0.31
...
### Community 270 - "Codex Hosted Semantic Extraction"
Cohesion: 0.17
...
### Community 271 - "Personal History Mvp Staging Delivery"
Cohesion: 0.23
...
### Community 272 - "September 12 Prelaunch Remediation Verification"
Cohesion: 0.27
...
### Community 273 - "One Canonical Personal Episode Progress"
Cohesion: 0.24
...
### Community 275 - "V1 Product Decisions (Historical)"
Cohesion: 0.17
...
### Community 276 - "Shared Pure Visibility Policy"
Cohesion: 0.21
...
### Community 279 - "Overlay Layout Engine.Test"
Cohesion: 0.23
...
### Community 280 - "overlay-media-session.ts"
Cohesion: 0.24
...
### Community 281 - "MemoryStorageArea"
Cohesion: 0.17
Nodes (4): BackgroundDependencies, DelayedRemoveStorageArea, MemoryStorageArea, StorageAreaLike

### Community 282 - "how-to-watch-crunchyroll-with-friends-without-account-sharing/page.tsx"
Cohesion: 0.17
Nodes (10): faq, metadata, SITE_URL, tocHeadings, WatchCrunchyrollWithoutAccountSharingPage(), faq, GroupWatchOnboardingPage(), metadata (+2 more)

### Community 283 - "Watch History V3 Sql.Test"
Cohesion: 0.20
...
### Community 286 - "Watch History V3.Test"
Cohesion: 0.17
...
### Community 287 - "Project Knowledge Map"
Cohesion: 0.17
...
### Community 288 - "Account Library And Manual Progress"
Cohesion: 0.27
...
### Community 289 - "Popup People And Social Directory"
Cohesion: 0.17
...
### Community 291 - "Smoke Staging Web"
Cohesion: 0.29
...
### Community 293 - "privacy-sanitizer.ts"
Cohesion: 0.20
Nodes (10): HASH_IDENTIFIER_ARRAY_FIELDS, HASH_IDENTIFIER_FIELDS, isHostOrSubdomain(), MEDIA_IDENTIFIER_FIELDS, RAW_FRAME_FIELDS, RAW_MEDIA_FIELDS, redactPrivacySafeMediaSourceUrl(), redactProviderContentPath() (+2 more)

### Community 294 - "room-quota-display.ts"
Cohesion: 0.31
...
### Community 295 - "MAX_PARTICIPANT_ID_CHARS"
Cohesion: 0.25
...
### Community 296 - "account-menu-client.test.ts"
Cohesion: 0.24
Nodes (7): AccountEntryLink(), UserMenu(), dom, mount(), open(), trigger(), user

### Community 297 - "Download On The App Store"
Cohesion: 0.31
...
### Community 298 - "20260816090000 Watch History V2 Bounded"
Cohesion: 0.18
...
### Community 300 - "Resources Progress Menu Implementation Plan"
Cohesion: 0.18
...
### Community 302 - "Watch History Capacity"
Cohesion: 0.20
...
### Community 305 - "sanitizePrivacySafeText"
Cohesion: 0.27
Nodes (10): appendDiagnosticEntry(), isDiagnosticEntry(), normalizePageDebugEntry(), pruneDiagnosticEntries(), readDiagnosticEntries(), sanitizeDiagnosticData(), sanitizeDiagnosticEntry(), looksLikeRawMediaPayload() (+2 more)

### Community 306 - "Include Module"
Cohesion: 0.20
Nodes (9): compilerOptions, jsx, extends, include, src, test, entrypoints, wxt.config.ts (+1 more)

### Community 307 - "Seo Trust & Authority Plan"
Cohesion: 0.20
...
### Community 308 - "account-navigation-client.test.ts"
Cohesion: 0.27
Nodes (8): dialog(), dom, mount(), navigations, open(), render(), router, trigger()

### Community 309 - "Ani Dachi Logo Asset"
Cohesion: 0.33
...
### Community 310 - "Personal Mvp Activation Contract"
Cohesion: 0.24
Nodes (9): activation, args, delay(), policy(), readme, session(), sql(), target (+1 more)

### Community 311 - "20260819133849 Auth Channel Rotation"
Cohesion: 0.38
...
### Community 314 - "Mvp Plan Pricing"
Cohesion: 0.20
...
### Community 316 - "Completed Public Product Recovery Record"
Cohesion: 0.20
...
### Community 317 - "Watch Drawer Browse Implementation Plan"
Cohesion: 0.20
...
### Community 319 - "Panel Account Title"
Cohesion: 0.39
...
### Community 320 - "Overlay Layout Ghost Preview"
Cohesion: 0.33
...
### Community 321 - "Conversion Metrics (Ga4)"
Cohesion: 0.22
...
### Community 322 - "Host Avatar Asset"
Cohesion: 0.28
...
### Community 324 - "20260907194413 Personal History Access"
Cohesion: 0.25
...
### Community 328 - "Participant Session Identity"
Cohesion: 0.28
...
### Community 329 - "Social Rooms, Friends, Groups, And"
Cohesion: 0.22
...
### Community 331 - "Real Web Rtc Two Browser"
Cohesion: 0.25
...
### Community 339 - "Natsuki Avatar Asset"
Cohesion: 0.43
...
### Community 346 - "Global Constraints"
Cohesion: 0.25
...
### Community 347 - "Global Constraints"
Cohesion: 0.25
...
### Community 348 - "Approved Voice Ux Simplification V2"
Cohesion: 0.25
...
### Community 349 - "Production Acceptance Snapshot: 685 Survey"
Cohesion: 0.29
...
### Community 350 - "You Tube Adapter Notes"
Cohesion: 0.25
...
### Community 351 - "Tsconfig Module"
Cohesion: 0.29
Nodes (7): lib, lib, dom, dom, dom iterable, ES2022, esnext

### Community 352 - "findKatamariPlayerFromReactNode"
Cohesion: 0.48
...
### Community 353 - "startCrunchyrollControlBridge"
Cohesion: 0.29
Nodes (7): installBitmovinNamespaceSetter(), main(), patchBitmovinNamespace(), patchBitmovinPrototype(), rememberBitmovinPlayer(), startBitmovinPlayerCapture(), startCrunchyrollControlBridge()

### Community 354 - "roomEventDebugSnapshot"
Cohesion: 0.33
Nodes (7): roomEventDebugSnapshot(), sanitizeRoutineDebugData(), stripRoutineContent(), readSafeStorageSnapshot(), sanitizeDiagnosticStorageKey(), hashPrivacySafeId(), sanitizePrivacySafeData()

### Community 355 - "Overlay App"
Cohesion: 0.48
...
### Community 356 - "Ani Dachi Apple Touch Icon"
Cohesion: 0.43
...
### Community 357 - "best-horror-anime-to-watch-with-friends/page.tsx"
Cohesion: 0.29
Nodes (5): faq, headings, itemList, metadata, SITE_URL

### Community 358 - "Ani Dachi Web Logo Asset"
Cohesion: 0.52
...
### Community 361 - "Anidachi Seo Aeo Pages"
Cohesion: 0.29
...
### Community 362 - "Project Status Board"
Cohesion: 0.29
...
### Community 363 - "Site, Extension, Auth, And Database"
Cohesion: 0.29
...
### Community 364 - "Watch History Capacity"
Cohesion: 0.29
...
### Community 365 - "Voice Ux Simplification V2"
Cohesion: 0.29
...
### Community 366 - "Participant Audio Controls"
Cohesion: 0.29
...
### Community 367 - "Shared Pure Visibility Policy"
Cohesion: 0.33
...
### Community 368 - "Watch History Catalog And Progress"
Cohesion: 0.29
...
### Community 369 - "Account Data Watch History Social"
Cohesion: 0.29
...
### Community 381 - "Anidachi Private"
Cohesion: 0.40
...
### Community 382 - "20260908071729 Room Media Negotiation Fence"
Cohesion: 0.40
...
### Community 383 - "Personal History Access.Test"
Cohesion: 0.33
Nodes (3): access_results, saved_order, saved_progress

### Community 387 - "Watch History V3 Episode Previews.Test"
Cohesion: 0.40
Nodes (3): bounded_preview, pg_temp.preview_tail(), preview_pages

### Community 389 - "Graphify Reference: Query, Path, Explain"
Cohesion: 0.33
Nodes (5): For /graphify explain, For /graphify path, graphify reference: query, path, explain, Step 0 — Constrained query expansion (REQUIRED before traversal), Step 1 — Traversal

### Community 390 - "High Level Task Breakdown (Historical)"
Cohesion: 0.33
...
### Community 391 - "Sitewide Cta → Plan Picker"
Cohesion: 0.33
...
### Community 392 - "Account Subscription Cancellation"
Cohesion: 0.33
...
### Community 393 - "Global Constraints"
Cohesion: 0.47
...
### Community 394 - "Billing And Entitlements"
Cohesion: 0.33
...
### Community 397 - "Always Visible Compact Participant Pills"
Cohesion: 0.33
...
### Community 398 - "Final Staging Runtime Acceptance"
Cohesion: 0.33
...
### Community 399 - "Exact Assignment Release"
Cohesion: 0.33
...
### Community 400 - "Account Data History Social And"
Cohesion: 0.53
...
### Community 401 - "Accepted Catalog Read"
Cohesion: 0.33
...
### Community 418 - "Vercel Module"
Cohesion: 0.40
Nodes (4): ignoreCommand, regions, $schema, sfo1

### Community 419 - "Anidachi Seo Aeo Pages"
Cohesion: 0.40
...
### Community 420 - "Anidachi Seo Aeo Pages"
Cohesion: 0.40
...
### Community 421 - "Service Level Objectives"
Cohesion: 0.40
...
### Community 426 - "Protocol Agent Instructions"
Cohesion: 0.40
Nodes (4): packages/protocol Agent Instructions, Rules, Source Of Truth, Verification

### Community 427 - "Production History 35 To 60"
Cohesion: 0.67
...
### Community 430 - "20260602 Extension Auth"
Cohesion: 0.67
...
### Community 435 - "20260908070552 Room Media Compatibility Fence"
Cohesion: 0.67
...
### Community 448 - "Current Operational Source Of Truth"
Cohesion: 0.50
...
### Community 449 - "Account Mvp Workspace"
Cohesion: 0.50
...
### Community 450 - "Account Data Watch History Social"
Cohesion: 0.50
...
### Community 451 - "Account Data Watch History Social"
Cohesion: 0.50
...
### Community 452 - "Five Object Crm Reconciliation"
Cohesion: 0.50
...
### Community 453 - "Launch Chrome"
Cohesion: 0.83
Nodes (3): port_in_use(), print_port_conflict_help(), launch-chrome.sh script

### Community 454 - "Production History 35 To 60"
Cohesion: 1.00
...
## Knowledge Gaps
- **3626 isolated node(s):** `DataTableColumn`, `CtaCopyKey`, `SeoGuideOption`, `SeoGuideRelatedLink`, `SeoGuideStep` (+3621 more)
...
- **Why does `react` connect `react` to `next/link`, `getGuideLinks`, `overlay-app.tsx`, `Privileged Overlay Wiring.Test`, `[token]/page.tsx`, `invites-client.tsx`, `Reaction Pop`, `VideoAdapter`, `popup-watch-browse.test.tsx`, `harness-entry.ts`, `profile/page.tsx`, `Voice Audio Preferences`, `popup-watch-drawer.tsx`, `core/types.ts`, `Use Camera Interaction Lock`, `Page Module`, `room-media-defaults.ts`, `account-menu-client.test.ts`, `app/login/page.tsx`, `voice-audio-preferences.ts`, `chrome-extension-demo-async-overlay.tsx`, `account-inbox-cache.ts`, `crm-client.tsx`, `account-navigation-client.test.ts`, `reaction-shortcuts.ts`, `popup-watch-history.tsx`, `billing.ts`, `Popup App`, `Popup People Panel.Test`, `Overlay Layout Ghost Preview`, `Panel Account Title`, `overlay-interface-settings.tsx`, `overlay-interface-settings.test.tsx`, `watch-library-client.test.tsx`, `Overlay Layout Editor`, `popup-watch-history.test.tsx`, `Overlay Layout Editor.Test`, `Popup App`, `Participant`, `Overlay Room Rail`, `extension/test/watch-history-browse.test.ts`, `contact-messages.ts`?**
  _High betweenness centrality (0.070) - this node is a cross-community bridge._
- **Why does `vitest` connect `protocol/src/index.ts` to `room-invite-notifications.ts`, `overlay-app.tsx`, `getSession`, `room-client.ts`, `anidachi-auth/watch-history-access.ts`, `auth-client.ts`, `VideoAdapter`, `room-session-storage.ts`, `account.ts`, `RoomState`, `api/src/index.ts`, `core/types.ts`, `popup-watch-drawer.tsx`, `watch-history.ts`, `Social Client`, `canonicalizeRoomSourceUrl`, `watch-history-controller.ts`, `anidachi-auth/watch-history-browse.ts`, `content.tsx`, `room-media-defaults.ts`, `Progress Module`, `room-departure-retry.ts`, `privileged-overlay-intent.ts`, `voice-audio-preferences.ts`, `account-inbox-cache.ts`, `youtube/adapter.ts`, `reaction-shortcuts.ts`, `popup-watch-history.tsx`, `Popup App`, `overlay-interface-settings.tsx`, `overlay-interface-settings.test.tsx`, `playback-sync-controller.ts`, `room-hibernation-runtime.ts`, `room-departure.ts`, `Overlay Layout Editor`, `room-media.ts`, `internal-web-client.ts`, `participant-disconnect.ts`, `Popup People Panel.Test`, `Player Chrome`, `popup-watch-history.test.tsx`, `middleware.ts`, `p2p-media.test.ts`, `node:fs`, `Popup App`, `Participant`, `watch-history-storage.ts`, `Overlay Layout Model`, `debug-log.ts`, `diagnostic-log.ts`, `registry.ts`, `p2p-ice.ts`, `Ice Servers`, `room-source-persistence.ts`, `Overlay Room Rail`, `bridge-client.ts`, `extension/test/watch-history-browse.test.ts`, `catalog.ts`, `Privileged Overlay Wiring.Test`, `Reaction Pop`, `voice-activity.ts`, `popup-watch-browse.test.tsx`, `User Identity`, `harness-entry.ts`, `Use Camera Interaction Lock`, `Artwork Select`, `Overlay Layout Runtime`, `routes.test.ts`, `Room Socket Attachment`, `Room Rate Limiter`, `room-invite-target-status.ts`, `RecentP2PSignalBuffer`, `protocol/src/auth.ts`, `Shared Protocol Types`, `hotkeys.ts`, `src/watch-history-access.ts`, `Social Client`, `Release Channel Build.Test`, `Popup Styles`, `Ghost Cam Size`, `Overlay Layout Editor.Test`, `Popup App`, `watch-history-catalog.test.ts`, `room-metering.ts`, `Overlay App`, `Room Persistence`, `Overlay Layout Engine.Test`, `overlay-media-session.ts`, `room-quota-display.ts`, `Panel Account Title`, `Overlay Layout Ghost Preview`, `Room Tab Lock`, `Overlay App`, `Index Module`, `background-invite-notification-wiring.test.ts`, `Voice Audio Preferences`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `.next/**` connect `.next/**` to `next/link`, `react`, `getGuideLinks`, `getResolvedSiteOrigin`, `getSession`, `watch-history-v3-routes.ts`, `invites-client.tsx`, `[token]/page.tsx`, `Page Module`, `Tasks Module`, `social.ts`, `profile/page.tsx`, `how-to-watch-crunchyroll-with-friends-without-account-sharing/page.tsx`, `Page Module`, `[roomId]/connect/route.ts`, `verifyKreatliCrmSession`, `app/login/page.tsx`, `node:crypto`, `how-to-host-a-crunchyroll-watch-party/page.tsx`, `Get Guide Links`, `Pseo New Guides`, `best-horror-anime-to-watch-with-friends/page.tsx`, `manager/layout.tsx`, `best-anime-to-watch-with-friends/page.tsx`, `Portfolio Audit`?**
