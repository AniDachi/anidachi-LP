  ...
  return (
    ...
    >
      ...
      <ul className="space-y-4 text-foreground/80 mb-10">
        <li>
          <strong><Link href="/watch/demon-slayer-with-friends" className="text-brand-orange hover:underline">Demon Slayer: Kimetsu no Yaiba</Link></strong> — 26 episodes (Season 1). The Mugen Train arc delivers theatrical-quality animation inside a TV episode. Perfect first anime for mixed groups — visual impact hooks newcomers before lore knowledge becomes relevant. Available on Crunchyroll.
        </li>
        <li>
          <strong><Link href="/watch/jujutsu-kaisen-with-friends" className="text-brand-orange hover:underline">Jujutsu Kaisen</Link></strong> — 24 episodes (Season 1). Fast-paced cursed energy battles and a cast that generates immediate group favourites. The Season 2 Shibuya arc escalates to a level that requires debrief time. Available on Crunchyroll.
        </li>
        <li>
          <strong><Link href="/watch/attack-on-titan-with-friends" className="text-brand-orange hover:underline">Attack on Titan</Link></strong> — 25 episodes (Season 1). Cliffhangers engineered to prevent your group from stopping. The season finale lands differently when everyone in the room experiences it simultaneously. Available on Crunchyroll.
        </li>
        <li>
          <strong><Link href="/watch/one-punch-man-with-friends" className="text-brand-orange hover:underline">One Punch Man</Link></strong> — 12 episodes (Season 1). A perfect comedy-action weekend watch — each episode is self-contained enough to accommodate late arrivals, but the escalating villain roster keeps the group invested. Available on Crunchyroll.
        </li>
        <li>
          <strong><Link href="/watch/mob-psycho-100-with-friends" className="text-brand-orange hover:underline">Mob Psycho 100</Link></strong> — 12 episodes per season. One of the most emotionally satisfying completions in anime — groups that finish all three seasons consider it the best anime they&apos;ve watched together. Available on Crunchyroll.
        </li>
        <li>
          <strong><Link href="/watch/chainsaw-man-with-friends" className="text-brand-orange hover:underline">Chainsaw Man</Link></strong> — 12 episodes (Season 1). Chaotic energy, unpredictable deaths, and production quality that demands immediate screenshots. Best for groups who want something loud and unhinged. Available on Crunchyroll.
        </li>
        <li>
          <strong><Link href="/watch/blue-lock-with-friends" className="text-brand-orange hover:underline">Blue Lock</Link></strong> — 24 episodes (Season 1). Soccer, ego, elimination tournaments — the most immediately watchable sports anime in years for groups who don&apos;t watch sports anime. Available on Crunchyroll.
        </li>
        <li>
          <strong><Link href="/watch/spy-x-family-with-friends" className="text-brand-orange hover:underline">Spy x Family</Link></strong> — 25 episodes (Season 1). A spy, an assassin, and a telepathic child pretend to be a normal family. The warmest group-watch option on this list — broad appeal, low stakes, high laughs. Available on Crunchyroll.
        </li>
      </ul>
      ...
      <ul className="space-y-4 text-foreground/80 mb-10">
        <li>
          <strong><Link href="/watch/fullmetal-alchemist-brotherhood-with-friends" className="text-brand-orange hover:underline">Fullmetal Alchemist: Brotherhood</Link></strong> — 64 episodes. Consistently the highest-rated anime on MAL. Every arc introduces a new villain the group immediately theorizes about — the finale pays off everything. Available on Crunchyroll.
        </li>
        <li>
          <strong><Link href="/watch/haikyuu-with-friends" className="text-brand-orange hover:underline">Haikyuu!!</Link></strong> — 85 episodes across 4 seasons. Every match is structured like a thriller. Group prediction games (bet on each serve) add a meta-layer of competition over the show itself. Available on Crunchyroll.
        </li>
        <li>
          <strong><Link href="/watch/my-hero-academia-with-friends" className="text-brand-orange hover:underline">My Hero Academia</Link></strong> — 6 seasons. Superhero shonen with a sports festival arc in Season 2 that is one of the best self-contained arcs for a group&apos;s first joint session. Available on Crunchyroll.
        </li>
        <li>
          <strong><Link href="/watch/vinland-saga-with-friends" className="text-brand-orange hover:underline">Vinland Saga</Link></strong> — 48 episodes across 2 seasons. A Viking revenge story that pivots into something far more philosophically ambitious in Season 2. Best for groups who want prestige-drama pacing alongside the action. Available on Crunchyroll.
        </li>
        <li>
          <strong><Link href="/watch/fruits-basket-with-friends" className="text-brand-orange hover:underline">Fruits Basket (2019)</Link></strong> — 63 episodes across 3 seasons. The best ongoing emotional investment on Crunchyroll — healing character arcs and a supernatural premise that serves pure character work. Available on Crunchyroll.
        </li>
      </ul>
      ...
      <ul className="space-y-4 text-foreground/80 mb-10">
        <li>
          <strong><Link href="/watch/spirited-away-with-friends" className="text-brand-orange hover:underline">Spirited Away</Link></strong> — Studio Ghibli&apos;s most celebrated film. 125 minutes of surreal worldbuilding that rewards repeat viewing. The best introduction to anime for groups who have never watched before. Available on Crunchyroll.
        </li>
        <li>
          <strong><Link href="/watch/your-name-with-friends" className="text-brand-orange hover:underline">Your Name (Kimi no Na wa)</Link></strong> — Makoto Shinkai&apos;s body-swap romance-disaster film. 112 minutes with a third-act reveal that groups need to discuss immediately. One of the highest-grossing anime films ever. Available on Crunchyroll.
        </li>
        <li>
          <strong><Link href="/watch/a-silent-voice-with-friends" className="text-brand-orange hover:underline">A Silent Voice (Koe no Katachi)</Link></strong> — A nuanced story of guilt, redemption, and disability. 130 minutes that generate longer post-watch discussions than most 24-episode series. Available on Crunchyroll.
        </li>
        <li>
          <strong><Link href="/watch/howls-moving-castle-with-friends" className="text-brand-orange hover:underline">Howl&apos;s Moving Castle</Link></strong> — Studio Ghibli&apos;s warm fantasy film, best for groups that want visual spectacle with a lighter emotional tone than Spirited Away. Available on Crunchyroll.
        </li>
      </ul>
