  ...
  return (
    ...
    >
      ...
      <ul className="space-y-4 text-foreground/80 mb-10">
        <li>
          <strong><Link href="/watch/toradora-with-friends" className="text-brand-orange hover:underline">Toradora!</Link></strong> — 25 episodes. Two mismatched high schoolers team up to pursue each other&apos;s best friends — and fall for each other in the process. The finale is the most universally acclaimed ending in romance anime: groups that start the last episode at 10pm routinely finish at 1am because stopping is not an option. Available on Crunchyroll.
        </li>
        <li>
          <strong><Link href="/watch/fruits-basket-with-friends" className="text-brand-orange hover:underline">Fruits Basket (2019)</Link></strong> — 63 episodes across 3 seasons. Orphaned Tohru Honda moves in with the Soma family and slowly unravels a supernatural curse through sheer warmth. The most emotionally healing romance on Crunchyroll — groups report feeling genuinely better about people after finishing it. Available on Crunchyroll.
        </li>
        <li>
          <strong><Link href="/watch/kimi-ni-todoke-with-friends" className="text-brand-orange hover:underline">Kimi ni Todoke: From Me to You</Link></strong> — 25 episodes across 2 seasons. Sawako, nicknamed &quot;Sadako&quot; by fearful classmates, finds her world changing when the most popular boy in school genuinely talks to her. The warmest slow-burn romance in anime — best for groups who want to cheer characters on across small, earned moments. Available on Crunchyroll.
        </li>
        <li>
          <strong><Link href="/watch/rascal-does-not-dream-of-bunny-girl-senpai-with-friends" className="text-brand-orange hover:underline">Rascal Does Not Dream of Bunny Girl Senpai</Link></strong> — 13 episodes + film. Supernatural romantic drama where social anxiety manifests as literal supernatural phenomena. Each arc resolves a different character&apos;s invisible problem — the central couple dynamic builds quietly across the whole run. Available on Crunchyroll.
        </li>
        <li>
          <strong><Link href="/watch/horimiya-with-friends" className="text-brand-orange hover:underline">Horimiya</Link></strong> — 26 episodes. Popular Hori and quiet Miyamura collide outside their school personas in cozy vignettes that consistently deliver small serotonin hits. The best low-stakes romance for groups who want warmth without dramatic tension. Available on Crunchyroll.
        </li>
      </ul>
      ...
      <ul className="space-y-4 text-foreground/80 mb-10">
        ...
        <li>
          <strong><Link href="/watch/quintessential-quintuplets-with-friends" className="text-brand-orange hover:underline">The Quintessential Quintuplets</Link></strong> — 24 episodes across 2 seasons. A tutor falls for one of five identical sisters — the show hides which one until the finale. Groups split into camps defending their preferred sister across the entire run. Available on Crunchyroll.
        </li>
      </ul>
