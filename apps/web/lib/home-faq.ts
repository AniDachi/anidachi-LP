...
export const homeFAQ = [
  ...
  },
  {
    ...
    answer:
      "Each person needs their own Crunchyroll account to stream the anime. AniDachi handles the sync, watchrooms, and chat layer on top.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Unlike Teleparty or Crunchyroll Party, AniDachi supports asynchronous watching — friends don't need to be online at the same time. AniDachi also auto-detects anime, tracks individual watch progress, and lets you leave reactions and comments that friends see later.",
  },
  {
